...
#define UTILITY_COMPARE_POLICY_DECL_HPP
...
/*! \brief Default structure used by Utility::ComparePolicy to produce a
 * compile time error when the specialization does not exist for type T.
 *
 * To use the Utility::ComparePolicy struct a template specialization for
...
#endif // end UTILITY_COMPARE_POLICY_DECL_HPP

//---------------------------------------------------------------------------//
// end Utility_ComparePolicyDecl.hpp
//---------------------------------------------------------------------------//
