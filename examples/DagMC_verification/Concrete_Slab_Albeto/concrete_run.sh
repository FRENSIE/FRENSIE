...
##.././facemc --sim_info=concrete_hist.xml --geom_def=concrete_geom_root.xml --mat_def=concrete_mat.xml --resp_def=concrete_response.xml --est_def=concrete_est.xml --src_def=concrete_src.xml --cross_sec_dir=/home/software/mcnpdata --threads=12
