...
\begin{frame}{Permanent Implant Brachytherapy}
  ...
  %% \begin{textblock}{10}(35,40)
  %%   \includegraphics[width=2.0in]{figures/organ_contour.pdf}
  %% \end{textblock}
...
\begin{frame}{The Collision Kernel}
  ...
  \only<2>{
    \begin{textblock}{10}(20,77)
      \includegraphics[width=1.0in,height=0.5in]{figures/circle.pdf}
    \end{textblock}
  }
  \only<3>{
    \begin{textblock}{10}(43,77)
      \includegraphics[width=0.85in,height=0.5in]{figures/circle.pdf}
    \end{textblock}
  }
  \only<4>{
    \begin{textblock}{10}(63,77)
      \includegraphics[width=2.1in,height=0.5in]{figures/circle.pdf}
    \end{textblock}
  }  
...
\begin{frame}{The Expanded Adjoint Collision Kernel}
  ...
  \only<2>{
    \begin{textblock}{10}(18,43)
      \includegraphics[width=1.0in,height=0.5in]{figures/circle.pdf}
    \end{textblock}
  }
  \only<3>{
    \begin{textblock}{10}(41,43)
      \includegraphics[width=0.85in,height=0.5in]{figures/circle.pdf}
    \end{textblock}
  }
  \only<4,5>{
    \begin{textblock}{10}(60,41)
      \includegraphics[width=2.6in,height=0.6in]{figures/circle.pdf}
    \end{textblock}
  }  
  ...
  \begin{textblock}{80}(4,15)
    \begin{itemize}
      \item \textbf{Problem Geometry:} 
        %%same as FACEMC validation step 3
