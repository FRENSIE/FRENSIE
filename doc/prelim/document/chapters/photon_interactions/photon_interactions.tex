...
The PDF for $x$ can be defined as
\begin{align}
  p_{K.N.}(\alpha^{'},x) & = 
  \begin{cases}
...
The derivative of the electron momentum projection with respect to the outgoing 
photon energy is 
\begin{equation}
...
The incoherent scattering cross section differential in outgoing energy, which
...
The next modification to the random walk process occurs when the expanded 
...
Assume that the source is defined as
\begin{equation}
  S(\vec{r},E,\hat{\Omega}) = 
  \begin{cases}
