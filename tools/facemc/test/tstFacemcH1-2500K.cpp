...
int main( int argc, char** argv )
{
  ...
  hdf5_file_handler.getEstimatorDimensionOrdering( 1u, 
						  dimension_ordering_result );
  ...
  UTILITY_TEST_COMPARE_ARRAYS( raw_bin_data,
			       raw_bin_data_result,
			       1e-15 );
  ...
  UTILITY_TEST_COMPARE_ARRAYS( processed_bin_data,
			       processed_bin_data_result,
			       1e-15 );
  ...
  // Ignore the fom since it will change every time
}
