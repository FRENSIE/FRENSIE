...
// FRENSIE Includes
#include "Facemc_GeneralEstimatorDimensionDiscretization.hpp"
...
{
  typedef Facemc::PhaseSpaceDimensionTraits<dimension> EPSDT;
...
void initialize<Facemc::COLLISION_NUMBER_DIMENSION>( 
			...
			const bool )
{
  typedef Facemc::PhaseSpaceDimensionTraits<Facemc::COLLISION_NUMBER_DIMENSION> EPSDT;
