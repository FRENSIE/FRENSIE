...
{
  typedef Facemc::SourceModuleInterface<Facemc::ParticleSource> SMI;
...
int main( int argc, char** argv )
{
  ...
  Teuchos::RCP<Facemc::ParticleSourceFactory> source_factory = 
    Facemc::StandardParticleSourceFactory<moab::DagMC>::getInstance();
