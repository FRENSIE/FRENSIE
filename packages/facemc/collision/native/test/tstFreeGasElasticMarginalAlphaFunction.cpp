...
// FRENSIE Includes
#include "Facemc_FreeGasElasticMarginalAlphaFunction.hpp"
...
Teuchos::RCP<Facemc::FreeGasElasticMarginalAlphaFunction> alpha_function;
...
int main( int argc, char** argv )
{
  ...
  alpha_function.reset( new Facemc::FreeGasElasticMarginalAlphaFunction(
						    cross_section, 
