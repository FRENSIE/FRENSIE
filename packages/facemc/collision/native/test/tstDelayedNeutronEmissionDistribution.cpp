...
TEUCHOS_UNIT_TEST( DelayedNeutronEmissionDistribution, scatterNeutron )
{
  ...
  Facemc::NeutronState neutron( 1ull );
...
int main( int argc, char** argv )
{
  ...
  Teuchos::RCP<Facemc::DelayedNeutronEmissionDistributionFactory>
    factory( new Facemc::DelayedNeutronEmissionDistributionFactory(
