...
// Testing Structs.
//---------------------------------------------------------------------------//
class TestDelayedNeutronEmissionDistributionFactory : public Facemc::DelayedNeutronEmissionDistributionFactory
{
public:
  TestDelayedNeutronEmissionDistributionFactory(
    ...
    : Facemc::DelayedNeutronEmissionDistributionFactory( table_name,
							 atomic_weight_ratio,
							 bdd_block,
							 dnedl_block,
							 dned_block )
  ...
  using Facemc::DelayedNeutronEmissionDistributionFactory::getPrecursorGroupDecayConsts;
  using Facemc::DelayedNeutronEmissionDistributionFactory::getPrecursorGroupProbDists;
  using Facemc::DelayedNeutronEmissionDistributionFactory::getPrecursorGroupEmissionDists;
};
