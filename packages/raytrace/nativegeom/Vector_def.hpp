...
#ifndef VECTOR_DEF_HPP
#define VECTOR_DEF_HPP
...
// Tuple constructor
template<typename ScalarType>
Vector<ScalarType>::Vector( const Trip<ScalarType,ScalarType,ScalarType>
			    &tuple )
  : PrintableObject( "ThreeSpaceVector" ),
    ThreeSpaceObject( THREE_SPACE_VECTOR ),
    d_data( 3 )
...
#endif // end THREE_SPACE_VECTOR_DEF_HPP

//---------------------------------------------------------------------------//
// end ThreeSpaceVector_def.hpp
//---------------------------------------------------------------------------//
