//---------------------------------------------------------------------------//
// \file   PhotonDataFluorescence.hpp
// \author Alex Robinson
// \brief  PhotonDataFluorescence class declaration
//---------------------------------------------------------------------------//

#ifndef PHOTON_DATA_FLUORESCENCE_HPP
#define PHOTON_DATA_FLUORESCENCE_HPP
...
public:
  ...
  // shell of interest
  double getShellRadiativeTransitionProbability( const unsigned int shell ) const;

  //! Return the new vacancy shell and the emitted photon energy after
  // a radiative transition
  Pair<unsigned int, double> getShellRadiativeTransitionData( 
						 const unsigned int shell,
						 const double cdf_value ) const;

  //! Return the new vacancy shells and the emmitted electron energy after
  // a nonradiative transition
  Trip<unsigned int, unsigned int, double> getShellNonradiativeTransitionData(
						 const unsigned int shell,
						 const double cdf_value ) const;
...
private:
  ...
  typedef Teuchos::ArrayRCP<Trip<double, unsigned int, double> > RadiativeTransitionArray;
  typedef Teuchos::ArrayRCP<Quad<double, unsigned int, unsigned int, double> > NonradiativeTransitionArray;
...
#endif // end PHOTON_DATA_FLUORESCENCE_HPP

//---------------------------------------------------------------------------//
//end PhotonDataFluorescence.hpp
//---------------------------------------------------------------------------//
