...
FRENSIE_CHECK_FLOATING_EQUALITY(
  ...
  FRENSIE_CHECK_EQUAL( electroionization_recoil_energy.back(), 1e-7 );
  FRENSIE_CHECK_EQUAL( electroionization_recoil_energy.size(), 2 );
  ...
  FRENSIE_CHECK_EQUAL( electroionization_recoil_energy.back(), 2.861468825511599151e-07 );
  ...
  FRENSIE_CHECK_EQUAL( electroionization_recoil_pdf.front(), 3.652781465554018505e+06 );
  FRENSIE_CHECK_EQUAL( electroionization_recoil_pdf.back(), 3.167783530173711013e+06 );
  ...
  FRENSIE_CHECK_EQUAL( bremsstrahlung_photon_pdf.back(), 2.136140388110006825e+04 );
  FRENSIE_CHECK_EQUAL( bremsstrahlung_photon_pdf.size(), 17 );
  ...
  FRENSIE_CHECK_EQUAL( bremsstrahlung_photon_pdf.back(), 5.638520429604341871e-09 );
