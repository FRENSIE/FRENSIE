...
//! \todo double check what the front cross section should be
  ...
  TEST_EQUALITY_CONST( discrete_weights.front(), 7.50007499925003707e-01 );
  TEST_EQUALITY_CONST( discrete_weights.back(), 2.49992500074996238e-01 );
  TEST_EQUALITY_CONST( discrete_weights.size(), 2 );

  discrete_weights =
    data_container.getMomentPreservingElasticWeights( 1.0e+5 );

  TEST_EQUALITY_CONST( discrete_weights.front(), 9.95726637056318249e-12 );
  TEST_EQUALITY_CONST( discrete_weights.back(), 9.99999999990042743e-01 );
  TEST_EQUALITY_CONST( discrete_weights.size(), 2 );
                   ...
                   repopulateMomentPreservingData_c )
{
  ...
  TEST_EQUALITY_CONST( discrete_angles.front(), 0.93333333332666712501 );
  TEST_EQUALITY_CONST( discrete_angles.back(), 1.0 );
  TEST_EQUALITY_CONST( discrete_angles.size(), 2 );
  ...
  TEST_EQUALITY_CONST( discrete_angles.front(), 9.96677280271654253e-01 );
  TEST_EQUALITY_CONST( discrete_angles.back(), 1.0 );
  TEST_EQUALITY_CONST( discrete_angles.size(), 2 );
  ...
  TEST_EQUALITY_CONST( discrete_weights.front(), 3.02280294523513256e-11 );
  TEST_EQUALITY_CONST( discrete_weights.back(), 9.99999999969771958e-01 );
  TEST_EQUALITY_CONST( discrete_weights.size(), 2 );
