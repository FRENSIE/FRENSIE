...
TEUCHOS_UNIT_TEST( ContinuousEnergyNeutronXsdirEntry, addInfoToParameterList )
{
  ...
  TEST_EQUALITY_CONST( sublist_d.get<std::string>( MonteCarlo::CrossSectionsXMLProperties::nuclear_file_path_prop ),
		       "endf70b" );
  TEST_EQUALITY_CONST( sublist_d.get<std::string>( MonteCarlo::CrossSectionsXMLProperties::nuclear_file_type_prop ),
		       MonteCarlo::CrossSectionsXMLProperties::ace_file );
  TEST_EQUALITY_CONST( sublist_d.get<std::string>( MonteCarlo::CrossSectionsXMLProperties::nuclear_table_name_prop ),
		       "27458.71c" );
  TEST_EQUALITY_CONST( sublist_d.get<int>( MonteCarlo::CrossSectionsXMLProperties::nuclear_file_start_line_prop ),
		       3694447 );
  TEST_EQUALITY_CONST( sublist_d.get<int>( MonteCarlo::CrossSectionsXMLProperties::atomic_number_prop ),
		       27);
  TEST_EQUALITY_CONST( sublist_d.get<int>( MonteCarlo::CrossSectionsXMLProperties::atomic_mass_number_prop ),
		       58 );
  TEST_EQUALITY_CONST( sublist_d.get<int>( MonteCarlo::CrossSectionsXMLProperties::isomer_number_prop ),
		       1 );
  TEST_EQUALITY_CONST( sublist_d.get<double>( MonteCarlo::CrossSectionsXMLProperties::atomic_weight_ratio_prop ),
		       57.438100 );
  TEST_EQUALITY_CONST( sublist_d.get<double>( MonteCarlo::CrossSectionsXMLProperties::temperature_prop ),
		       5.1704E-08 );
  ...
  TEST_EQUALITY_CONST( sublist_e.get<std::string>( MonteCarlo::CrossSectionsXMLProperties::nuclear_file_path_prop ),
		       "endf70d" );
  TEST_EQUALITY_CONST( sublist_e.get<std::string>( MonteCarlo::CrossSectionsXMLProperties::nuclear_file_type_prop ),
		       MonteCarlo::CrossSectionsXMLProperties::ace_file );
  TEST_EQUALITY_CONST( sublist_e.get<std::string>( MonteCarlo::CrossSectionsXMLProperties::nuclear_table_name_prop ),
		       "48515.70c" );
  TEST_EQUALITY_CONST( sublist_e.get<int>( MonteCarlo::CrossSectionsXMLProperties::nuclear_file_start_line_prop ),
		       10018897 );
  TEST_EQUALITY_CONST( sublist_e.get<int>( MonteCarlo::CrossSectionsXMLProperties::atomic_number_prop ),
		       48 );
  TEST_EQUALITY_CONST( sublist_e.get<int>( MonteCarlo::CrossSectionsXMLProperties::atomic_mass_number_prop ),
		       115 );
  TEST_EQUALITY_CONST( sublist_e.get<int>( MonteCarlo::CrossSectionsXMLProperties::isomer_number_prop ),
		       1 );
  TEST_EQUALITY_CONST( sublist_e.get<double>( MonteCarlo::CrossSectionsXMLProperties::atomic_weight_ratio_prop ),
		       113.918000 );
  TEST_EQUALITY_CONST( sublist_e.get<double>( MonteCarlo::CrossSectionsXMLProperties::temperature_prop ),
		       2.5301E-08 );
  ...
  TEST_EQUALITY_CONST( sublist_f.get<std::string>( MonteCarlo::CrossSectionsXMLProperties::nuclear_file_path_prop ),
		       "endf70a" );
  TEST_EQUALITY_CONST( sublist_f.get<std::string>( MonteCarlo::CrossSectionsXMLProperties::nuclear_file_type_prop ),
		       MonteCarlo::CrossSectionsXMLProperties::ace_file );
  TEST_EQUALITY_CONST( sublist_f.get<std::string>( MonteCarlo::CrossSectionsXMLProperties::nuclear_table_name_prop ),
		       "6000.70c" );
  TEST_EQUALITY_CONST( sublist_f.get<int>( MonteCarlo::CrossSectionsXMLProperties::nuclear_file_start_line_prop ),
		       1107528 );
  TEST_EQUALITY_CONST( sublist_f.get<int>( MonteCarlo::CrossSectionsXMLProperties::atomic_number_prop ),
		       6 );
  TEST_EQUALITY_CONST( sublist_f.get<int>( MonteCarlo::CrossSectionsXMLProperties::atomic_mass_number_prop ),
		       0 );
  TEST_EQUALITY_CONST( sublist_f.get<int>( MonteCarlo::CrossSectionsXMLProperties::isomer_number_prop ),
		       0 );
  TEST_EQUALITY_CONST( sublist_f.get<double>( MonteCarlo::CrossSectionsXMLProperties::atomic_weight_ratio_prop ),
		       11.898000 );
  TEST_EQUALITY_CONST( sublist_f.get<double>( MonteCarlo::CrossSectionsXMLProperties::temperature_prop ),
		       2.5301E-08 );
}
