		   ...
		   testUnmodifiedCrossSection )
{
  ...
  std::shared_ptr<double> unmodified_cross_section;
		   ...
		   testEnergyArray )
{
  ...
  std::shared_ptr<double> energy_array;
...
free_gas_factory->generateFreeGasPDFDistributions();
  std::shared_ptr<double> zero_temperature_cross_section;
		   ...
		   tstTotalCrossSection )
{
  ...
  std::shared_ptr<double> free_gas_cross_section;
		   ...
		   tstFalseDistribution )
{
  ...
  std::shared_ptr<double> energy_array( test_energy );

  std::vector<double> test_pdf{0, 0.1, 0.2, 0.4, 0.6, 0.8, 0.95};
  std::shared_ptr<double> pdf_array( test_pdf );
