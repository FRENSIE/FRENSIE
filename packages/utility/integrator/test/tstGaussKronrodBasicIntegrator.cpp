//---------------------------------------------------------------------------//
//!
//! \file   tstGaussKronrodBasicIntegrator.cpp
...
// Testing Structs.
//---------------------------------------------------------------------------//
class TestGaussKronrodBasicIntegrator : public Utility::GaussKronrodBasicIntegrator
{
public:
  TestGaussKronrodBasicIntegrator( const double relative_error_tol )
    : Utility::GaussKronrodBasicIntegrator( relative_error_tol )
  { /* ... */ }

  ~TestGaussKronrodBasicIntegrator()
  { /* ... */ }

  // Allow public access to the GaussKronrodBasicIntegrator protected member functions
  using Utility::GaussKronrodBasicIntegrator::calculateQuadratureIntegrandValuesAtAbscissa;
  using Utility::GaussKronrodBasicIntegrator::bisectAndIntegrateBinInterval;
  using Utility::GaussKronrodBasicIntegrator::rescaleAbsoluteError;
  using Utility::GaussKronrodBasicIntegrator::subintervalTooSmall;
  using Utility::GaussKronrodBasicIntegrator::checkRoundoffError;
  using Utility::GaussKronrodBasicIntegrator::sortBins;
  using Utility::GaussKronrodBasicIntegrator::getWynnEpsilonAlgorithmExtrapolation;
};
...
TEUCHOS_UNIT_TEST_TEMPLATE_1_DECL( GaussKronrodBasicIntegrator,
				                   integrateWithPointRule,
                                   Functor )
{
  Utility::GaussKronrodBasicIntegrator gk_integrator( 1e-12 );
...
UNIT_TEST_INSTANTIATION( GaussKronrodBasicIntegrator, integrateWithPointRule );
...
TEUCHOS_UNIT_TEST_TEMPLATE_1_DECL( GaussKronrodBasicIntegrator,
                                   ...
                                   Functor )
{
  TestGaussKronrodBasicIntegrator test_integrator( 1e-12 );
...
UNIT_TEST_INSTANTIATION( GaussKronrodBasicIntegrator, calculateQuadratureIntegrandValuesAtAbscissa );
...
UNIT_TEST_INSTANTIATION( GaussKronrodBasicIntegrator, bisectAndIntegrateBinInterval );

//---------------------------------------------------------------------------//
// Check that the error can be rescaled
TEUCHOS_UNIT_TEST( GaussKronrodBasicIntegrator, 
...
UNIT_TEST_INSTANTIATION( GaussKronrodBasicIntegrator, integrateAdaptively );
		   ...
		   integrateAdaptivelyWynnEpsilon )
{
  ...
  Utility::GaussKronrodBasicIntegrator gk_int( 1e-12, 0.0, 100000 );
                                   ...
                                   Functor )
{
  ...
  Utility::GaussKronrodBasicIntegrator gkq_set( 1e-12, 0.0, 100000 );
...
UNIT_TEST_INSTANTIATION( GaussKronrodBasicIntegrator, integrateAdaptivelyWynnEpsilon_no_singularities );

//---------------------------------------------------------------------------//
// end tstGaussKronrodBasicIntegrator.cpp
//---------------------------------------------------------------------------//
