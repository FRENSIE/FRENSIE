...
TEUCHOS_UNIT_TEST_TEMPLATE_1_DECL( GaussRadauQuadratureSet,
                                   integrate,
                                   Functor )
{
  double result;
...
UNIT_TEST_INSTANTIATION( GaussRadauQuadratureSet, integrate );

//---------------------------------------------------------------------------//
// Check that nodes and weights can be found for n=4 p(x) = 1
TEUCHOS_UNIT_TEST( GaussRadauQuadratureSet,
