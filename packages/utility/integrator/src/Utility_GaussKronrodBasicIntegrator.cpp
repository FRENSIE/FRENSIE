//---------------------------------------------------------------------------//
//!
//! \file   Utility_GaussKronrodBasicIntegrator.cpp
...
// Constructor
GaussKronrodBasicIntegrator::GaussKronrodBasicIntegrator( 
...
void GaussKronrodBasicIntegrator::rescaleAbsoluteError( 
...
void GaussKronrodBasicIntegrator::sortBins( 
...
void GaussKronrodBasicIntegrator::getWynnEpsilonAlgorithmExtrapolation( 
...
void GaussKronrodBasicIntegrator::checkRoundoffError( 
                       const BinTraits& bin, 
...
//---------------------------------------------------------------------------//
// end Utility_GaussKronrodBasicIntegrator.cpp
//---------------------------------------------------------------------------//
