//---------------------------------------------------------------------------//
//!
//! \file   Utility_GaussKronrodBasicQuadratureSetTraitsDecl.hpp
//! \author Luke Kersting
//! \brief  Gauss-Kronrod quadrature set traits declaration
//!
//---------------------------------------------------------------------------//

#ifndef UTILITY_GAUSS_KRONROD_BASIC_QUADRATURE_SET_TRAITS_DECL_HPP
#define UTILITY_GAUSS_KRONROD_BASIC_QUADRATURE_SET_TRAITS_DECL_HPP
...
namespace Utility{
  ...
  template<int Points>
  struct GaussKronrodBasicQuadratureSetTraits
  {
    //! Valid rule
...
#endif // end UTILITY_GAUSS_KRONROD_BASIC_QUADRATURE_SET_TRAITS_DECL_HPP

//---------------------------------------------------------------------------//
// end Utility_GaussKronrodBasicQuadratureSetTraitsDecl.hpp
//---------------------------------------------------------------------------//
