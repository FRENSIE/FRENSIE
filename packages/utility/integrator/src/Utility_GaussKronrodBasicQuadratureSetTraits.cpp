//---------------------------------------------------------------------------//
//!
//! \file   Utility_GaussKronrodBasicQuadratureSetTraits.cpp
...
// FRENSIE Includes
#include "Utility_GaussKronrodBasicQuadratureSetTraits.hpp"
...
namespace Utility{
    ...
    const Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<15>::gauss_weights =
        GaussKronrodBasicQuadratureSetTraits<15>::initializeGaussWeights();
    
    // Kronrad quadrature weights 
    const Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<15>::kronrod_weights = 
        GaussKronrodBasicQuadratureSetTraits<15>::initializeKronrodWeights();

    // Kronrad quadrature abscissae
    const Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<15>::kronrod_abscissae =
        GaussKronrodBasicQuadratureSetTraits<15>::initializeKronrodAbscissae();

    // Initialize the gauss weight array
    Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<15>::initializeGaussWeights()
    { 
    ...
    Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<15>::initializeKronrodWeights()
    {
    ...
    // Initialize the gauss weight array
    Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<15>::initializeKronrodAbscissae()
    {
    ...
    /******************* 21 point rule *******************/
    // Gauss quadrature weights 
    const Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<21>::gauss_weights =
        GaussKronrodBasicQuadratureSetTraits<21>::initializeGaussWeights();
    
    // Kronrad quadrature weights 
    const Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<21>::kronrod_weights = 
        GaussKronrodBasicQuadratureSetTraits<21>::initializeKronrodWeights();

    // Kronrad quadrature abscissae
    const Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<21>::kronrod_abscissae =
        GaussKronrodBasicQuadratureSetTraits<21>::initializeKronrodAbscissae();

    // Initialize the gauss weight array
    Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<21>::initializeGaussWeights()
    { 
    ...
    // Initialize the kronrod weight array
    Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<21>::initializeKronrodWeights()
    {
    ...
    // Initialize the gauss weight array
    Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<21>::initializeKronrodAbscissae()
    {
    ...
    /******************* 31 point rule *******************/
    // Gauss quadrature weights 
    const Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<31>::gauss_weights =
        GaussKronrodBasicQuadratureSetTraits<31>::initializeGaussWeights();
    
    // Kronrad quadrature weights 
    const Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<31>::kronrod_weights = 
        GaussKronrodBasicQuadratureSetTraits<31>::initializeKronrodWeights();

    // Kronrad quadrature abscissae
    const Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<31>::kronrod_abscissae =
        GaussKronrodBasicQuadratureSetTraits<31>::initializeKronrodAbscissae();

    // Initialize the gauss weight array
    Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<31>::initializeGaussWeights()
    { 
    ...
    // Initialize the kronrod weight array
    Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<31>::initializeKronrodWeights()
    {
    ...
    // Initialize the gauss weight array
    Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<31>::initializeKronrodAbscissae()
    {
    ...
    /******************* 41 point rule *******************/
    // Gauss quadrature weights 
    const Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<41>::gauss_weights =
        GaussKronrodBasicQuadratureSetTraits<41>::initializeGaussWeights();
    
    // Kronrad quadrature weights 
    const Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<41>::kronrod_weights = 
        GaussKronrodBasicQuadratureSetTraits<41>::initializeKronrodWeights();

    // Kronrad quadrature abscissae
    const Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<41>::kronrod_abscissae =
        GaussKronrodBasicQuadratureSetTraits<41>::initializeKronrodAbscissae();

    // Initialize the gauss weight array
    Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<41>::initializeGaussWeights()
    { 
    ...
    // Initialize the kronrod weight array
    Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<41>::initializeKronrodWeights()
    {
    ...
    // Initialize the gauss weight array
    Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<41>::initializeKronrodAbscissae()
    {
    ...
    /******************* 51 point rule *******************/
    // Gauss quadrature weights 
    const Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<51>::gauss_weights =
        GaussKronrodBasicQuadratureSetTraits<51>::initializeGaussWeights();
    
    // Kronrad quadrature weights 
    const Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<51>::kronrod_weights = 
        GaussKronrodBasicQuadratureSetTraits<51>::initializeKronrodWeights();

    // Kronrad quadrature abscissae
    const Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<51>::kronrod_abscissae =
        GaussKronrodBasicQuadratureSetTraits<51>::initializeKronrodAbscissae();

    // Initialize the gauss weight array
    Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<51>::initializeGaussWeights()
    { 
    ...
    // Initialize the kronrod weight array
    Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<51>::initializeKronrodWeights()
    {
    ...
    // Initialize the gauss weight array
    Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<51>::initializeKronrodAbscissae()
    {
    ...
    /******************* 61 point rule *******************/
    // Gauss quadrature weights 
    const Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<61>::gauss_weights =
        GaussKronrodBasicQuadratureSetTraits<61>::initializeGaussWeights();
    
    // Kronrad quadrature weights 
    const Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<61>::kronrod_weights = 
        GaussKronrodBasicQuadratureSetTraits<61>::initializeKronrodWeights();

    // Kronrad quadrature abscissae
    const Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<61>::kronrod_abscissae =
        GaussKronrodBasicQuadratureSetTraits<61>::initializeKronrodAbscissae();

    // Initialize the gauss weight array
    Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<61>::initializeGaussWeights()
    { 
    ...
    // Initialize the kronrod weight array
    Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<61>::initializeKronrodWeights()
    {
    ...
    // Initialize the gauss weight array
    Teuchos::Array<double> GaussKronrodBasicQuadratureSetTraits<61>::initializeKronrodAbscissae()
    {
...
//---------------------------------------------------------------------------//
// end Utility_GaussKronrodBasicQuadratureSetTraits.cpp
//---------------------------------------------------------------------------//
