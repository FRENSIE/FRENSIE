//---------------------------------------------------------------------------//
//!
//! \file   Utility_GaussRadauQuadratureKernel.cpp
...
// Constructor
GaussRadauQuadratureKernel::GaussRadauQuadratureKernel( 
 ...
 */
double GaussRadauQuadratureKernel::getJacobiPolynomial( 
                              double x,
                              int n, 
                              int alpha,
                              int beta ) const
...
double GaussRadauQuadratureKernel::getLegendrePolynomial( 
                                        double x,
                                        int n ) const
{
 ...
 */
double GaussRadauQuadratureKernel::getJacobiPolynomialDerivative( 
                              double x,
                              int n, 
                              int alpha,
                              int beta ) const
 ...
 */
void GaussRadauQuadratureKernel::getJacobiPolynomialRoots( 
...
void GaussRadauQuadratureKernel::findNodesAndWeights(
                            double end_point, 
...
// Find the Radau nodes and wieghts including at end point -1 or 1
void GaussRadauQuadratureKernel::findNodesAndPositiveWeights(
                            double end_point, 
                            Teuchos::Array<double>& nodes,
                            Teuchos::Array<double>& weights ) const
{
...
double GaussRadauQuadratureKernel::getFixedWeightIntegrand( 
                               double end_point,
                               int n ) const
{
...
double GaussRadauQuadratureKernel::getWeightIntegrand(
                               double x,
                               double node,
                               double end_point, 
                               int n ) const
...
double GaussRadauQuadratureKernel::findWeightAtEndPoint( double end_point,
                                                         int n ) const
{
  // Make sure end_point is either -1 or 1
  testPrecondition( fabs(end_point) == 1.0 );
  ...
  boost::function<double (double x)> weight_function =
    boost::bind<double>( &GaussRadauQuadratureKernel::getFixedWeightIntegrand,
			 boost::cref( *this ),
			 _1,
			 n );
...
double GaussRadauQuadratureKernel::findWeightAtNode( double node,
                                                     double end_point,
                                                     int n ) const
{
  // Make sure end_point is either -1 or 1
  ...
  boost::function<double (double x)> weight_function =
    boost::bind<double>( &GaussRadauQuadratureKernel::getWeightIntegrand,
			 boost::cref( *this ),
			 _1,
                         node,
                         end_point,
...
//---------------------------------------------------------------------------//
// end Utility_GaussRadauQuadratureKernel.cpp
//---------------------------------------------------------------------------//
