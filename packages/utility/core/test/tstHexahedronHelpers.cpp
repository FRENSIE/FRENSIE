...
// Tests.
//---------------------------------------------------------------------------//
// Check that the volume of a hex can be calculated

/*TEUCHOS_UNIT_TEST( HexahedronHelpers, calculateHexahedronVolume_array )
{
...
*/
//---------------------------------------------------------------------------//
// Check that the face normal vectors can be calculated
TEUCHOS_UNIT_TEST( HexahedronHelpers, 
                   calculateFaceNormals )
{
  double vertex_a[3] = { 0.0, 0.0, 1.0 };
  double vertex_b[3] = { 1.0, 0.0, 1.0 };
  double vertex_c[3] = { 1.0, 0.0, 0.0 };
  double vertex_d[3] = { 0.0, 0.0, 0.0 };
  double vertex_e[3] = { 0.0, 1.0, 1.0 };
  double vertex_f[3] = { 1.0, 1.0, 1.0 };
  double vertex_g[3] = { 1.0, 1.0, 0.0 };
  double vertex_h[3] = { 0.0, 1.0, 0.0 };

  Teuchos::TwoDArray<double> face_normals(6,3);
  
  // Usage Test Passing Matrix3
  Utility::calculateFaceNormals(         vertex_a,
					 vertex_b,
					 vertex_c,
					 vertex_d,
                                         vertex_e,
					 ...
					 vertex_h,
					 face_normals );
  Teuchos::TwoDArray<double> face_normals_test(6,3);					 
  Teuchos::Tuple<double,3> face_normals_tuple = 
    Teuchos::tuple<double>( face_normals( 0, 0), face_normals( 0, 1), face_normals( 0, 2));
                         
    
  Teuchos::Tuple<double,3> expected_face_normals_tuple = 
    Teuchos::tuple<double>( 0.0, -1.0, 0.0);

  TEST_COMPARE_FLOATING_ARRAYS( face_normals_tuple, 
				expected_face_normals_tuple, 
				1e-12 );
}
/*
//---------------------------------------------------------------------------//
