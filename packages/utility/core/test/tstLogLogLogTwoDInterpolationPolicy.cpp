...
// Check that the log-log-log interpolation policy between four points
// can be done
TEUCHOS_UNIT_TEST( LogLogLog, interpolate_raw_no_tuple_grids )
{
  double x0 = 0.1, x1 = 1.0, x = 0.3, y = 3e-2;
...
TEUCHOS_UNIT_TEST( LogLogLog, calculateIntermediateGridMin )
{
  double x0 = 0.1, x1 = 1.0, x = 0.3;
  double y0_min = 1e-3, y1_min = 1e-2;

  double yx_min = Utility::LogLogLog::calculateIntermediateGridMin(
  ...
  yx_min = Utility::LogLogLog::calculateIntermediateGridMin(
						   x0, x1, x, y0_min, y1_min );
...
// four points can be done
TEUCHOS_UNIT_TEST( LogLogLog, interpolateUnitBase_raw_no_tuple_grids )
{
  double x0 = 0.1, x1 = 1.0, x = 0.3, y = 0.05;
