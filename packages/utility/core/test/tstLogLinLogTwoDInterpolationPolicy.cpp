...
// Check that the log-linear-log interpolation policy between four points
// can be done
TEUCHOS_UNIT_TEST( LogLinLog, interpolate_raw_no_tuple_grids )
{
  double x0 = 0.1, x1 = 1.0, x = 0.3, y = 0.0;
...
TEUCHOS_UNIT_TEST( LogLinLog, calculateIntermediateGridMin )
{
  double x0 = 0.1, x1 = 1.0, x = 0.3;
  double y0_min = -10.0, y1_min = 10.0;

  double yx_min = Utility::LogLinLog::calculateIntermediateGridMin(
  ...
  yx_min = Utility::LogLinLog::calculateIntermediateGridMin(
						   x0, x1, x, y0_min, y1_min );
...
// Check that the log-linear-log unit base interpolation policy between 
// four points can be done
TEUCHOS_UNIT_TEST( LogLinLog, interpolateUnitBase_raw_no_tuple_grids )
{
  double x0 = 0.1, x1 = 1.0, x = 0.3, y = 0.0;
