...
TEUCHOS_UNIT_TEST( StreamHelpers, pair_ostream )
{
...
TEUCHOS_UNIT_TEST( StreamHelpers, pair_istream )
{
...
TEUCHOS_UNIT_TEST( StreamHelpers, tuple_ostream )
{
  std::ostringstream oss;
...
TEUCHOS_UNIT_TEST( StreamHelpers, tuple_istream )
{
...
TEUCHOS_UNIT_TEST( StreamHelpers, array_ostream )
{
  std::ostringstream oss;
