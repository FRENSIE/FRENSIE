...
#include "Utility_HistogramPartiallyTabularBivariateDistribution.hpp"
...
// Testing Variables
//---------------------------------------------------------------------------//
std::shared_ptr<Utility::UnitAwarePartiallyTabularBivariateDistribution<MegaElectronVolt,cgs::length,Barn> > 
  unit_aware_distribution;

std::shared_ptr<Utility::PartiallyTabularBivariateDistribution> distribution;
...
// can be returned
TEUCHOS_UNIT_TEST( HistogramPartiallyTabularBivariateDistribution,
...
TEUCHOS_UNIT_TEST( UnitAwareHistogramPartiallyTabularBivariateDistribution,
                   getUpperBoundOfPrimaryIndepVar )
{
                   ...
                   getUpperBoundOfConditionalIndepVar )
{
  ...
  // After the third bin - no extension
  TEST_EQUALITY_CONST(
         unit_aware_distribution->getUpperBoundOfConditionalIndepVar(3.0*MeV),
         0.0*cgs::centimeter );
                   ...
                   getLowerBoundOfConditionalIndepVar )
{
  ...
  // After the third bin - no extension
  TEST_EQUALITY_CONST(
         unit_aware_distribution->getLowerBoundOfConditionalIndepVar(3.0*MeV),
         0.0*cgs::centimeter );
...
{
  std::shared_ptr<Utility::BivariateDistribution> other_distribution;
  
  {
    Utility::HistogramPartiallyTabularBivariateDistribution::DistributionType
      distribution_data( 2 );
    ...
    other_distribution.reset(
                       new Utility::HistogramPartiallyTabularBivariateDistribution(
                                                         distribution_data ) );
  }
...
TEUCHOS_UNIT_TEST( UnitAwareHistogramPartiallyTabularBivariateDistribution,
                   hasSamePrimaryBounds )
{
  std::shared_ptr<Utility::UnitAwareBivariateDistribution<MegaElectronVolt,cgs::length,Barn> > other_distribution;
  
  {
    Utility::UnitAwareHistogramPartiallyTabularBivariateDistribution<MegaElectronVolt,cgs::length,Barn>::DistributionType
      distribution_data( 2 );
    ...
    other_distribution.reset(
                       new Utility::UnitAwareHistogramPartiallyTabularBivariateDistribution<MegaElectronVolt,cgs::length,Barn>(
                                                         distribution_data ) );
  }
...
TEUCHOS_UNIT_TEST( HistogramPartiallyTabularBivariateDistribution, evaluate )
{
  // Before the first bin - no extension
...
UTILITY_CUSTOM_TEUCHOS_UNIT_TEST_DATA_INITIALIZATION()
{
  // Create the two-dimensional distribution
  {
    ...
    Utility::get<1>( distribution_data[1] ).reset( new Utility::ExponentialDistribution( 1.0, 1.0 ) );
    ...
    distribution.reset( new Utility::HistogramPartiallyTabularBivariateDistribution(
                                                         distribution_data ) );
  }
  ...
  // Create the unit-aware two-dimensional distribution
  {
    ...
    Teuchos::Array<std::shared_ptr<const Utility::UnitAwareUnivariateDistribution<cgs::length,Barn> > > secondary_dists( 4 );
    ...
    unit_aware_distribution.reset( new Utility::UnitAwareHistogramPartiallyTabularBivariateDistribution<MegaElectronVolt,cgs::length,Barn>( primary_bins, secondary_dists ) );
  }
...
//---------------------------------------------------------------------------//
// end tstHistogramPartiallyTabularBivariateDistribution.cpp
//---------------------------------------------------------------------------//
