...
#include "Utility_HistogramFullyTabularBivariateDistribution.hpp"
...
// Testing Variables
//---------------------------------------------------------------------------//
std::shared_ptr<Utility::UnitAwareBivariateDistribution<MegaElectronVolt,cgs::length,Barn> > 
  unit_aware_distribution;

std::shared_ptr<Utility::UnitAwareFullyTabularBivariateDistribution<MegaElectronVolt,cgs::length,Barn> >
  unit_aware_tab_distribution;

std::shared_ptr<Utility::BivariateDistribution> distribution;

std::shared_ptr<Utility::FullyTabularBivariateDistribution> tab_distribution;
...
// can be returned
TEUCHOS_UNIT_TEST( HistogramFullyTabularBivariateDistribution,
...
TEUCHOS_UNIT_TEST( UnitAwareHistogramFullyTabularBivariateDistribution,
                   getUpperBoundOfPrimaryIndepVar )
{
                   ...
                   hasSamePrimaryBounds )
{
  ...
  {
    Utility::HistogramFullyTabularBivariateDistribution::DistributionType
      distribution_data( 2 );
    ...
    other_distribution.reset(
                       new Utility::HistogramFullyTabularBivariateDistribution(
                                                         distribution_data ) );
  }
                   ...
                   hasSamePrimaryBounds )
{
  ...
  {
    Utility::UnitAwareHistogramFullyTabularBivariateDistribution<MegaElectronVolt,cgs::length,Barn>::DistributionType
      distribution_data( 2 );
    ...
    other_distribution.reset(
                       new Utility::UnitAwareHistogramFullyTabularBivariateDistribution<MegaElectronVolt,cgs::length,Barn>(
                                                         distribution_data ) );
  }
...
TEUCHOS_UNIT_TEST( HistogramFullyTabularBivariateDistribution, evaluate )
{
  // Before the first bin - no extension
...
TEUCHOS_UNIT_TEST( UnitAwareHistogramFullyTabularBivariateDistribution, evaluate )
{
  // Before the first bin - no extension
...
UTILITY_CUSTOM_TEUCHOS_UNIT_TEST_DATA_INITIALIZATION()
{
  // Create the two-dimensional distribution
  {
    ...
    tab_distribution.reset( new Utility::HistogramFullyTabularBivariateDistribution(
                                                         distribution_data ) );
  ...
  // Create the unit-aware two-dimensional distribution
  {
    ...
    Teuchos::Array<std::shared_ptr<const Utility::UnitAwareTabularUnivariateDistribution<cgs::length,Barn> > > secondary_dists( 4 );
    ...
    unit_aware_tab_distribution.reset( new Utility::UnitAwareHistogramFullyTabularBivariateDistribution<MegaElectronVolt,cgs::length,Barn>( primary_bins, secondary_dists ) );
...
//---------------------------------------------------------------------------//
// end tstHistogramFullyTabularBivariateDistribution.hpp
//---------------------------------------------------------------------------//
