                   ...
                   sampleSecondaryConditionalExactWithRandomNumberInSubrange )
{
  ...
  sample = tab_distribution->sampleSecondaryConditionalExactWithRandomNumberInSubrange( 0.5, 0.0, 8.0 );
  TEST_EQUALITY_CONST( sample, 1.25 );

  sample = tab_distribution->sampleSecondaryConditionalExactWithRandomNumberInSubrange( 0.5, 0.5, 8.0 );
  TEST_FLOATING_EQUALITY( sample, 4.62829175487371547, 1e-12 );

  sample = tab_distribution->sampleSecondaryConditionalExactWithRandomNumberInSubrange( 0.5, 1.0-1e-15, 8.0 );
                   ...
                   correlatedSampleSecondaryConditional )
{
  ...
  sample = tab_distribution->correlatedSampleSecondaryConditionalInBoundaries( 2.0, lower_func, upper_func );
  TEST_EQUALITY_CONST( sample, 0.0 );
  ...
  // After the third bin - no extension
  TEST_THROW( tab_distribution->correlatedSampleSecondaryConditionalInBoundaries( 3.0, lower_func, upper_func ),
              std::logic_error );
  ...
  sample = tab_distribution->correlatedSampleSecondaryConditionalInBoundaries( 3.0, lower_func, upper_func );
  TEST_EQUALITY_CONST( sample, 0.0 );
...
{
  initialize<Utility::Correlated>( tab_distribution, distribution );
  lower_func = [](double x){return 0.0;};

  // Before the first bin - no extension
  TEST_THROW( tab_distribution->correlatedSampleSecondaryConditionalInSubrangeInBoundaries( -1.0, lower_func, 7.5 ),
              std::logic_error );
  ...
  // Subrange
  double sample = tab_distribution->correlatedSampleSecondaryConditionalInSubrangeInBoundaries( -1.0, lower_func, 7.5 );
  TEST_EQUALITY_CONST( sample, 0.0 );

  sample = tab_distribution->correlatedSampleSecondaryConditionalInSubrangeInBoundaries( -1.0, lower_func, 7.5 );
  TEST_EQUALITY_CONST( sample, 3.75 );
  ...
  // Beyond full range - check that expected range will be used
  sample = tab_distribution->correlatedSampleSecondaryConditionalInSubrangeInBoundaries( -1.0, lower_func, 11.0 );
  TEST_EQUALITY_CONST( sample, 0.0 );
  ...
  sample = tab_distribution->correlatedSampleSecondaryConditionalInSubrangeInBoundaries( 0.0, lower_func, 7.5 );
  TEST_EQUALITY_CONST( sample, 0.0 );
  ...
  fake_stream[2] = 1.0-1e-15;
  Utility::RandomNumberGenerator::setFakeStream( fake_stream );
  lower_func = [](double x){return 1.25;};

  sample = tab_distribution->correlatedSampleSecondaryConditionalInSubrangeInBoundaries( 0.5, lower_func, 7.5 );
  TEST_EQUALITY_CONST( sample, 1.25 );
  ...
  // On the third bin
  Utility::RandomNumberGenerator::setFakeStream( fake_stream );
  lower_func = [](double x){return 2.5;};
  ...
  sample = tab_distribution->correlatedSampleSecondaryConditionalInSubrangeInBoundaries( 1.5, lower_func, 7.5 );
  TEST_EQUALITY_CONST( sample, 1.25 );
  ...
  sample = tab_distribution->correlatedSampleSecondaryConditionalInSubrangeInBoundaries( 2.0, lower_func, 7.5 );
  TEST_EQUALITY_CONST( sample, 0.0 );
  ...
  // After the third bin - no extension
  TEST_THROW( tab_distribution->correlatedSampleSecondaryConditionalInSubrangeInBoundaries( 3.0, lower_func, 7.5 ),
              std::logic_error );
  ...
  sample = tab_distribution->correlatedSampleSecondaryConditionalInSubrangeInBoundaries( 3.0, lower_func, 7.5 );
  TEST_EQUALITY_CONST( sample, 0.0 );
                   ...
                   correlatedSampleSecondaryConditionalInSubrangeInBoundaries )
{
  ...
  // Before the first bin - no extension
  TEST_THROW( unit_aware_tab_distribution->correlatedSampleSecondaryConditionalInSubrangeInBoundaries( -1.0*MeV, ua_lower_func,  7.5*cgs::centimeter ),
              std::logic_error );
  ...
  // Subrange
  quantity<cgs::length> sample = unit_aware_tab_distribution->correlatedSampleSecondaryConditionalInSubrangeInBoundaries( -1.0*MeV, ua_lower_func,  7.5*cgs::centimeter);
  TEST_EQUALITY_CONST( sample, 0.0*cgs::centimeter );

  sample = unit_aware_tab_distribution->correlatedSampleSecondaryConditionalInSubrangeInBoundaries( -1.0*MeV, ua_lower_func,  7.5*cgs::centimeter);
  TEST_EQUALITY_CONST( sample, 3.75*cgs::centimeter );
  ...
  // Beyond full range - check that expected range will be used
  sample = unit_aware_tab_distribution->correlatedSampleSecondaryConditionalInSubrangeInBoundaries( -1.0*MeV, ua_lower_func,  11.0*cgs::centimeter );
  TEST_EQUALITY_CONST( sample, 0.0*cgs::centimeter );
  ...
  sample = unit_aware_tab_distribution->correlatedSampleSecondaryConditionalInSubrangeInBoundaries( 0.0*MeV, ua_lower_func,  7.5*cgs::centimeter);
  TEST_EQUALITY_CONST( sample, 0.0*cgs::centimeter );
  ...
  sample = unit_aware_tab_distribution->correlatedSampleSecondaryConditionalInSubrangeInBoundaries( 0.5*MeV, ua_lower_func,  7.5*cgs::centimeter);
  TEST_EQUALITY_CONST( sample, 1.25*cgs::centimeter );
  ...
  sample = unit_aware_tab_distribution->correlatedSampleSecondaryConditionalInSubrangeInBoundaries( 1.5*MeV, ua_lower_func,  7.5*cgs::centimeter);
  TEST_EQUALITY_CONST( sample, 1.25*cgs::centimeter );
  ...
  sample = unit_aware_tab_distribution->correlatedSampleSecondaryConditionalInSubrangeInBoundaries( 2.0*MeV, ua_lower_func,  7.5*cgs::centimeter);
  TEST_EQUALITY_CONST( sample, 0.0*cgs::centimeter );
  ...
  // After the third bin - no extension
  TEST_THROW( unit_aware_tab_distribution->correlatedSampleSecondaryConditionalInSubrangeInBoundaries( 3.0*MeV, ua_lower_func,  7.5*cgs::centimeter ),
              std::logic_error );
  ...
  sample = unit_aware_tab_distribution->correlatedSampleSecondaryConditionalInSubrangeInBoundaries( 3.0*MeV, ua_lower_func,  7.5*cgs::centimeter );
  TEST_EQUALITY_CONST( sample, 0.0*cgs::centimeter );
