//---------------------------------------------------------------------------//
//!
//! \file   tstLinLinLinInterpolatedFullyTabularBivariateDistribution.cpp
...
#include "Utility_InterpolatedFullyTabularBivariateDistribution.hpp"
...
TEUCHOS_UNIT_TEST( InterpolatedFullyTabularBivariateDistribution,
...
TEUCHOS_UNIT_TEST( UnitAwareInterpolatedFullyTabularBivariateDistribution,
                   isPrimaryDimensionTabular )
{
                   ...
                   hasSamePrimaryBounds )
{
  ...
  std::shared_ptr<Utility::FullyTabularBivariateDistribution> test_dist;

  {
    Utility::FullyTabularBivariateDistribution::DistributionType
      distribution_data( 2 );
    ...
    test_dist.reset( new Utility::InterpolatedFullyTabularBivariateDistribution<Utility::LinLinLin>(
                                                         distribution_data ) );
  }
...
TEUCHOS_UNIT_TEST( InterpolatedFullyTabularBivariateDistribution, evaluate )
{
  // Before the first bin - no extension
...
UTILITY_CUSTOM_TEUCHOS_UNIT_TEST_DATA_INITIALIZATION()
{
  // Create the two-dimensional distribution
  {
    ...
    tab_distribution.reset( new Utility::InterpolatedFullyTabularBivariateDistribution<Utility::LinLinLin>(
                                                         distribution_data ) );
  ...
  // Create the unit-aware two-dimensional distribution
  {
    ...
    unit_aware_tab_distribution.reset( new Utility::UnitAwareInterpolatedFullyTabularBivariateDistribution<Utility::LinLinLin,MegaElectronVolt,cgs::length,Barn>( primary_bins, secondary_dists ) );
...
//---------------------------------------------------------------------------//
// end tstLinLinLinInterpolatedFullyTabularBivariateDistribution.cpp
//---------------------------------------------------------------------------//
