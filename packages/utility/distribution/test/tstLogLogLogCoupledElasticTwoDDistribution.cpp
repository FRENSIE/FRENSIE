                 ...
                 std::shared_ptr<BaseDistribution>& dist )
{
  ...
  tab_dist.reset( new Utility::UnitAwareElasticTwoDDistribution<TwoDGridPolicy<Utility::LogLogCosLog<true> >,typename BaseTabDistribution::PrimaryIndepUnit,typename BaseTabDistribution::SecondaryIndepUnit,typename BaseTabDistribution::DepUnit>(
                   ...
                   hasSamePrimaryBounds )
{
  ...
  // Create a test distribution with different bounds
  {
    ...
    test_dist.reset( new Utility::InterpolatedFullyTabularTwoDDistribution<Utility::UnitBase<Utility::LogLogLog> >(
                                                               primary_grid,
                                                               secondary_grids,
                                                               values ) );
  }
                   ...
                   evaluateSecondaryConditionalCDF_direct )
{
  ...
  TEST_FLOATING_EQUALITY( tab_distribution->evaluateSecondaryConditionalCDF( 3.0, 0.0 ),
                          2.57143040816457724151e-01,
                          1e-15 );
  TEST_EQUALITY_CONST( tab_distribution->evaluateSecondaryConditionalCDF( 3.0, 0.999999 ), 0.9 );
