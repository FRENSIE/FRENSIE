//---------------------------------------------------------------------------//
//!
//! \file   tstLinLinLinInterpolatedPartiallyTabularBasicBivariateDistribution.cpp
//! \author Alex Robinson
//! \brief  The interpolated partially tabular basic bivariate dist. unit tests
                   ...
                   hasSamePrimaryBounds )
{
...

  {
    ...
    test_dist.reset( new Utility::InterpolatedPartiallyTabularBasicBivariateDistribution<Utility::LinLinLin>(
                                   ...
                                   TestArchives )
{
  ...
  std::string archive_base_name( "test_interpolated_partially_tabular_basic_bivariate_dist" );
  ...
  // Create and archive some distributions
  {
    ...
    std::shared_ptr<Utility::InterpolatedPartiallyTabularBasicBivariateDistribution<Utility::LinLinLin> >
      concrete_distribution = std::dynamic_pointer_cast<Utility::InterpolatedPartiallyTabularBasicBivariateDistribution<Utility::LinLinLin> >( distribution );

    std::shared_ptr<Utility::BasicBivariateDistribution> base_distribution =
    ...
    FRENSIE_REQUIRE_NO_THROW( (*oarchive) << BOOST_SERIALIZATION_NVP( base_distribution ) );
  }
  ...
  FRENSIE_REQUIRE_NO_THROW( (*iarchive) >> boost::serialization::make_nvp( "distribution", local_tab_dist ) );
  FRENSIE_CHECK_EQUAL( Utility::toString( *local_tab_dist ),
                       Utility::toString( *distribution ),
                       SHOW_BOTH );

  std::shared_ptr<Utility::BasicBivariateDistribution> local_base_dist;

  FRENSIE_REQUIRE_NO_THROW( (*iarchive) >> boost::serialization::make_nvp( "base_distribution", local_base_dist ) );
  FRENSIE_CHECK_EQUAL( Utility::toString( *local_base_dist ),
                       Utility::toString( *distribution ),
                       SHOW_BOTH );
}
                                   ...
                                   TestArchives )
{
  ...
  std::string archive_base_name( "test_unit_aware_interpolated_partially_tabular_basic_bivariate_dist" );
  std::ostringstream archive_ostream;
  ...
  // Create and archive some distributions
  {
    ...
    std::shared_ptr<Utility::UnitAwareInterpolatedPartiallyTabularBasicBivariateDistribution<Utility::LinLinLin,MegaElectronVolt,cgs::length,Barn> >
      concrete_distribution = std::dynamic_pointer_cast<Utility::UnitAwareInterpolatedPartiallyTabularBasicBivariateDistribution<Utility::LinLinLin,MegaElectronVolt,cgs::length,Barn> >( unit_aware_distribution );

    std::shared_ptr<Utility::UnitAwareBasicBivariateDistribution<MegaElectronVolt,cgs::length,Barn> >
      base_distribution = concrete_distribution;

    FRENSIE_REQUIRE_NO_THROW( (*oarchive) << BOOST_SERIALIZATION_NVP( concrete_distribution ) );
    FRENSIE_REQUIRE_NO_THROW( (*oarchive) << boost::serialization::make_nvp( "tab_distribution", unit_aware_distribution ) );
    FRENSIE_REQUIRE_NO_THROW( (*oarchive) << BOOST_SERIALIZATION_NVP( base_distribution ) );
  }
  ...
  std::shared_ptr<Utility::UnitAwareBasicBivariateDistribution<MegaElectronVolt,cgs::length,Barn> > local_base_dist;
...
FRENSIE_CUSTOM_UNIT_TEST_INIT()
{
  // Create the two-dimensional distribution
  {
    ...
    distribution.reset( new Utility::InterpolatedPartiallyTabularBasicBivariateDistribution<Utility::LinLinLin>(
                                             primary_grid, secondary_dists ) );
  }
  ...
  // Create the unit-aware two-dimensional distribution
  {
    ...
    unit_aware_distribution.reset( new Utility::UnitAwareInterpolatedPartiallyTabularBasicBivariateDistribution<Utility::LinLinLin,MegaElectronVolt,cgs::length,Barn>( primary_bins, secondary_dists ) );
  }
...
//---------------------------------------------------------------------------//
// end tstLinLinLinInterpolatedPartiallyTabularBasicBivariateDistribution.cpp
//---------------------------------------------------------------------------//
