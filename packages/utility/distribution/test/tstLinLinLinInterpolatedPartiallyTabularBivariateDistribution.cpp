//---------------------------------------------------------------------------//
//!
//! \file   tstLinLinLinInterpolatedPartiallyTabularBivariateDistribution.cpp
...
#include "Utility_InterpolatedPartiallyTabularBivariateDistribution.hpp"
...
TEUCHOS_UNIT_TEST( InterpolatedPartiallyTabularBivariateDistribution,
...
TEUCHOS_UNIT_TEST( UnitAwareInterpolatedPartiallyTabularBivariateDistribution,
                   isPrimaryDimensionTabular )
{
                   ...
                   hasSamePrimaryBounds )
{
  ...
  std::shared_ptr<Utility::PartiallyTabularBivariateDistribution> test_dist;

  {
    Utility::PartiallyTabularBivariateDistribution::DistributionType
      distribution_data( 2 );
    ...
    test_dist.reset( new Utility::InterpolatedPartiallyTabularBivariateDistribution<Utility::LinLinLin>(
                                                         distribution_data ) );
  }
...
TEUCHOS_UNIT_TEST( InterpolatedPartiallyTabularBivariateDistribution, evaluate )
{
  // Before the first bin - no extension
...
UTILITY_CUSTOM_TEUCHOS_UNIT_TEST_DATA_INITIALIZATION()
{
  // Create the two-dimensional distribution
  {
    ...
    distribution.reset( new Utility::InterpolatedPartiallyTabularBivariateDistribution<Utility::LinLinLin>(
                                                         distribution_data ) );
  }
  ...
  // Create the unit-aware two-dimensional distribution
  {
    ...
    unit_aware_distribution.reset( new Utility::UnitAwareInterpolatedPartiallyTabularBivariateDistribution<Utility::LinLinLin,MegaElectronVolt,cgs::length,Barn>( primary_bins, secondary_dists ) );
  }
...
//---------------------------------------------------------------------------//
// end tstLinLinLinInterpolatedPartiallyTabularBivariateDistribution.cpp
//---------------------------------------------------------------------------//
