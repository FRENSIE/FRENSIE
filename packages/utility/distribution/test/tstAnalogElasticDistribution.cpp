...
//  typedef Utility::UnitAwareAnalogElasticDistribution<InterpolationPolicy,MegaElectronVolt,si::amount> Distribution;
...
//  std::ostringstream xml_file_name;
//  xml_file_name << "unit_aware_analog_elastic_" << InterpolationPolicy::name()
//		<< "_dist_test_list.xml";
...
//{
//  Utility::UnitAwareAnalogElasticDistribution<Utility::LinLin,MegaElectronVolt,si::amount>
//    distribution_1 =
//    test_dists_list->get<Utility::UnitAwareAnalogElasticDistribution<Utility::LinLin,MegaElectronVolt,si::amount> >( "Unit-Aware Analog Elastic Distribution A" );
...
//  distribution_1 =
//    test_dists_list->get<Utility::UnitAwareAnalogElasticDistribution<Utility::LinLin,MegaElectronVolt,si::amount> >( "Unit-Aware Analog Elastic Distribution B" );

//  TEST_EQUALITY_CONST( distribution_1.getLowerBoundOfIndepVar(), 0.001*MeV );
//  TEST_EQUALITY_CONST( distribution_1.getUpperBoundOfIndepVar(), 1.0*MeV );

//  Utility::UnitAwareAnalogElasticDistribution<Utility::LogLog,MegaElectronVolt,si::amount>
//    distribution_2 =
//    test_dists_list->get<Utility::UnitAwareAnalogElasticDistribution<Utility::LogLog,MegaElectronVolt,si::amount> >( "Unit-Aware Analog Elastic Distribution C" );
...
UTILITY_CUSTOM_TEUCHOS_UNIT_TEST_DATA_INITIALIZATION()
{
  ...
  typedef Utility::UnitAwareAnalogElasticDistribution<Utility::LinLin,MegaElectronVolt,si::amount> UnitAwareAnalogElasticLinLinDist;
  TEUCHOS_ADD_TYPE_CONVERTER( UnitAwareAnalogElasticLinLinDist );
  typedef Utility::UnitAwareAnalogElasticDistribution<Utility::LogLin,MegaElectronVolt,si::amount> UnitAwareAnalogElasticLogLinDist;
  TEUCHOS_ADD_TYPE_CONVERTER( UnitAwareAnalogElasticLogLinDist );
  typedef Utility::UnitAwareAnalogElasticDistribution<Utility::LinLog,MegaElectronVolt,si::amount> UnitAwareAnalogElasticLinLogDist;
  TEUCHOS_ADD_TYPE_CONVERTER( UnitAwareAnalogElasticLinLogDist );
  typedef Utility::UnitAwareAnalogElasticDistribution<Utility::LogLog,MegaElectronVolt,si::amount> UnitAwareAnalogElasticLogLogDist;
