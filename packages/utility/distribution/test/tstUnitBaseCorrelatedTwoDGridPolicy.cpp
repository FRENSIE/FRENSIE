...
//! \brief  The Unit-base Correlated two-dimensional grid policy unit tests
//!
//---------------------------------------------------------------------------//
                   ...
                   name )
{
  ...
  name = Utility::UnitBaseCorrelated<Utility::LogLogLog>::name();
