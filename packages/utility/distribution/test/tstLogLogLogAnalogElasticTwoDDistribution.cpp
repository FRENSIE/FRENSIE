...
//  TEST_EQUALITY_CONST( unit_aware_distribution->evaluate( 0.0*MeV, 0.0*cgs::dimensionless() ), 0.1*barn );
//  TEST_EQUALITY_CONST( unit_aware_distribution->evaluate( 0.0*MeV, 1.0*cgs::dimensionless() ), 0.1*barn );
//  TEST_EQUALITY_CONST( unit_aware_distribution->evaluate( 0.0*MeV, 2.0*cgs::dimensionless() ), 0.0*barn );
...
//  TEST_EQUALITY_CONST( unit_aware_distribution->evaluate( 1.0*MeV, -1.0*cgs::dimensionless() ), 1.0*barn );
...
//  UTILITY_TEST_FLOATING_EQUALITY( unit_aware_distribution->evaluate( 1.5*MeV, -1.0*cgs::dimensionless() ), 0.55*barn, 1e-15 );
//  UTILITY_TEST_FLOATING_EQUALITY( unit_aware_distribution->evaluate( 1.5*MeV, 0.0*cgs::dimensionless() ), 1.0*barn, 1e-15 );
//  UTILITY_TEST_FLOATING_EQUALITY( unit_aware_distribution->evaluate( 1.5*MeV, 1.0*cgs::dimensionless() ), 0.75*barn, 1e-15 );
//  TEST_EQUALITY_CONST( unit_aware_distribution->evaluate( 1.5*MeV, 2.0*cgs::dimensionless() ), 0.0*barn );
...
//{
//  // Before the first bin - no extension
//  TEST_EQUALITY_CONST( unit_aware_distribution->evaluateSecondaryConditionalPDF( 0.0*MeV, -1.0*cgs::dimensionless() ), 0.0/cgs::dimensionless() );
//  TEST_EQUALITY_CONST( unit_aware_distribution->evaluateSecondaryConditionalPDF( 0.0*MeV, 0.0*cgs::dimensionless() ), 0.0/cgs::dimensionless() );
//  TEST_EQUALITY_CONST( unit_aware_distribution->evaluateSecondaryConditionalPDF( 0.0*MeV, 1.0*cgs::dimensionless() ), 0.0/cgs::dimensionless() );
...
//  // Before the first bin - no extension
//  TEST_EQUALITY_CONST( unit_aware_tab_distribution->evaluateSecondaryConditionalPDFExact( 0.0*MeV, -1.0*cgs::dimensionless() ), 0.0*barn );
//  TEST_EQUALITY_CONST( unit_aware_tab_distribution->evaluateSecondaryConditionalPDFExact( 0.0*MeV, 0.0*cgs::dimensionless() ), 0.0*barn );
//  TEST_EQUALITY_CONST( unit_aware_tab_distribution->evaluateSecondaryConditionalPDFExact( 0.0*MeV, 0.999999*cgs::dimensionless() ), 0.0*barn );
//  TEST_EQUALITY_CONST( unit_aware_tab_distribution->evaluateSecondaryConditionalPDFExact( 0.0*MeV, 1.0*cgs::dimensionless() ), 0.0*barn );

//  // Before the first bin - with extension
//  unit_aware_tab_distribution->extendBeyondPrimaryIndepLimits();

//  TEST_EQUALITY_CONST( unit_aware_tab_distribution->evaluateSecondaryConditionalPDFExact( 0.0*MeV, -1.0*cgs::dimensionless() ), 0.1*barn );
//  TEST_EQUALITY_CONST( unit_aware_tab_distribution->evaluateSecondaryConditionalPDFExact( 0.0*MeV, 0.0*cgs::dimensionless() ), 0.5*barn );
//  TEST_EQUALITY_CONST( unit_aware_tab_distribution->evaluateSecondaryConditionalPDFExact( 0.0*MeV, 0.999999*cgs::dimensionless() ), 1.0*barn );
...
//  // On the first bin boundary
//  TEST_EQUALITY_CONST( unit_aware_tab_distribution->evaluateSecondaryConditionalPDFExact( 1.0*MeV, -1.0*cgs::dimensionless() ), 0.1*barn );
//  TEST_EQUALITY_CONST( unit_aware_tab_distribution->evaluateSecondaryConditionalPDFExact( 1.0*MeV, 0.0*cgs::dimensionless() ), 0.5*barn );
//  TEST_EQUALITY_CONST( unit_aware_tab_distribution->evaluateSecondaryConditionalPDFExact( 1.0*MeV, 0.999999*cgs::dimensionless() ), 1.0*barn );
...
//  // On the upper bin boundary
//  TEST_EQUALITY_CONST( unit_aware_tab_distribution->evaluateSecondaryConditionalPDFExact( 2.0*MeV, -1.0*cgs::dimensionless() ), 1.0*barn );
//  TEST_EQUALITY_CONST( unit_aware_tab_distribution->evaluateSecondaryConditionalPDFExact( 2.0*MeV, 0.0*cgs::dimensionless() ), 5.0*barn );
//  TEST_EQUALITY_CONST( unit_aware_tab_distribution->evaluateSecondaryConditionalPDFExact( 2.0*MeV, 0.999999*cgs::dimensionless() ), 10.0*barn );
...
//  // After the second bin - no extension
//  TEST_EQUALITY_CONST( unit_aware_tab_distribution->evaluateSecondaryConditionalPDFExact( 3.0*MeV, -1.0*cgs::dimensionless() ), 0.0*barn );
//  TEST_EQUALITY_CONST( unit_aware_tab_distribution->evaluateSecondaryConditionalPDFExact( 3.0*MeV, 0.0*cgs::dimensionless() ), 0.0*barn );
//  TEST_EQUALITY_CONST( unit_aware_tab_distribution->evaluateSecondaryConditionalPDFExact( 3.0*MeV, 0.999999*cgs::dimensionless() ), 0.0*barn );
//  TEST_EQUALITY_CONST( unit_aware_tab_distribution->evaluateSecondaryConditionalPDFExact( 3.0*MeV, 1.0*cgs::dimensionless() ), 0.0*barn );

//  // After the second bin - with extension
//  unit_aware_tab_distribution->extendBeyondPrimaryIndepLimits();

//  TEST_EQUALITY_CONST( unit_aware_tab_distribution->evaluateSecondaryConditionalPDFExact( 3.0*MeV, -1.0*cgs::dimensionless() ), 1.0*barn );
//  TEST_EQUALITY_CONST( unit_aware_tab_distribution->evaluateSecondaryConditionalPDFExact( 3.0*MeV, 0.0*cgs::dimensionless() ), 5.0*barn );
//  TEST_EQUALITY_CONST( unit_aware_tab_distribution->evaluateSecondaryConditionalPDFExact( 3.0*MeV, 0.999999*cgs::dimensionless() ), 10.0*barn );
//  UTILITY_TEST_FLOATING_EQUALITY( unit_aware_tab_distribution->evaluateSecondaryConditionalPDFExact( 2.0*MeV, 1.0*cgs::dimensionless() ),
//                                  9.000018000008997987*barn,
//                                  1e-15 );
...
//  Utility::RandomNumberGenerator::setFakeStream( fake_stream );
//  
//  quantity<cgs::dimensionless> sample = unit_aware_tab_distribution->sampleSecondaryConditionalAndRecordBinIndices( 0.0*MeV, primary_bin_index, secondary_bin_index );
...
//  quantity<cgs::dimensionless> sample = unit_aware_tab_distribution->sampleSecondaryConditionalAndRecordBinIndices( 0.0*MeV, raw_sample, primary_bin_index, secondary_bin_index );
...
//  quantity<cgs::dimensionless> sample = unit_aware_tab_distribution->sampleSecondaryConditionalWithRandomNumber( 0.0*MeV, 0.0 );
...
//  // Subrange
//  double sample = tab_distribution->sampleSecondaryConditionalInSubrange( 0.0, 0.0 );
...
//  // Subrange
//  quantity<cgs::dimensionless> sample = unit_aware_tab_distribution->sampleSecondaryConditionalInSubrange( 0.0*MeV, 0.0*cgs::dimensionless() );
//  TEST_EQUALITY_CONST( sample, -1.0*cgs::dimensionless() );
...
//{ 
//  // Before the first bin - no extension
//  TEST_THROW( tab_distribution->sampleSecondaryConditionalWithRandomNumberInSubrange( 0.0, 0.0, 0.0 ),
//              std::logic_error );
...
//  // Subrange
//  double sample = tab_distribution->sampleSecondaryConditionalWithRandomNumberInSubrange( 0.0, 0.0, 0.0 );
//  TEST_EQUALITY_CONST( sample, -1.0 );
...
//{ 
//  // Before the first bin - no extension
//  TEST_THROW( unit_aware_tab_distribution->sampleSecondaryConditionalWithRandomNumberInSubrange( 0.0*MeV, 0.0, 0.0*cgs::dimensionless() ),
//              std::logic_error );
...
//  // Subrange
//  quantity<cgs::dimensionless> sample = unit_aware_tab_distribution->sampleSecondaryConditionalWithRandomNumberInSubrange( 0.0*MeV, 0.0, 0.0*cgs::dimensionless() );
//  TEST_EQUALITY_CONST( sample, -1.0*cgs::dimensionless() );
...
//  quantity<cgs::dimensionless> sample = unit_aware_tab_distribution->sampleSecondaryConditionalExact( 0.0*MeV );
//  TEST_EQUALITY_CONST( sample, -1.0*cgs::dimensionless() );
...
//{
//  // Before the first bin - no extension
//  TEST_THROW( tab_distribution->sampleSecondaryConditionalExactWithRandomNumber( 0.0, 0.0 ),
//              std::logic_error );
...
//{
//  // Before the first bin - no extension
//  TEST_THROW( unit_aware_tab_distribution->sampleSecondaryConditionalExactWithRandomNumber( 0.0*MeV, 0.0 ),
//              std::logic_error );

//  // Before the first bin - with extension
//  unit_aware_tab_distribution->extendBeyondPrimaryIndepLimits();
//  
//  quantity<cgs::dimensionless> sample = unit_aware_tab_distribution->sampleSecondaryConditionalExactWithRandomNumber( 0.0*MeV, 0.0 );
...
//  // Subrange
//  double sample = tab_distribution->sampleSecondaryConditionalExactInSubrange( 0.0, 0.0 );
//  TEST_EQUALITY_CONST( sample, -1.0 );
...
//  // Subrange
//  quantity<cgs::dimensionless> sample = unit_aware_tab_distribution->sampleSecondaryConditionalExactInSubrange( 0.0*MeV, 0.0*cgs::dimensionless() );
//  TEST_EQUALITY_CONST( sample, -1.0*cgs::dimensionless() );
...
//{
//  // Before the first bin - no extension
//  TEST_THROW( tab_distribution->sampleSecondaryConditionalExactWithRandomNumberInSubrange( 0.0, 0.0, 0.0 ),
//              std::logic_error );
...
//  // Subrange
//  double sample = tab_distribution->sampleSecondaryConditionalExactWithRandomNumberInSubrange( 0.0, 0.0, 0.0 );
//  TEST_EQUALITY_CONST( sample, -1.0 );
...
//{
//  // Before the first bin - no extension
//  TEST_THROW( unit_aware_tab_distribution->sampleSecondaryConditionalExactWithRandomNumberInSubrange( 0.0*MeV, 0.0, 0.0*cgs::dimensionless() ),
//              std::logic_error );
...
//  // Subrange
//  quantity<cgs::dimensionless> sample = unit_aware_tab_distribution->sampleSecondaryConditionalExactWithRandomNumberInSubrange( 0.0*MeV, 0.0, 0.0*cgs::dimensionless() );
//  TEST_EQUALITY_CONST( sample, -1.0*cgs::dimensionless() );
...
//{
//  // Before the first bin - no extension
//  TEST_THROW( tab_distribution->correlatedSampleSecondaryConditionalWithRandomNumber( 0.0, 0.0 ),
//              std::logic_error );
...
//{
//  // Before the first bin - no extension
//  TEST_THROW( unit_aware_tab_distribution->correlatedSampleSecondaryConditionalWithRandomNumber( 0.0*MeV, 0.0 ),
//              std::logic_error );

//  // Before the first bin - with extension
//  unit_aware_tab_distribution->extendBeyondPrimaryIndepLimits();

//  quantity<cgs::dimensionless> sample = unit_aware_tab_distribution->correlatedSampleSecondaryConditionalWithRandomNumber( 0.0*MeV, 0.0 );
//  TEST_EQUALITY_CONST( sample, -1.0*cgs::dimensionless() );
...
//  // Subrange
//  double sample = tab_distribution->correlatedSampleSecondaryConditionalInSubrange( 0.0, 0.0 );
//  TEST_EQUALITY_CONST( sample, -1.0 );
...
//  // Subrange
//  quantity<cgs::dimensionless> sample = unit_aware_tab_distribution->correlatedSampleSecondaryConditionalInSubrange( 0.0*MeV, 0.0*cgs::dimensionless() );
//  TEST_EQUALITY_CONST( sample, -1.0*cgs::dimensionless() );
...
//{ 
//  // Before the first bin - no extension
//  TEST_THROW( tab_distribution->correlatedSampleSecondaryConditionalWithRandomNumberInSubrange( 0.0, 0.0, 0.0 ),
//              std::logic_error );
...
//  // Subrange
//  double sample = tab_distribution->correlatedSampleSecondaryConditionalWithRandomNumberInSubrange( 0.0, 0.0, 0.0 );
//  TEST_EQUALITY_CONST( sample, -1.0 );
...
//{ 
//  // Before the first bin - no extension
//  TEST_THROW( unit_aware_tab_distribution->correlatedSampleSecondaryConditionalWithRandomNumberInSubrange( 0.0*MeV, 0.0, 0.0*cgs::dimensionless() ),
//              std::logic_error );
...
//  // Subrange
//  quantity<cgs::dimensionless> sample = unit_aware_tab_distribution->correlatedSampleSecondaryConditionalWithRandomNumberInSubrange( 0.0*MeV, 0.0, 0.0*cgs::dimensionless() );
//  TEST_EQUALITY_CONST( sample, -1.0*cgs::dimensionless() );
...
//---------------------------------------------------------------------------//
// end tstLogLogLogAnalogElasticTwoDDistribution.cpp
//---------------------------------------------------------------------------//
