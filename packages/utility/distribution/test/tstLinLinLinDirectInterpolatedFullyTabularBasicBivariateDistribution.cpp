//---------------------------------------------------------------------------//
//!
//! \file   tstLinLinLinDirectInterpolatedFullyTabularBasicBivariateDistribution.cpp
                   ...
                   hasSamePrimaryBounds )
{
...

  {
    ...
    test_dist.reset( new Utility::InterpolatedFullyTabularBasicBivariateDistribution<Utility::Direct<Utility::LinLinLin>>(
...
FRENSIE_UNIT_TEST( InterpolatedFullyTabularBasicBivariateDistribution, evaluate )
{
  ...
  FRENSIE_CHECK_EQUAL( distribution->evaluate( 0.0, 5.0 ), 1.0 );
  FRENSIE_CHECK_EQUAL( distribution->evaluate( 0.0, 10.0 ), 1.0 );
  FRENSIE_CHECK_EQUAL( distribution->evaluate( 0.0, 11.0 ), 0.0 );

  // In the second bin
  FRENSIE_CHECK_EQUAL( distribution->evaluate( 0.5, 1.0 ), 0.5 );
  FRENSIE_CHECK_EQUAL( distribution->evaluate( 0.5, 1.25 ), 0.5 );
  FRENSIE_CHECK_FLOATING_EQUALITY( distribution->evaluate( 0.5, 5.0 ),
                          1.0,
                          1e-15 );
  FRENSIE_CHECK_EQUAL( distribution->evaluate( 0.5, 8.75 ), 0.5 );
  FRENSIE_CHECK_EQUAL( distribution->evaluate( 0.5, 9.0 ), 0.5 );

  // On the third bin boundary
  FRENSIE_CHECK_EQUAL( distribution->evaluate( 1.0, 2.0 ), 0.0 );
  FRENSIE_CHECK_EQUAL( distribution->evaluate( 1.0, 2.5 ), 0.1 );
  FRENSIE_CHECK_EQUAL( distribution->evaluate( 1.0, 5.0 ), 1.0 );
  FRENSIE_CHECK_EQUAL( distribution->evaluate( 1.0, 7.5 ), 0.5 );
  FRENSIE_CHECK_EQUAL( distribution->evaluate( 1.0, 8.0 ), 0.0 );

  // In the third bin
  FRENSIE_CHECK_EQUAL( distribution->evaluate( 1.5, 1.0 ), 0.05 );
  FRENSIE_CHECK_EQUAL( distribution->evaluate( 1.5, 1.25 ), 0.05 );
  FRENSIE_CHECK_FLOATING_EQUALITY( distribution->evaluate( 1.5, 5.0 ),
                          0.55,
                          1e-15 );
  FRENSIE_CHECK_EQUAL( distribution->evaluate( 1.5, 8.75 ), 0.05 );
                   ...
                   evaluate )
{
  ...
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluate( -1.0*MeV, -1.0*cgs::centimeter ), 0.0*barn );
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluate( -1.0*MeV, 0.0*cgs::centimeter ), 0.1*barn );
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluate( -1.0*MeV, 5.0*cgs::centimeter ), 0.1*barn );
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluate( -1.0*MeV, 10.0*cgs::centimeter ), 0.1*barn );
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluate( -1.0*MeV, 11.0*cgs::centimeter ), 0.0*barn );
  ...
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluate( 0.0*MeV, 5.0*cgs::centimeter ), 1.0*barn );
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluate( 0.0*MeV, 10.0*cgs::centimeter ), 1.0*barn );
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluate( 0.0*MeV, 11.0*cgs::centimeter ), 0.0*barn );

  // In the second bin
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluate( 0.5*MeV, 1.0*cgs::centimeter ), 0.5*barn );
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluate( 0.5*MeV, 1.25*cgs::centimeter ), 0.5*barn );
  FRENSIE_CHECK_FLOATING_EQUALITY( unit_aware_distribution->evaluate( 0.5*MeV, 5.0*cgs::centimeter ),
                                  1.0*barn,
                                  1e-15 );
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluate( 0.5*MeV, 8.75*cgs::centimeter ), 0.5*barn );
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluate( 0.5*MeV, 9.0*cgs::centimeter ), 0.5*barn );

  // On the third bin boundary
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluate( 1.0*MeV, 2.0*cgs::centimeter ), 0.0*barn );
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluate( 1.0*MeV, 2.5*cgs::centimeter ), 0.1*barn );
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluate( 1.0*MeV, 5.0*cgs::centimeter ), 1.0*barn );
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluate( 1.0*MeV, 7.5*cgs::centimeter ), 0.5*barn );
  ...
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluate( 1.5*MeV, 1.25*cgs::centimeter ), 0.05*barn );
  FRENSIE_CHECK_FLOATING_EQUALITY( unit_aware_distribution->evaluate( 1.5*MeV, 5.0*cgs::centimeter ),
                                  0.55*barn,
                                  1e-15 );
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluate( 1.5*MeV, 8.75*cgs::centimeter ), 0.05*barn );
  ...
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluate( 2.0*MeV, 0.0*cgs::centimeter ), 0.1*barn );
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluate( 2.0*MeV, 5.0*cgs::centimeter ), 0.1*barn );
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluate( 2.0*MeV, 10.0*cgs::centimeter ), 0.1*barn );
                   ...
                   evaluateSecondaryConditionalPDF )
{
  ...
  // In the second bin
  FRENSIE_CHECK_EQUAL( distribution->evaluateSecondaryConditionalPDF( 0.5, 1.0 ), 0.05 );
  FRENSIE_CHECK_EQUAL( distribution->evaluateSecondaryConditionalPDF( 0.5, 1.25 ), 0.05 );
  FRENSIE_CHECK_FLOATING_EQUALITY( distribution->evaluateSecondaryConditionalPDF( 0.5, 5.0 ),
                          2.0384615384615384e-01,
                          1e-15 );
  FRENSIE_CHECK_EQUAL( distribution->evaluateSecondaryConditionalPDF( 0.5, 8.75 ), 0.05 );
  FRENSIE_CHECK_EQUAL( distribution->evaluateSecondaryConditionalPDF( 0.5, 9.0 ), 0.05 );

  // On the third bin boundary
  FRENSIE_CHECK_EQUAL( distribution->evaluateSecondaryConditionalPDF( 1.0, 2.0 ), 0.0 );
  FRENSIE_CHECK_FLOATING_EQUALITY( distribution->evaluateSecondaryConditionalPDF( 1.0, 2.5 ),
                          0.03076923076923077,
                          1e-15 );
  FRENSIE_CHECK_FLOATING_EQUALITY( distribution->evaluateSecondaryConditionalPDF( 1.0, 5.0 ),
                          0.3076923076923077,
                          1e-15 );
  FRENSIE_CHECK_FLOATING_EQUALITY( distribution->evaluateSecondaryConditionalPDF( 1.0, 7.5 ),
                          0.15384615384615385,
                          1e-15 );
                   ...
                   evaluateSecondaryConditionalPDF )
{
  ...
  // In the second bin
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluateSecondaryConditionalPDF( 0.5*MeV, 1.0*cgs::centimeter ), 0.05/cgs::centimeter );
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluateSecondaryConditionalPDF( 0.5*MeV, 1.25*cgs::centimeter ), 0.05/cgs::centimeter );
  FRENSIE_CHECK_FLOATING_EQUALITY( unit_aware_distribution->evaluateSecondaryConditionalPDF( 0.5*MeV, 5.0*cgs::centimeter ),
                                  2.0384615384615384e-01/cgs::centimeter,
                                  1e-15 );
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluateSecondaryConditionalPDF( 0.5*MeV, 8.75*cgs::centimeter ), 0.05/cgs::centimeter );
  FRENSIE_CHECK_EQUAL( unit_aware_distribution->evaluateSecondaryConditionalPDF( 0.5*MeV, 9.0*cgs::centimeter ), 0.05/cgs::centimeter );
  ...
  FRENSIE_CHECK_FLOATING_EQUALITY( unit_aware_distribution->evaluateSecondaryConditionalPDF( 1.0*MeV, 2.5*cgs::centimeter ),
                                  0.03076923076923077/cgs::centimeter,
                                  1e-15 );
  FRENSIE_CHECK_FLOATING_EQUALITY( unit_aware_distribution->evaluateSecondaryConditionalPDF( 1.0*MeV, 5.0*cgs::centimeter ),
                                  0.3076923076923077/cgs::centimeter,
                                  1e-15 );
  FRENSIE_CHECK_FLOATING_EQUALITY( unit_aware_distribution->evaluateSecondaryConditionalPDF( 1.0*MeV, 7.5*cgs::centimeter ),
                   ...
                   evaluateSecondaryConditionalCDF )
{
  ...
  // In the second bin
  FRENSIE_CHECK_EQUAL( tab_distribution->evaluateSecondaryConditionalCDF( 0.5, 1.0 ), 0.05 );
  FRENSIE_CHECK_EQUAL( tab_distribution->evaluateSecondaryConditionalCDF( 0.5, 1.25 ), 0.0625 );
  FRENSIE_CHECK_FLOATING_EQUALITY( tab_distribution->evaluateSecondaryConditionalCDF( 0.5, 5.0 ),
                          4.6153846153846156e-01,
                          1e-15 );
  FRENSIE_CHECK_EQUAL( tab_distribution->evaluateSecondaryConditionalCDF( 0.5, 8.75 ), 0.9375 );
  FRENSIE_CHECK_EQUAL( tab_distribution->evaluateSecondaryConditionalCDF( 0.5, 9.0 ), 0.95 );
  ...
  FRENSIE_CHECK_FLOATING_EQUALITY( tab_distribution->evaluateSecondaryConditionalCDF( 1.5, 5.0 ),
                          4.6153846153846156e-01,
                          1e-15 );
  FRENSIE_CHECK_EQUAL( tab_distribution->evaluateSecondaryConditionalCDF( 1.5, 8.75 ), 0.9375 );
  FRENSIE_CHECK_EQUAL( tab_distribution->evaluateSecondaryConditionalCDF( 1.5, 9.0 ), 0.95 );
                   ...
                   evaluateSecondaryConditionalCDF )
{
  ...
  // In the second bin
  FRENSIE_CHECK_EQUAL( unit_aware_tab_distribution->evaluateSecondaryConditionalCDF( 0.5*MeV, 1.0*cgs::centimeter ), 0.05 );
  FRENSIE_CHECK_EQUAL( unit_aware_tab_distribution->evaluateSecondaryConditionalCDF( 0.5*MeV, 1.25*cgs::centimeter ), 0.0625 );
  FRENSIE_CHECK_FLOATING_EQUALITY( unit_aware_tab_distribution->evaluateSecondaryConditionalCDF( 0.5*MeV, 5.0*cgs::centimeter ),
                          4.6153846153846156e-01,
                          1e-15 );
  FRENSIE_CHECK_EQUAL( unit_aware_tab_distribution->evaluateSecondaryConditionalCDF( 0.5*MeV, 8.75*cgs::centimeter ), 0.9375 );
  FRENSIE_CHECK_EQUAL( unit_aware_tab_distribution->evaluateSecondaryConditionalCDF( 0.5*MeV, 9.0*cgs::centimeter ), 0.95 );
  ...
  FRENSIE_CHECK_FLOATING_EQUALITY( unit_aware_tab_distribution->evaluateSecondaryConditionalCDF( 1.5*MeV, 5.0*cgs::centimeter ),
                          4.6153846153846156e-01,
                          1e-15 );
  FRENSIE_CHECK_EQUAL( unit_aware_tab_distribution->evaluateSecondaryConditionalCDF( 1.5*MeV, 8.75*cgs::centimeter ), 0.9375 );
  FRENSIE_CHECK_EQUAL( unit_aware_tab_distribution->evaluateSecondaryConditionalCDF( 1.5*MeV, 9.0*cgs::centimeter ), 0.95 );
                   ...
                   sampleSecondaryConditionalAndRecordTrials )
{
  ...
  FRENSIE_CHECK_THROW( distribution->sampleSecondaryConditionalAndRecordTrials( -1.0, trials ),
              std::logic_error );
  FRENSIE_REQUIRE_EQUAL( trials, 0u );
  ...
  fake_stream[2] = 0.0;
  fake_stream[3] = 0.5; // sample bin boundary
  fake_stream[4] = 0.0;
  fake_stream[5] = 1.0-1e-15; // sample bin boundary
  Utility::RandomNumberGenerator::setFakeStream( fake_stream );
...
{ 
  ...
  sample = tab_distribution->sampleSecondaryConditionalWithRandomNumberInSubrange( 0.5, 0.4230769230769231, 7.5 );
...
{ 
  ...
  sample = unit_aware_tab_distribution->sampleSecondaryConditionalWithRandomNumberInSubrange( 0.5*MeV, 0.4230769230769231, 7.5*cgs::centimeter );
                                   ...
                                   TestArchives )
{
  ...
  std::string archive_base_name( "test_LinLinLin_direct_interpolated_fully_tabular_basic_bivariate_dist" );
  ...
  // Create and archive some distributions
  {
    ...
    auto concrete_dist = std::dynamic_pointer_cast<Utility::InterpolatedFullyTabularBasicBivariateDistribution<Utility::Direct<Utility::LinLinLin> > >( distribution );
  ...
  std::shared_ptr<Utility::InterpolatedFullyTabularBasicBivariateDistribution<Utility::Direct<Utility::LinLinLin> > > concrete_dist;
  ...
  FRENSIE_CHECK_EQUAL( concrete_dist->evaluate( 0.5, 1.0 ), 0.5 );
  FRENSIE_CHECK_EQUAL( concrete_dist->evaluate( 0.5, 1.25 ), 0.5 );
  FRENSIE_CHECK_FLOATING_EQUALITY( concrete_dist->evaluate( 0.5, 5.0 ),
                          1.0,
                          1e-15 );
  FRENSIE_CHECK_EQUAL( concrete_dist->evaluate( 0.5, 8.75 ), 0.5 );
  FRENSIE_CHECK_EQUAL( concrete_dist->evaluate( 0.5, 9.0 ), 0.5 );
  ...
  FRENSIE_CHECK_EQUAL( concrete_dist->evaluate( 1.5, 1.25 ), 0.05 );
  FRENSIE_CHECK_FLOATING_EQUALITY( concrete_dist->evaluate( 1.5, 5.0 ),
                          0.55,
                          1e-15 );
  FRENSIE_CHECK_EQUAL( concrete_dist->evaluate( 1.5, 8.75 ), 0.05 );
  ...
  FRENSIE_CHECK_EQUAL( intermediate_base_dist->evaluate( 0.5, 1.0 ), 0.5 );
  FRENSIE_CHECK_EQUAL( intermediate_base_dist->evaluate( 0.5, 1.25 ), 0.5 );
  FRENSIE_CHECK_FLOATING_EQUALITY( intermediate_base_dist->evaluate( 0.5, 5.0 ),
                          1.0,
                          1e-15 );
  FRENSIE_CHECK_EQUAL( intermediate_base_dist->evaluate( 0.5, 8.75 ), 0.5 );
  FRENSIE_CHECK_EQUAL( intermediate_base_dist->evaluate( 0.5, 9.0 ), 0.5 );
  ...
  FRENSIE_CHECK_EQUAL( intermediate_base_dist->evaluate( 1.5, 1.0 ), 0.05 );
  FRENSIE_CHECK_EQUAL( intermediate_base_dist->evaluate( 1.5, 1.25 ), 0.05 );
  FRENSIE_CHECK_FLOATING_EQUALITY( intermediate_base_dist->evaluate( 1.5, 5.0 ),
                          0.55,
                          1e-15 );
  FRENSIE_CHECK_EQUAL( intermediate_base_dist->evaluate( 1.5, 8.75 ), 0.05 );
  FRENSIE_CHECK_EQUAL( intermediate_base_dist->evaluate( 1.5, 9.0 ), 0.05 );
  ...
  FRENSIE_CHECK_EQUAL( base_dist->evaluate( 0.5, 1.0 ), 0.5 );
  FRENSIE_CHECK_EQUAL( base_dist->evaluate( 0.5, 1.25 ), 0.5 );
  FRENSIE_CHECK_FLOATING_EQUALITY( base_dist->evaluate( 0.5, 5.0 ),
                          1.0,
                          1e-15 );
  FRENSIE_CHECK_EQUAL( base_dist->evaluate( 0.5, 8.75 ), 0.5 );
  FRENSIE_CHECK_EQUAL( base_dist->evaluate( 0.5, 9.0 ), 0.5 );
  ...
  FRENSIE_CHECK_EQUAL( base_dist->evaluate( 1.5, 1.25 ), 0.05 );
  FRENSIE_CHECK_FLOATING_EQUALITY( base_dist->evaluate( 1.5, 5.0 ),
                          0.55,
                          1e-15 );
  FRENSIE_CHECK_EQUAL( base_dist->evaluate( 1.5, 8.75 ), 0.05 );
                                   ...
                                   TestArchives )
{
  ...
  std::string archive_base_name( "test_LinLinLin_direct_unit_aware_interpolated_fully_tabular_basic_bivariate_dist" );
  std::ostringstream archive_ostream;
  ...
  // Create and archive some distributions
  {
    ...
    auto concrete_dist = std::dynamic_pointer_cast<Utility::UnitAwareInterpolatedFullyTabularBasicBivariateDistribution<Utility::Direct<Utility::LinLinLin>,MegaElectronVolt,cgs::length,Barn> >( unit_aware_distribution );
  ...
  std::shared_ptr<Utility::UnitAwareInterpolatedFullyTabularBasicBivariateDistribution<Utility::Direct<Utility::LinLinLin>,MegaElectronVolt,cgs::length,Barn> > concrete_dist;
  ...
  FRENSIE_CHECK_EQUAL( concrete_dist->evaluate( 0.5*MeV, 1.0*cgs::centimeter ), 0.5*barn );
  FRENSIE_CHECK_EQUAL( concrete_dist->evaluate( 0.5*MeV, 1.25*cgs::centimeter ), 0.5*barn );
  FRENSIE_CHECK_FLOATING_EQUALITY( concrete_dist->evaluate( 0.5*MeV, 5.0*cgs::centimeter ),
                                  1.0*barn,
                                  1e-15 );
  FRENSIE_CHECK_EQUAL( concrete_dist->evaluate( 0.5*MeV, 8.75*cgs::centimeter ), 0.5*barn );
  FRENSIE_CHECK_EQUAL( concrete_dist->evaluate( 0.5*MeV, 9.0*cgs::centimeter ), 0.5*barn );
  ...
  FRENSIE_CHECK_EQUAL( concrete_dist->evaluate( 1.5*MeV, 1.25*cgs::centimeter ), 0.05*barn );
  FRENSIE_CHECK_FLOATING_EQUALITY( concrete_dist->evaluate( 1.5*MeV, 5.0*cgs::centimeter ),
                                  0.55*barn,
                                  1e-15 );
  FRENSIE_CHECK_EQUAL( concrete_dist->evaluate( 1.5*MeV, 8.75*cgs::centimeter ), 0.05*barn );
  ...
  std::shared_ptr<Utility::UnitAwareFullyTabularBasicBivariateDistribution<MegaElectronVolt,cgs::length,Barn> > intermediate_base_dist;
  ...
  FRENSIE_CHECK_EQUAL( intermediate_base_dist->evaluate( 0.5*MeV, 1.0*cgs::centimeter ), 0.5*barn );
  FRENSIE_CHECK_EQUAL( intermediate_base_dist->evaluate( 0.5*MeV, 1.25*cgs::centimeter ), 0.5*barn );
  FRENSIE_CHECK_FLOATING_EQUALITY( intermediate_base_dist->evaluate( 0.5*MeV, 5.0*cgs::centimeter ),
                                  1.0*barn,
                                  1e-15 );
  FRENSIE_CHECK_EQUAL( intermediate_base_dist->evaluate( 0.5*MeV, 8.75*cgs::centimeter ), 0.5*barn );
  FRENSIE_CHECK_EQUAL( intermediate_base_dist->evaluate( 0.5*MeV, 9.0*cgs::centimeter ), 0.5*barn );
  ...
  FRENSIE_CHECK_EQUAL( intermediate_base_dist->evaluate( 1.5*MeV, 1.0*cgs::centimeter ), 0.05*barn );
  FRENSIE_CHECK_EQUAL( intermediate_base_dist->evaluate( 1.5*MeV, 1.25*cgs::centimeter ), 0.05*barn );
  FRENSIE_CHECK_FLOATING_EQUALITY( intermediate_base_dist->evaluate( 1.5*MeV, 5.0*cgs::centimeter ),
                                  0.55*barn,
                                  1e-15 );
  FRENSIE_CHECK_EQUAL( intermediate_base_dist->evaluate( 1.5*MeV, 8.75*cgs::centimeter ), 0.05*barn );
  FRENSIE_CHECK_EQUAL( intermediate_base_dist->evaluate( 1.5*MeV, 9.0*cgs::centimeter ), 0.05*barn );
  ...
  FRENSIE_CHECK_EQUAL( base_dist->evaluate( 0.5*MeV, 1.0*cgs::centimeter ), 0.5*barn );
  FRENSIE_CHECK_EQUAL( base_dist->evaluate( 0.5*MeV, 1.25*cgs::centimeter ), 0.5*barn );
  FRENSIE_CHECK_FLOATING_EQUALITY( base_dist->evaluate( 0.5*MeV, 5.0*cgs::centimeter ),
                                  1.0*barn,
                                  1e-15 );
  FRENSIE_CHECK_EQUAL( base_dist->evaluate( 0.5*MeV, 8.75*cgs::centimeter ), 0.5*barn );
  FRENSIE_CHECK_EQUAL( base_dist->evaluate( 0.5*MeV, 9.0*cgs::centimeter ), 0.5*barn );
  ...
  FRENSIE_CHECK_EQUAL( base_dist->evaluate( 1.5*MeV, 1.25*cgs::centimeter ), 0.05*barn );
  FRENSIE_CHECK_FLOATING_EQUALITY( base_dist->evaluate( 1.5*MeV, 5.0*cgs::centimeter ),
                                  0.55*barn,
                                  1e-15 );
  FRENSIE_CHECK_EQUAL( base_dist->evaluate( 1.5*MeV, 8.75*cgs::centimeter ), 0.05*barn );
...
FRENSIE_CUSTOM_UNIT_TEST_INIT()
{
  // Create the two-dimensional distribution
  {
    ...
    tab_distribution.reset( new Utility::InterpolatedFullyTabularBasicBivariateDistribution<Utility::Direct<Utility::LinLinLin>>(
                                                            primary_grid,
                                                            secondary_dists,
                                                            1e-3,
                                                            1e-7 ) );
  ...
  // Create the unit-aware two-dimensional distribution
  {
    ...
    unit_aware_tab_distribution.reset( new Utility::UnitAwareInterpolatedFullyTabularBasicBivariateDistribution<Utility::Direct<Utility::LinLinLin>,MegaElectronVolt,cgs::length,Barn>( primary_bins, secondary_dists, 1e-3, 1e-7 ) );
...
//---------------------------------------------------------------------------//
// end tstLinLinLinDirectInterpolatedFullyTabularBasicBivariateDistribution.cpp
//---------------------------------------------------------------------------//
