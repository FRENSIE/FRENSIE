...
FRENSIE_UNIT_TEST( InterpolatedFullyTabularBasicBivariateDistribution, evaluate )
{
  ...
  FRENSIE_CHECK_FLOATING_EQUALITY( distribution->evaluate( 1.5, 1.25 ),
                          0.1,
                          1e-15 );
  FRENSIE_CHECK_FLOATING_EQUALITY( distribution->evaluate( 1.5, 5.0 ),
                          0.4,
                          1e-15 );
  FRENSIE_CHECK_FLOATING_EQUALITY( distribution->evaluate( 1.5, 8.75 ),
                          0.23333333333333334,
                          1e-15 );
                   ...
                   evaluate )
{
  ...
  FRENSIE_CHECK_FLOATING_EQUALITY( unit_aware_distribution->evaluate( 1.5*MeV, 1.25*cgs::centimeter ),
                                  0.1*barn,
                                  1e-15 );
  FRENSIE_CHECK_FLOATING_EQUALITY( unit_aware_distribution->evaluate( 1.5*MeV, 5.0*cgs::centimeter ),
                                  0.4*barn,
                                  1e-15 );
  FRENSIE_CHECK_FLOATING_EQUALITY( unit_aware_distribution->evaluate( 1.5*MeV, 8.75*cgs::centimeter ),
                   ...
                   sampleSecondaryConditionalInSubrange )
{
  ...
  FRENSIE_CHECK_FLOATING_EQUALITY( sample, 4.375, 1e-15 );
                   ...
                   sampleSecondaryConditionalInSubrange )
{
  ...
  FRENSIE_CHECK_FLOATING_EQUALITY( sample, 4.375*cgs::centimeter, 1e-15 );
