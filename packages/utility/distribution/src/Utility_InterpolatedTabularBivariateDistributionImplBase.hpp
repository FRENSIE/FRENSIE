...
// FRENSIE Includes
#include "Utility_PartiallyTabularBivariateDistribution.hpp"
#include "Utility_FullyTabularBivariateDistribution.hpp"
#include "Utility_TwoDInterpolationPolicy.hpp"

namespace Utility{

/*! The interpolated tabular two-dimensional dist. base implementation class
 * \details Distribution must be either the PartiallyTabularBivariateDistribution
 * or the FullyTabularBivariateDistribution. This intermediate base class implements
 * methods that are required by both the branches of the inheritance tree
 * and differ only in the UnivariateDistribution base class that they operate on
 * (either the UnivariateDistribution or the TabularUnivariateDistribution respectively).
 */
template<typename TwoDInterpPolicy, typename Distribution>
class UnitAwareInterpolatedTabularBivariateDistributionImplBase : public Distribution{
...
public:
  ...
  //! Constructor
  UnitAwareInterpolatedTabularBivariateDistributionImplBase(
  ...
  //! Destructor
  virtual ~UnitAwareInterpolatedTabularBivariateDistributionImplBase()
  { /* ... */ }
...
#include "Utility_InterpolatedTabularBivariateDistributionImplBase_def.hpp"
...
//---------------------------------------------------------------------------//
// end Utility_InterpolatedTabularBivariateDistributionImplBase.hpp
//---------------------------------------------------------------------------//
