//---------------------------------------------------------------------------//
//!
//! \file   Utility_HistogramTabularBivariateDistributionImplBase.hpp
...
class UnitAwareHistogramTabularBivariateDistributionImplBase : public Distribution
{
...
public:
  ...
  //! Constructor
  UnitAwareHistogramTabularBivariateDistributionImplBase(
  ...
  //! Destructor
  virtual ~UnitAwareHistogramTabularBivariateDistributionImplBase()
  { /* ... */ }
...
#include "Utility_HistogramTabularBivariateDistributionImplBase_def.hpp"
...
//---------------------------------------------------------------------------//
// end Utility_HistogramTabularBivariateDistributionImplBase.hpp
//---------------------------------------------------------------------------//
