//---------------------------------------------------------------------------//
//!
//! \file   Utility_BivariateDistributionHelpers.hpp
 ...
 * std::shared_ptr<Utility::BivariateDistribution>,  
 * std::unique_ptr<Utility::BivariateDistribution>, etc.) we need to register
...
#define BOOST_DISTRIBUTION2_CLASS_VERSION( FullName, Version ) \
  __BOOST_DISTRIBUTION_CLASS_VERSION_IMPL__( Version,                   \
    template<typename PrimaryIndependentUnit, typename SecondaryIndependentUnit, typename DependentUnit> \
    struct version<Utility::FullName<PrimaryIndependentUnit,SecondaryIndependentUnit,DependentUnit> > )
...
//---------------------------------------------------------------------------//
// end Utility_BivariateDistributionHelpers.hpp
//---------------------------------------------------------------------------//
