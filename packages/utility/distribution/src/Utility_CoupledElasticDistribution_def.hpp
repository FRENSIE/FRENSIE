...
EXTERN_EXPLICIT_TEMPLATE_CLASS_INST( UnitAwareCoupledElasticDistribution<LinLogCos<true>,void,void> );
EXTERN_EXPLICIT_TEMPLATE_CLASS_INST( UnitAwareCoupledElasticDistribution<LogLogCos<true>,void,void> );
