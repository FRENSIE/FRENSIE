...
UnitAwareAnalogElasticDistribution<InterpolationPolicy,IndependentUnit,DependentUnit>::UnitAwareAnalogElasticDistribution(
  ...
  : BaseType( independent_values, dependent_values )
{
...
//  : UnitAwareTabularDistribution<InterpolationPolicy,IndependentUnit,DependentUnit>( dist_instance )
//{ /* ... */ }
...
//  : UnitAwareTabularDistribution<InterpolationPolicy,IndependentUnit,DependentUnit>( unitless_dist_instance, int )
//{ /* ... */ }
...
#endif // end Utility_AnalogElasticDistribution_def.hpp
