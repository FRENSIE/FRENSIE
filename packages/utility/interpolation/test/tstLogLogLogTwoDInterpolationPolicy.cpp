...

{
  ...
  double z = Utility::LogLogLog::interpolateWeighted<ymember,zmember>(x0,
							      x1,
							      x,
							      y,
							      y_0_grid.begin(),
  ...
  z = Utility::LogLogLog::interpolateWeighted<ymember,zmember>( x0,
							x1,
							x,
							y,
							y_0_grid.begin(),
...
UNIT_TEST_INSTANTIATION_2_TUPLE( LogLogLog, interpolateWeighted_separate_tuple_grids );
...
// Check that the log-log-log interpolation policy between four points
// can be done
TEUCHOS_UNIT_TEST( LogLogLog, interpolateWeighted_no_tuple_grids )
{
  double x0 = 0.1, x1 = 1.0, x = 0.3, y = 3e-2;
  Teuchos::Array<double> y_0_grid( 4 );
  y_0_grid[0] = 1e-3;
  ...
  double z = Utility::LogLogLog::interpolateWeighted( x0,
					      x1,
					      x,
					      y,
					      y_0_grid.begin(),
  ...
  z = Utility::LogLogLog::interpolateWeighted( x0,
				       x1,
				       x,
				       y,
				       y_0_grid.begin(),
