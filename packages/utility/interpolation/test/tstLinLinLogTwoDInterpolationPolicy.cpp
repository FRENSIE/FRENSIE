                          ...
                          ztuple )
{
  ...
  double z = Utility::LinLinLog::interpolateWeighted<ymember,zmember>(x0,
                                  x1,
                                  x,
                                  y,
                                  y_0_grid.begin(),
  ...
  z = Utility::LinLinLog::interpolateWeighted<ymember,zmember>( x0,
                            x1,
                            x,
                            y,
                            y_0_grid.begin(),
...
// Check that the linear-linear-log interpolation policy between four points
// can be done
TEUCHOS_UNIT_TEST( LinLinLog, interpolateWeighted_no_tuple_grids )
{
  double x0 = 0.1, x1 = 1.0, x = 0.3, y = 0.0;
  ...
  double z = Utility::LinLinLog::interpolateWeighted( x0,
                                                      x1,
                                                      x,
                                                      y,
                                                      y_0_grid.begin(),
  ...
  z = Utility::LinLinLog::interpolateWeighted( x0,
                                               x1,
                                               x,
                                               y,
                                               y_0_grid.begin(),
