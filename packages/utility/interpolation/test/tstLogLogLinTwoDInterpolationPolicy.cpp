...
UTILITY_UNIT_TEST_MEMBER_1_TUPLE_1_TEMPLATE_DECL( LogLogLin,
						  calculateGridLength,
						  member,
						  tuple )
{
  ...
  double grid_length = Utility::LogLogLin::calculateGridLength<member>(
							    tuple_grid.begin(),
							    tuple_grid.end() );
...
UNIT_TEST_INSTANTIATION_1_TUPLE( LogLogLin, calculateGridLength );

//---------------------------------------------------------------------------//
// Check that the grid length can be calculated
TEUCHOS_UNIT_TEST( LogLogLin, calculateGridLength_no_tuple )
{
  ...
  double grid_length =
    Utility::LogLogLin::calculateGridLength<Utility::FIRST>( grid.begin(),
							     grid.end() );
...
TEUCHOS_UNIT_TEST( LogLogLin, calculateUnitBaseIndepVar )
{
  double y_min = 1e-3, y = 1e-2, L = 3.0;

  double eta = Utility::LogLogLin::calculateUnitBaseIndepVar( y, y_min, L );

  TEST_FLOATING_EQUALITY( eta, 0.76752836433133, 1e-12 );

  y = 1e-3;

  eta = Utility::LogLogLin::calculateUnitBaseIndepVar( y, y_min, L );
...
TEUCHOS_UNIT_TEST( LogLogLin, calculateGridIndepVar )
{
  double y_min = 1e-3, L = 3.0, eta = 0.5;

  double y =  Utility::LogLogLin::calculateGridIndepVar( eta, y_min, L );

  TEST_FLOATING_EQUALITY( y, 0.0044816890703382, 1e-12 );

  eta = 0.0;

  y = Utility::LogLogLin::calculateGridIndepVar( eta, y_min, L );
						  ...
						  tuple )
{
  ...
  double grid_length =
    Utility::LogLogLin::calculateGridLengthProcessed<member>(
							    tuple_grid.begin(),
							    tuple_grid.end() );
...
UNIT_TEST_INSTANTIATION_1_TUPLE( LogLogLin, calculateGridLengthProcessed );

//---------------------------------------------------------------------------//
// Check that the grid length can be calculated
TEUCHOS_UNIT_TEST( LogLogLin, calculateGridLengthProcessed_no_tuple )
{
  Teuchos::Array<double> grid( 4 );
  grid[0] = Utility::LogLogLin::processSecondIndepVar(1e-3);
  grid[1] = Utility::LogLogLin::processSecondIndepVar(1e-2);
  grid[2] = Utility::LogLogLin::processSecondIndepVar(1e-1);
  grid[3] = Utility::LogLogLin::processSecondIndepVar(1.0);

  double grid_length =
    Utility::LogLogLin::calculateGridLengthProcessed<Utility::FIRST>(
								  grid.begin(),
								  grid.end() );
...
//---------------------------------------------------------------------------//
// Check that the unit base independent can be calculated
TEUCHOS_UNIT_TEST( LogLogLin, calculateUnitBaseIndepVarProcessed )
{
  double y_min = Utility::LogLogLin::processSecondIndepVar(1e-3);
  double y = Utility::LogLogLin::processSecondIndepVar(1e-2);
  double L = 3.0;

  double eta = Utility::LogLogLin::calculateUnitBaseIndepVarProcessed(
								 y, y_min, L );
  ...
  eta = Utility::LogLogLin::calculateUnitBaseIndepVarProcessed( y, y_min, L );

  TEST_FLOATING_EQUALITY( eta, 0.0, 1e-12 );

  y = Utility::LogLogLin::processSecondIndepVar(0.020085536923187);
...
// Check that the grid independent y variable can be calculated given a
// unit base independent variable
TEUCHOS_UNIT_TEST( LogLogLin, calculateProcessedGridIndepVar )
{
  double y_min = Utility::LogLogLin::processSecondIndepVar(1e-3);
  double L = 3.0, eta = 0.5;

  double y =  Utility::LogLogLin::calculateProcessedGridIndepVar(
							       eta, y_min, L );

  TEST_FLOATING_EQUALITY(
		 y,
		 Utility::LogLogLin::processSecondIndepVar(0.0044816890703382),
		 1e-12 );

  eta = 0.0;

  y = Utility::LogLogLin::calculateProcessedGridIndepVar( eta, y_min, L );
  ...
  TEST_FLOATING_EQUALITY(
		  y,
		  Utility::LogLogLin::processSecondIndepVar(0.020085536923187),
		  1e-12 );
}
