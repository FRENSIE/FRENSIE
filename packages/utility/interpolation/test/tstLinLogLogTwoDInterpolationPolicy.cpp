					      ...
					      ztuple )
{
  ...
  double z = Utility::LinLogLog::interpolateWeighted<ymember,zmember>(x0,
                                  x1,
                                  x,
                                  y,
                                  y_0_grid.begin(),
  ...
  z = Utility::LinLogLog::interpolateWeighted<ymember,zmember>( x0,
                            x1,
                            x,
                            y,
                            y_0_grid.begin(),
...
UNIT_TEST_INSTANTIATION_2_TUPLE( LinLogLog, interpolateWeighted_separate_tuple_grids );
...
// can be done
TEUCHOS_UNIT_TEST( LinLogLog,
           interpolateWeighted_no_tuple_grids )
{
  double x0 = 0.1, x1 = 1.0, x = 0.3, y = 3e-2;
  ...
  double z = Utility::LinLogLog::interpolateWeighted( x0,
                          x1,
                          x,
                          y,
                          y_0_grid.begin(),
  ...
  z = Utility::LinLogLog::interpolateWeighted( x0,
                       x1,
                       x,
                       y,
                       y_0_grid.begin(),
