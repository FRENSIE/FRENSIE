                          ...
                          ztuple )
{
  ...
  double z = Utility::LinLogLin::interpolateWeighted<ymember,zmember>(x0,
                                                              x1,
                                                              x,
                                                              y,
                                                              y_0_grid.begin(),
  ...
  z = Utility::LinLogLin::interpolateWeighted<ymember,zmember>( x0,
                                                            x1,
                                                            x,
                                                            y,
                                                            y_0_grid.begin(),
...
// Check that the linear-log-linear interpolation policy between four points
// can be done
TEUCHOS_UNIT_TEST( LinLogLin, interpolateWeighted_no_tuple_grids )
{
  double x0 = 0.0, x1 = 1.0, x = 0.5, y = 3e-2;
  Teuchos::Array<double> y_0_grid( 4 );
  y_0_grid[0] = 1e-3;
  ...
  double z = Utility::LinLogLin::interpolateWeighted( x0,
                                                      x1,
                                                      x,
                                                      y,
                                                      y_0_grid.begin(),
  ...
  z = Utility::LinLogLin::interpolateWeighted( x0,
                                               x1,
                                               x,
                                               y,
                                               y_0_grid.begin(),
