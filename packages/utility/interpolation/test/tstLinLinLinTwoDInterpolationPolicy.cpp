...

{
  ...
  double z = Utility::LinLinLin::interpolateWeighted<ymember,zmember>(x0,
                                  x1,
                                  x,
                                  y,
                                  y_0_grid.begin(),
  ...
  z = Utility::LinLinLin::interpolateWeighted<ymember,zmember>( x0,
                            x1,
                            x,
                            y,
                            y_0_grid.begin(),
...
UNIT_TEST_INSTANTIATION_2_TUPLE( LinLinLin, interpolateWeighted_separate_tuple_grids );
...
// Check that the linear-linear-linear interpolation policy between four points
// can be done
TEUCHOS_UNIT_TEST( LinLinLin, interpolateWeighted_no_tuple_grids )
{
  double x0 = 0.0, x1 = 1.0, x = 0.5, y = 0.0;
  Teuchos::Array<double> y_0_grid( 4 );
  y_0_grid[0] = -10.0;
  ...
  double z = Utility::LinLinLin::interpolateWeighted( x0,
                          x1,
                          x,
                          y,
                          y_0_grid.begin(),
  ...
  z = Utility::LinLinLin::interpolateWeighted( x0,
                       x1,
                       x,
                       y,
                       y_0_grid.begin(),
