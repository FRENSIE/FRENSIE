...
{
  // Save the base class
  ar & BOOST_SERIALIZATION_BASE_OBJECT_NVP( TranslationSphericalCoordinateConversionPolicy );
...
BOOST_CLASS_VERSION( Utility::TranslationSphericalSpatialCoordinateConversionPolicy, 0 );
