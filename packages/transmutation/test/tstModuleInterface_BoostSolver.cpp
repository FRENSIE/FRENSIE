...
TEUCHOS_UNIT_TEST( ModuleInterface, burn )
{
   ...
   // Set reaction rates
   Transmutation::ModuleInterface<Utility::BoostSolver>::setReactionRates( Facemc::N__GAMMA_REACTION, reaction_rates, 1);

   reaction_rates[0] = std::pair<int,double>(1002,5e-10);

   Transmutation::ModuleInterface<Utility::BoostSolver>::setReactionRates( Facemc::N__GAMMA_REACTION, reaction_rates, 5);
