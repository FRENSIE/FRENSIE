//---------------------------------------------------------------------------//
//!
//! \file   Data_PhotonDataProcessor.hpp
//! \author Alex Robinson
//! \brief  Photon Data Processor declaration
//!
//---------------------------------------------------------------------------//

#ifndef DATA_PHOTON_DATA_PROCESSOR_HPP
#define DATA_PHOTON_DATA_PROCESSOR_HPP
 ...
 *
 * This class is derived from the Utility::DataProcessor abstract base class. It 
 ...
 * \ingroup data_proc
 */
class PhotonDataProcessor : public Utility::DataProcessor
{
...
public:
  ...
  PhotonDataProcessor( const std::string epdl_file_name,
		       ...
		       const std::string output_directory = FRENSIE_DATA_DIRECTORY,
...
protected:
  ...
  void processShellOccupancyData( 
  ...
  */
  ...
  Utility::HDF5FileHandler d_hdf5_file_handler;
...
#endif // end DATA_PHOTON_DATA_PROCESSOR_HPP

//---------------------------------------------------------------------------//
// end Data_PhotonDataProcessor.hpp
//---------------------------------------------------------------------------//
