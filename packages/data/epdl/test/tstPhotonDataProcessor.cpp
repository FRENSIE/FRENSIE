...
public:
  ...
  using Data::PhotonDataProcessor::processEPDLFile;
  using Data::PhotonDataProcessor::processCoherentCrossSectionData;
  using Data::PhotonDataProcessor::processIncoherentCrossSectionData;
  using Data::PhotonDataProcessor::processTotalPhotoelectricCrossSectionData;
  using Data::PhotonDataProcessor::processShellPhotoelectricCrossSectionData;
  using Data::PhotonDataProcessor::processPairProductionCrossSectionData;
  using Data::PhotonDataProcessor::processTripletProductionCrossSectionData;
  using Data::PhotonDataProcessor::processFormFactorData;
  using Data::PhotonDataProcessor::processScatteringFunctionData;
  using Data::PhotonDataProcessor::processEADLFile;
  using Data::PhotonDataProcessor::processShellOccupancyData;
  using Data::PhotonDataProcessor::processBindingEnergyData;
  using Data::PhotonDataProcessor::processKineticEnergyData;
  using Data::PhotonDataProcessor::processShellRadiativeTransitionData;
  using Data::PhotonDataProcessor::processShellNonradiativeTransitionData;
  using Data::PhotonDataProcessor::processComptonFiles;
  using Data::PhotonDataProcessor::initializeHDF5Files;
  using Data::PhotonDataProcessor::d_hdf5_file_handler;
};
...
TEUCHOS_UNIT_TEST( PhotonDataProcessor, processCoherentCrossSectionData )
{
  ...
  Teuchos::Array<Utility::Trip<double,double,double> > ref_data;
  ...
  UTILITY_TEST_COMPARE_FLOATING_ARRAYS( data, ref_data, TOL );
}
...
TEUCHOS_UNIT_TEST( PhotonDataProcessor, processFormFactorData )
{
  ...
  // Fill the reference data array
  Teuchos::Array<Utility::Quad<double,double,double,double> > ref_data;
  ref_data.resize( data.size() );
...
TEUCHOS_UNIT_TEST( PhotonDataProcessor, processShellOccupancyData_processBindingEnergyData )
{
  ...
  Teuchos::Array<Utility::Pair<unsigned int, double> > binding_energy_data;
  ...
  Teuchos::Array<Utility::Pair<unsigned int, double> > ref_binding_energy_data;
  ...
  UTILITY_TEST_COMPARE_FLOATING_ARRAYS( binding_energy_data, 
  ...
  UTILITY_TEST_COMPARE_FLOATING_ARRAYS( occupancy_data, 
				     ref_occupancy_data, 
				     TOL );
}
...
TEUCHOS_UNIT_TEST( PhotonDataProcessor, processKineticEnergyData )
{
  ...
  // Fill the reference data array
  Teuchos::Array<Utility::Pair<unsigned int, double> > ref_data;
  ref_data.resize( data.size() );
...
TEUCHOS_UNIT_TEST( PhotonDataProcessor, processShellRadiativeTransitionData )
{
  ...
  Teuchos::Array<Utility::Trip<double, unsigned int, double> > data;
  ...
  // Fill the reference data array
  Teuchos::Array<Utility::Trip<double, unsigned int, double> > ref_data;
  ref_data.resize( data.size() );
