...
public:
  ...
  using AdjointElectronPhotonRelaxationDataContainer::setElectronLinLinLogInterpolationModeOnOff;
  ...
  // Electron functions
  using AdjointElectronPhotonRelaxationDataContainer::setElasticTwoDInterpPolicy;
  ...
  using AdjointElectronPhotonRelaxationDataContainer::setElectroionizationTwoDInterpPolicy;
  ...
  using AdjointElectronPhotonRelaxationDataContainer::setBremsstrahlungTwoDInterpPolicy;
