						  ...
						  const unsigned version) const
{
  ...
  ar & boost::serialization::make_nvp( "cutoff angle cosine", 
                                        d_cutoff_angle_cosine );
  ar & boost::serialization::make_nvp( "angular energy grid",
				                        d_angular_energy_grid );
  ar & boost::serialization::make_nvp( "number of discrete angles", 
                                        d_number_of_discrete_angles );
  ar & boost::serialization::make_nvp( "soft elastic discrete angles", 
                                        d_soft_elastic_discrete_angles );
  ar & boost::serialization::make_nvp( "soft elastic weights", 
                                        d_soft_elastic_weights );
  ar & boost::serialization::make_nvp( "electron energy grid",
				                        d_electron_energy_grid );
  ar & boost::serialization::make_nvp( 
            "moment preserving soft elastic cross section", 
            d_moment_preserving_soft_elastic_cross_section );
  ar & boost::serialization::make_nvp( 
            "moment preserving soft elastic cross section threshold index", 
