...
public:
  ...
  using ElectronPhotonRelaxationDataContainer::setElectroionizationEnergyLossAtIncomingEnergy;
  using ElectronPhotonRelaxationDataContainer::setElectroionizationEnergyLossPDFAtIncomingEnergy;
  using ElectronPhotonRelaxationDataContainer::setElectroionizationEnergyLoss;
  using ElectronPhotonRelaxationDataContainer::setElectroionizationEnergyLossPDF;
