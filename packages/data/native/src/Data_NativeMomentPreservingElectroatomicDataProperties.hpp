//---------------------------------------------------------------------------//
//!
//! \file   Data_NativeMomentPreservingElectroatomicDataProperties.hpp
...
#ifndef DATA_NATIVE_MOMENT_PRESERVING_ELECTROATOMIC_DATA_PROPERTIES_HPP
#define DATA_NATIVE_MOMENT_PRESERVING_ELECTROATOMIC_DATA_PROPERTIES_HPP
...
//! The Native moment preserving electroatomic data properties class
class NativeMomentPreservingElectroatomicDataProperties : public ElectroatomicDataProperties
{

public:

  //! Constructor
  NativeMomentPreservingElectroatomicDataProperties(
  ...
  NativeMomentPreservingElectroatomicDataProperties* clone() const override;
...
private:
  ...
  // Copy constructor
  NativeMomentPreservingElectroatomicDataProperties( const NativeMomentPreservingElectroatomicDataProperties& other );

  // Assignment operator
  NativeMomentPreservingElectroatomicDataProperties& operator=( const NativeMomentPreservingElectroatomicDataProperties& other );
...
BOOST_SERIALIZATION_CLASS_VERSION( NativeMomentPreservingElectroatomicDataProperties, Data, 0 );
BOOST_SERIALIZATION_CLASS_EXPORT_STANDARD_KEY( NativeMomentPreservingElectroatomicDataProperties, Data );
EXTERN_EXPLICIT_CLASS_SAVE_LOAD_INST( Data, NativeMomentPreservingElectroatomicDataProperties );

#endif // end DATA_NATIVE_MOMENT_PRESERVING_ELECTROATOMIC_DATA_PROPERTIES_HPP

//---------------------------------------------------------------------------//
// end Data_NativeMomentPreservingElectroatomicDataProperties.hpp
//---------------------------------------------------------------------------//
