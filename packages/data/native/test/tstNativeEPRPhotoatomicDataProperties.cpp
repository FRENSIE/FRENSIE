                                   ...
                                   TestArchives )
{
  ...
  // Create and archive some properties
  {
    ...
    Data::NativeEPRPhotoatomicDataProperties local_properties( "photoatomic_data/he_data.xml",
                                                          1,
                                                          Data::He_ATOM );
...
{
  properties.reset( new Data::NativeEPRPhotoatomicDataProperties( "photoatomic_data/h_data.xml",
                                                             0,
                                                             Data::H_ATOM ) );
}
