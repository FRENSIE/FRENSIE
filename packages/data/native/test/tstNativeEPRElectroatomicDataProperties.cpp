//---------------------------------------------------------------------------//
//!
//! \file   tstNativeEPRElectroatomicDataProperties.cpp
//! \author Alex Robinson
//! \brief  NativeEPRElectroatomicDataProperties class unit tests
//!
//---------------------------------------------------------------------------//
...
FRENSIE_UNIT_TEST( NativeEPRElectroatomicDataProperties, atom )
{
...
FRENSIE_UNIT_TEST( NativeEPRElectroatomicDataProperties, fileType )
{
...
FRENSIE_UNIT_TEST( NativeEPRElectroatomicDataProperties, atomicWeight )
{
...
FRENSIE_UNIT_TEST( NativeEPRElectroatomicDataProperties, fileStartLine )
{
...
FRENSIE_UNIT_TEST( NativeEPRElectroatomicDataProperties, fileVersion )
{
...
FRENSIE_UNIT_TEST( NativeEPRElectroatomicDataProperties, tableName )
{
...
FRENSIE_UNIT_TEST( NativeEPRElectroatomicDataProperties, clone )
{
...
FRENSIE_UNIT_TEST_TEMPLATE_EXPAND( NativeEPRElectroatomicDataProperties,
                                   archive,
                                   TestArchives )
{
  ...
  // Create and archive some properties
  {
    ...
    Data::NativeEPRElectroatomicDataProperties local_properties(
                                              4.0*amu,
  ...
  Data::NativeEPRElectroatomicDataProperties
...
//---------------------------------------------------------------------------//
// end tstNativeEPRElectroatomicDataProperties.cpp
//---------------------------------------------------------------------------//
