                                   ...
                                   TestArchives )
{
  ...
  // Create and archive some properties
  {
    ...
    Data::ACENuclearDataProperties local_properties( 2.5301e-8,
  ...
  Data::ACENuclearDataProperties
    local_properties( 0.1, "dummy", 100000, "dummy.00c" );
...
{
  properties.reset( new Data::ACENuclearDataProperties( 2.5301e-8,
                                                        "neutron_data/h_data.txt",
                                                        10,
                                                        "1001.70c" ) );
}
