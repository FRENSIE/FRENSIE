...
TEUCHOS_UNIT_TEST( SAlphaBetaXsdirEntry, getTableAlias )
{
  ...
  Teuchos::RCP<Data::XsdirEntry> entry(
			   new Data::SAlphaBetaXsdirEntry( entry_tokens ) );
  ...
  entry.reset( new Data::SAlphaBetaXsdirEntry( entry_tokens ) );
...
TEUCHOS_UNIT_TEST( SAlphaBetaXsdirEntry, addInfoToParameterList )
{
  ...
  TEST_EQUALITY_CONST( sublist_a.get<std::string>( Data::CrossSectionsXMLProperties::s_alpha_beta_file_path_prop ),
		       "sab2002" );
  TEST_EQUALITY_CONST( sublist_a.get<std::string>( Data::CrossSectionsXMLProperties::s_alpha_beta_file_type_prop ),
		       Data::CrossSectionsXMLProperties::ace_file );
  TEST_EQUALITY_CONST( sublist_a.get<std::string>( Data::CrossSectionsXMLProperties::s_alpha_beta_table_name_prop ),
		       "smeth.60t" );
  TEST_EQUALITY_CONST( sublist_a.get<int>( Data::CrossSectionsXMLProperties::s_alpha_beta_file_start_line_prop ),
		       823113 );
  ...
  TEST_EQUALITY_CONST( sublist_b.get<std::string>( Data::CrossSectionsXMLProperties::s_alpha_beta_file_path_prop ),
		       "tmccs" );
  TEST_EQUALITY_CONST( sublist_b.get<std::string>( Data::CrossSectionsXMLProperties::s_alpha_beta_file_type_prop ),
		       Data::CrossSectionsXMLProperties::ace_file );
  TEST_EQUALITY_CONST( sublist_b.get<std::string>( Data::CrossSectionsXMLProperties::s_alpha_beta_table_name_prop ),
		       "zr/h.06t" );
  TEST_EQUALITY_CONST( sublist_b.get<int>( Data::CrossSectionsXMLProperties::s_alpha_beta_file_start_line_prop ),
		       132047 );
  ...
  TEST_EQUALITY_CONST( sublist_c.get<std::string>( Data::CrossSectionsXMLProperties::s_alpha_beta_file_path_prop ),
		       "endf70sab" );
  TEST_EQUALITY_CONST( sublist_c.get<std::string>( Data::CrossSectionsXMLProperties::s_alpha_beta_file_type_prop ),
		       Data::CrossSectionsXMLProperties::ace_file );
  TEST_EQUALITY_CONST( sublist_c.get<std::string>( Data::CrossSectionsXMLProperties::s_alpha_beta_table_name_prop ),
		       "u/o2.12t" );
  TEST_EQUALITY_CONST( sublist_c.get<int>( Data::CrossSectionsXMLProperties::s_alpha_beta_file_start_line_prop ),
		       4693164 );
