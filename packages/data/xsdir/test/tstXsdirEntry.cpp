...
// Testing Structs
//---------------------------------------------------------------------------//
struct TestXsdirEntry : public Data::XsdirEntry
{
  TestXsdirEntry( const std::vector<std::string>& entry_tokens )
    : Data::XsdirEntry( entry_tokens )
  { /* ... */ }
  ...
  using Data::XsdirEntry::extractTableVersionFromEntryTokens;
  using Data::XsdirEntry::extractFilePathFromEntryTokens;
  using Data::XsdirEntry::extractFileStartLineFromEntryTokens;
  using Data::XsdirEntry::extractTableLengthFromEntryTokens;
  using Data::XsdirEntry::extractTableAtomicWeightRatioFromEntryTokens;
  using Data::XsdirEntry::extractTableTemperatureFromEntryTokens;
  using Data::XsdirEntry::extractZaidFromTableName;
  using Data::XsdirEntry::extractAtomicNumberFromZaid;
  using Data::XsdirEntry::extractAtomicMassNumberFromZaid;
...
TEUCHOS_UNIT_TEST( XsdirEntry, extractTableTokensFromXsdirLine )
{
  ...
  Data::XsdirEntry::extractTableTokensFromXsdirLine( line_g, entry_tokens );
  ...
  Data::XsdirEntry::extractTableTokensFromXsdirLine( line_h, entry_tokens );
  ...
  Data::XsdirEntry::extractTableTokensFromXsdirLine( line_i, entry_tokens );
  ...
  Data::XsdirEntry::extractTableTokensFromXsdirLine( line_j, entry_tokens );
  ...
  Data::XsdirEntry::extractTableTokensFromXsdirLine( line_k, entry_tokens );
  ...
  Data::XsdirEntry::extractTableTokensFromXsdirLine( line_l, entry_tokens );
  ...
  Data::XsdirEntry::extractTableTokensFromXsdirLine( line_m, entry_tokens );
  ...
  Data::XsdirEntry::extractTableTokensFromXsdirLine( line_n, entry_tokens );
  ...
  Data::XsdirEntry::extractTableTokensFromXsdirLine( line_o, entry_tokens );
  ...
  Data::XsdirEntry::extractTableTokensFromXsdirLine( line_p, entry_tokens );
  ...
  Data::XsdirEntry::extractTableTokensFromXsdirLine( line_q, entry_tokens );
...
TEUCHOS_UNIT_TEST( XsdirEntry, isLineTableEntry )
{
  ...
  TEST_ASSERT( !Data::XsdirEntry::isLineTableEntry( entry_tokens ) );
...
TEUCHOS_UNIT_TEST( XsdirEntry, isTableTypeSupported )
{
  ...
  TEST_ASSERT( !Data::XsdirEntry::isTableTypeSupported( entry_tokens ) );
...
TEUCHOS_UNIT_TEST( XsdirEntry, extractTableTypeFromEntryTokens )
{
  ...
  Data::XsdirEntry::TableType type =
    Data::XsdirEntry::extractTableTypeFromEntryTokens( entry_tokens );

  TEST_EQUALITY_CONST( type, Data::XsdirEntry::UNSUPPORTED_TABLE );

  Data::XsdirEntry::extractTableTokensFromXsdirLine( line_h, entry_tokens );

  type = Data::XsdirEntry::extractTableTypeFromEntryTokens( entry_tokens );
  ...
  TEST_EQUALITY_CONST( type, Data::XsdirEntry::S_ALPHA_BETA_TABLE );
  ...
  TEST_EQUALITY_CONST( type, Data::XsdirEntry::PHOTONUCLEAR_TABLE );
}
