...
TEUCHOS_UNIT_TEST( ElectronPhotonRelaxationXsdirEntry, addInfoToParameterList )
{
  ...
  TEST_EQUALITY_CONST( sublist_a.get<std::string>( Data::CrossSectionsXMLProperties::photoatomic_file_path_prop ),
		       "mcplib12" );
  TEST_EQUALITY_CONST( sublist_a.get<std::string>( Data::CrossSectionsXMLProperties::photoatomic_file_type_prop ),
		       Data::CrossSectionsXMLProperties::ace_file );
  TEST_EQUALITY_CONST( sublist_a.get<std::string>( Data::CrossSectionsXMLProperties::photoatomic_table_name_prop ),
		       "1000.12p" );
  TEST_EQUALITY_CONST( sublist_a.get<int>( Data::CrossSectionsXMLProperties::photoatomic_file_start_line_prop ),
		       1 );
  TEST_EQUALITY_CONST( sublist_a.get<std::string>( Data::CrossSectionsXMLProperties::electroatomic_file_path_prop ),
		       "mcplib12" );
  TEST_EQUALITY_CONST( sublist_a.get<std::string>( Data::CrossSectionsXMLProperties::electroatomic_file_type_prop ),
		       Data::CrossSectionsXMLProperties::ace_file );
  TEST_EQUALITY_CONST( sublist_a.get<std::string>( Data::CrossSectionsXMLProperties::electroatomic_table_name_prop ),
		       "1000.12p" );
  TEST_EQUALITY_CONST( sublist_a.get<int>( Data::CrossSectionsXMLProperties::electroatomic_file_start_line_prop ),
		       1 );
  ...
  TEST_EQUALITY_CONST( sublist_b.get<std::string>( Data::CrossSectionsXMLProperties::photoatomic_file_path_prop ),
		       "xmc/eprdata12" );
  TEST_EQUALITY_CONST( sublist_b.get<std::string>( Data::CrossSectionsXMLProperties::photoatomic_file_type_prop ),
		       Data::CrossSectionsXMLProperties::ace_file );
  TEST_EQUALITY_CONST( sublist_b.get<std::string>( Data::CrossSectionsXMLProperties::photoatomic_table_name_prop ),
		       "100000.12p" );
  TEST_EQUALITY_CONST( sublist_b.get<int>( Data::CrossSectionsXMLProperties::photoatomic_file_start_line_prop ),
		       2114874 );
  TEST_EQUALITY_CONST( sublist_b.get<std::string>( Data::CrossSectionsXMLProperties::electroatomic_file_path_prop ),
		       "xmc/eprdata12" );
  TEST_EQUALITY_CONST( sublist_b.get<std::string>( Data::CrossSectionsXMLProperties::electroatomic_file_type_prop ),
		       Data::CrossSectionsXMLProperties::ace_file );
  TEST_EQUALITY_CONST( sublist_b.get<std::string>( Data::CrossSectionsXMLProperties::electroatomic_table_name_prop ),
		       "100000.12p" );
  TEST_EQUALITY_CONST( sublist_b.get<int>( Data::CrossSectionsXMLProperties::electroatomic_file_start_line_prop ),
		       2114874 );
