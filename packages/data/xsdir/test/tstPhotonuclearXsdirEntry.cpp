...
TEUCHOS_UNIT_TEST( PhotonuclearXsdirEntry, addInfoToParameterList )
{
  ...
  TEST_EQUALITY_CONST( sublist_a.get<std::string>( Data::CrossSectionsXMLProperties::photonuclear_file_path_prop ),
		       "la150u" );
  TEST_EQUALITY_CONST( sublist_a.get<std::string>( Data::CrossSectionsXMLProperties::photonuclear_file_type_prop ),
		       Data::CrossSectionsXMLProperties::ace_file );
  TEST_EQUALITY_CONST( sublist_a.get<std::string>( Data::CrossSectionsXMLProperties::photonuclear_table_name_prop ),
		       "1002.24u" );
  TEST_EQUALITY_CONST( sublist_a.get<int>( Data::CrossSectionsXMLProperties::photonuclear_file_start_line_prop ),
		       216233 );
  ...
  TEST_EQUALITY_CONST( sublist_b.get<std::string>( Data::CrossSectionsXMLProperties::photonuclear_file_path_prop ),
		       "xdata/la150u" );
  TEST_EQUALITY_CONST( sublist_b.get<std::string>( Data::CrossSectionsXMLProperties::photonuclear_file_type_prop ),
		       Data::CrossSectionsXMLProperties::ace_file );
  TEST_EQUALITY_CONST( sublist_b.get<std::string>( Data::CrossSectionsXMLProperties::photonuclear_table_name_prop ),
		       "82208.24u" );
  TEST_EQUALITY_CONST( sublist_b.get<int>( Data::CrossSectionsXMLProperties::photonuclear_file_start_line_prop ),
		       196946 );
  ...
  TEST_EQUALITY_CONST( sublist_c.get<std::string>( Data::CrossSectionsXMLProperties::photonuclear_file_path_prop ),
		       "xmc/endf7u" );
  TEST_EQUALITY_CONST( sublist_c.get<std::string>( Data::CrossSectionsXMLProperties::photonuclear_file_type_prop ),
		       Data::CrossSectionsXMLProperties::ace_file );
  TEST_EQUALITY_CONST( sublist_c.get<std::string>( Data::CrossSectionsXMLProperties::photonuclear_table_name_prop ),
		       "93237.70u" );
  TEST_EQUALITY_CONST( sublist_c.get<int>( Data::CrossSectionsXMLProperties::photonuclear_file_start_line_prop ),
		       4868895 );
