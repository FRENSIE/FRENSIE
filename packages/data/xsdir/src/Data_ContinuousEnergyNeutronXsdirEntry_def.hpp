//---------------------------------------------------------------------------//
//!
//! \file   Data_ContinuousEnergyNeutronXsdirEntry_def.hpp
//! \author Alex Robinson
//! \brief  The continuous energy neutron xsdir entry class template defs.
//!
//---------------------------------------------------------------------------//

#ifndef DATA_CONTINUOUS_ENERGY_NEUTRON_XSDIR_ENTRY_DEF_HPP
#define DATA_CONTINUOUS_ENERGY_NEUTRON_XSDIR_ENTRY_DEF_HPP
...
#endif // end DATA_CONTINUOUS_ENERGY_NEUTRON_XSDIR_ENTRY_DEF_HPP

//---------------------------------------------------------------------------//
// end Data_ContinuousEnergyNeutronXsdirEntry_def.hpp
//---------------------------------------------------------------------------//
