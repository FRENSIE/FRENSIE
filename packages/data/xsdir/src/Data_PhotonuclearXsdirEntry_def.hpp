//---------------------------------------------------------------------------//
//!
//! \file   Data_PhotonuclearXsdirEntry_def.hpp
//! \author Alex Robinson
//! \brief  The photonuclear xsdir entry class template definitions
//!
//---------------------------------------------------------------------------//

#ifndef DATA_PHOTONUCLEAR_XSDIR_ENTRY_DEF_HPP
#define DATA_PHOTONUCLEAR_XSDIR_ENTRY_DEF_HPP
...
#endif // end DATA_PHOTONUCLEAR_XSDIR_ENTRY_DEF_HPP

//---------------------------------------------------------------------------//
// end Data_PhotonuclearXsdirEntry_def.hpp
//---------------------------------------------------------------------------//
