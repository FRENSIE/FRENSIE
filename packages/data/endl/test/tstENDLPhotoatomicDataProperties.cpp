//---------------------------------------------------------------------------//
//!
//! \file   tstENDLPhotoatomicDataProperties.cpp
//! \author Alex Robinson
//! \brief  ENDLPhotoatomicDataProperties class unit tests
//!
//---------------------------------------------------------------------------//
...
FRENSIE_UNIT_TEST( ENDLPhotoatomicDataProperties, atom )
{
...
FRENSIE_UNIT_TEST( ENDLPhotoatomicDataProperties, fileType )
{
...
//---------------------------------------------------------------------------//
// Check that the file type can be returned
FRENSIE_UNIT_TEST( ENDLPhotoatomicDataProperties, atomicWeight )
{
...
FRENSIE_UNIT_TEST( ENDLPhotoatomicDataProperties, fileStartLine )
{
...
FRENSIE_UNIT_TEST( ENDLPhotoatomicDataProperties, fileVersion )
{
...
FRENSIE_UNIT_TEST( ENDLPhotoatomicDataProperties, tableName )
{
...
FRENSIE_UNIT_TEST( ENDLPhotoatomicDataProperties, clone )
{
...
FRENSIE_UNIT_TEST_TEMPLATE_EXPAND( ENDLPhotoatomicDataProperties,
                                   archive,
                                   TestArchives )
{
  ...
  // Create and archive some properties
  {
    ...
    Data::ENDLPhotoatomicDataProperties local_properties(
                                                4.0*amu,
  ...
  Data::ENDLPhotoatomicDataProperties
...
{
  properties.reset( new Data::ENDLPhotoatomicDataProperties(
                                                 1.0*amu,
                                                 "photoatomic_data/h_data.xml",
                                                 0,
                                                 Data::H_ATOM ) );
...
//---------------------------------------------------------------------------//
// end tstENDLPhotoatomicDataProperties.cpp
//---------------------------------------------------------------------------//
