                                   ...
                                   TestArchives )
{
  ...
  // Create and archive some properties
  {
    ...
    Data::ENDLPhotoatomicDataProperties local_properties( "photoatomic_data/he_data.xml",
                                                          1,
                                                          Data::He_ATOM );
...
{
  properties.reset( new Data::ENDLPhotoatomicDataProperties( "photoatomic_data/h_data.xml",
                                                             0,
                                                             Data::H_ATOM ) );
}
