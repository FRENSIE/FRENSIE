                                   ...
                                   TestArchives )
{
  ...
  // Create and archive some properties
  {
    ...
    Data::ENDLElectroatomicDataProperties local_properties( "electroatomic_data/he_data.xml",
                                                          1,
                                                          Data::He_ATOM );
...
{
  properties.reset( new Data::ENDLElectroatomicDataProperties( "electroatomic_data/h_data.xml",
                                                               0,
                                                               Data::H_ATOM ) );
}
