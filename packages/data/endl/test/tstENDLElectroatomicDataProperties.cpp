//---------------------------------------------------------------------------//
//!
//! \file   tstENDLElectroatomicDataProperties.cpp
//! \author Alex Robinson
//! \brief  ENDLElectroatomicDataProperties class unit tests
//!
//---------------------------------------------------------------------------//
...
FRENSIE_UNIT_TEST( ENDLElectroatomicDataProperties, atom )
{
...
FRENSIE_UNIT_TEST( ENDLElectroatomicDataProperties, fileType )
{
...
FRENSIE_UNIT_TEST( ENDLElectroatomicDataProperties, atomicWeight )
{
...
FRENSIE_UNIT_TEST( ENDLElectroatomicDataProperties, fileStartLine )
{
...
FRENSIE_UNIT_TEST( ENDLElectroatomicDataProperties, fileVersion )
{
...
FRENSIE_UNIT_TEST( ENDLElectroatomicDataProperties, tableName )
{
...
FRENSIE_UNIT_TEST( ENDLElectroatomicDataProperties, clone )
{
...
FRENSIE_UNIT_TEST_TEMPLATE_EXPAND( ENDLElectroatomicDataProperties,
                                   archive,
                                   TestArchives )
{
  ...
  // Create and archive some properties
  {
    ...
    Data::ENDLElectroatomicDataProperties local_properties(
                                              4.0*amu,
  ...
  Data::ENDLElectroatomicDataProperties
...
{
  properties.reset( new Data::ENDLElectroatomicDataProperties(
                                               1.0*amu,
                                               "electroatomic_data/h_data.xml",
                                               0,
                                               Data::H_ATOM ) );
...
//---------------------------------------------------------------------------//
// end tstENDLElectroatomicDataProperties.cpp
//---------------------------------------------------------------------------//
