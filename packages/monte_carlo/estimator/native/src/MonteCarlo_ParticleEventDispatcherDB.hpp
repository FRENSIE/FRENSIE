...
#ifndef MONTE_CARLO_PARTICLE_EVENT_DISPATCHER_DB_HPP
#define MONTE_CARLO_PARTICLE_EVENT_DISPATCHER_DB_HPP
...
#endif // end MONTE_CARLO_PARTICLE_EVENT_DISPATCHER_DP_HPP
