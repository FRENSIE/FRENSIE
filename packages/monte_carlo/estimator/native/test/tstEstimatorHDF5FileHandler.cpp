...
std::string hdf5_file_name( "test_estimators.h5" );
...
{
  Teuchos::RCP<MonteCarlo::EstimatorHDF5FileHandler> file_handler;
...
{
  Teuchos::RCP<Utility::HDF5FileHandler> shared_handler( 
						new Utility::HDF5FileHandler );
  shared_handler->openHDF5FileAndOverwrite( hdf5_file_name );

  Teuchos::RCP<MonteCarlo::EstimatorHDF5FileHandler> estimator_file_handler(
...
TEUCHOS_UNIT_TEST( EstimatorHDF5FileHandler, set_getSimulationTime )
{
...
TEUCHOS_UNIT_TEST( EstimatorHDF5FileHandler, set_getLastHistorySimulated )
{
  MonteCarlo::EstimatorHDF5FileHandler file_handler( hdf5_file_name );
...
TEUCHOS_UNIT_TEST( EstimatorHDF5FileHandler, set_getNumberOfHistoriesSimulated)
{
  MonteCarlo::EstimatorHDF5FileHandler file_handler( hdf5_file_name );
