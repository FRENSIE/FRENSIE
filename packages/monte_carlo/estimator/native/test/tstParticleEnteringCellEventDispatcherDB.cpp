...
{
  TEST_EQUALITY_CONST( MonteCarlo::ParticleEnteringCellEventDispatcherDB::getDispatcher( 0 ).getId(), 0 );

  TEST_EQUALITY_CONST( MonteCarlo::ParticleEnteringCellEventDispatcherDB::getDispatcher( 1 ).getId(), 1 );
}
		   ...
		   detachObserver_dispatcher )
{
  ...
  TEST_EQUALITY_CONST( MonteCarlo::ParticleEnteringCellEventDispatcherDB::getDispatcher( 0 ).getNumberOfObservers(), 1 );

  MonteCarlo::ParticleEnteringCellEventDispatcherDB::detachObserver( 1, 0 );

  TEST_EQUALITY_CONST( MonteCarlo::ParticleEnteringCellEventDispatcherDB::getDispatcher( 1 ).getNumberOfObservers(), 1 );
}
		   ...
		   detachObserver_all_dispatchers )
{
  ...
  TEST_EQUALITY_CONST( MonteCarlo::ParticleEnteringCellEventDispatcherDB::getDispatcher( 0 ).getNumberOfObservers(), 0 );

  TEST_EQUALITY_CONST( MonteCarlo::ParticleEnteringCellEventDispatcherDB::getDispatcher( 1 ).getNumberOfObservers(), 0 );
}
