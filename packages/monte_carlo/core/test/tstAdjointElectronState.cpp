...
FRENSIE_UNIT_TEST( AdjointElectronState, getParticleType )
{
...
FRENSIE_UNIT_TEST( AdjointElectronState, getCharge )
{
  MonteCarlo::AdjointElectronState particle( 1ull );
...
FRENSIE_UNIT_TEST( AdjointElectronState, getSpeed )
{
  MonteCarlo::AdjointElectronState particle( 1ull );
...
FRENSIE_UNIT_TEST( AdjointElectronState, setSpeed )
{
  MonteCarlo::AdjointElectronState particle( 1ull );
...
FRENSIE_UNIT_TEST( AdjointElectronState, advance )
{
...
FRENSIE_UNIT_TEST( AdjointElectronState, isProbe )
{
  MonteCarlo::AdjointElectronState particle( 1ull );
...
FRENSIE_UNIT_TEST( AdjointElectronState, clone )
{
...
FRENSIE_UNIT_TEST( AdjointElectronState, clone_new_hist )
{
  boost::shared_ptr<MonteCarlo::ParticleState> particle(
				  new MonteCarlo::AdjointElectronState( 0ull ) );
  particle->setPosition( 1.0, 1.0, 1.0 );
...
FRENSIE_UNIT_TEST( AdjointElectronState, copy_constructor )
{
...
FRENSIE_UNIT_TEST_TEMPLATE_EXPAND( AdjointElectronState,
                                   archive,
                                   TestArchives )
{
  ...
  std::string archive_base_name( "test_adjoint_electron_state" );
  ...
  MonteCarlo::AdjointElectronState particle( 10ull );
