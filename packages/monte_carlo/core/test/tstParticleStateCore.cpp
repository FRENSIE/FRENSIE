...
{
  Teuchos::Array<MonteCarlo::ParticleStateCore> particle_state_cores( 1 );

  particle_state_cores[0].history_number = 0ull;
  particle_state_cores[0].particle_type = MonteCarlo::NEUTRON;
  ...
  Teuchos::Array<MonteCarlo::ParticleStateCore> ref_particle_state_cores;
