...
FRENSIE_UNIT_TEST( PositronState, getParticleType )
{
  MonteCarlo::PositronState particle( 1ull );

  FRENSIE_CHECK_EQUAL( particle.getParticleType(), MonteCarlo::POSITRON );
}

//---------------------------------------------------------------------------//
// Get the particle charge
FRENSIE_UNIT_TEST( PositronState, getCharge )
{
  MonteCarlo::PositronState particle( 1ull );
...
FRENSIE_UNIT_TEST( PositronState, getSpeed )
{
  MonteCarlo::PositronState particle( 1ull );
...
FRENSIE_UNIT_TEST( PositronState, setSpeed )
{
  MonteCarlo::PositronState particle( 1ull );
...
FRENSIE_UNIT_TEST( PositronState, advance )
{
...
FRENSIE_UNIT_TEST( PositronState, clone )
{
...
FRENSIE_UNIT_TEST( PositronState, clone_new_hist )
{
  boost::shared_ptr<MonteCarlo::ParticleState> particle(
				       new MonteCarlo::PositronState( 0ull ) );
  particle->setPosition( 1.0, 1.0, 1.0 );
...
FRENSIE_UNIT_TEST( PositronState, copy_constructor )
{
...
//---------------------------------------------------------------------------//
// Create new particles
FRENSIE_UNIT_TEST( PositronState, assignment_operator )
{
  MonteCarlo::PositronState particle_gen_a( 1ull );
  particle_gen_a.setPosition( 1.0, 1.0, 1.0 );
  particle_gen_a.setDirection( 0.0, 0.0, 1.0 );
...
FRENSIE_UNIT_TEST_TEMPLATE_EXPAND( PositronState, archive, TestArchives )
{
  ...
  std::string archive_base_name( "test_positron_state" );
