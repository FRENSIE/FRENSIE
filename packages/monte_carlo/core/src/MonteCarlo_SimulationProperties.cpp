...
double SimulationProperties::elastic_cutoff_angle = 1.0e-6;
...
void SimulationProperties::setElasticCutoffAngle( 
                          const double cutoff_angle )
{
  SimulationProperties::elastic_cutoff_angle = cutoff_angle;
}
