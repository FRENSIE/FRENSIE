						  ...
						  const SubshellType subshell )
{
  switch( subshell )
  {
  case K_SUBSHELL: return K_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case L1_SUBSHELL: return L1_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case L2_SUBSHELL: return L2_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case L3_SUBSHELL: return L3_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case M1_SUBSHELL: return M1_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case M2_SUBSHELL: return M2_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case M3_SUBSHELL: return M3_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case M4_SUBSHELL: return M4_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case M5_SUBSHELL: return M5_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case N1_SUBSHELL: return N1_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case N2_SUBSHELL: return N2_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case N3_SUBSHELL: return N3_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case N4_SUBSHELL: return N4_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case N5_SUBSHELL: return N5_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case N6_SUBSHELL: return N6_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case N7_SUBSHELL: return N7_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case O1_SUBSHELL: return O1_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case O2_SUBSHELL: return O2_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case O3_SUBSHELL: return O3_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case O4_SUBSHELL: return O4_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case O5_SUBSHELL: return O5_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case O6_SUBSHELL: return O6_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case O7_SUBSHELL: return O7_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case O8_SUBSHELL: return O8_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case O9_SUBSHELL: return O9_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case P1_SUBSHELL: return P1_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case P2_SUBSHELL: return P2_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case P3_SUBSHELL: return P3_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case P4_SUBSHELL: return P4_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case P5_SUBSHELL: return P5_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case P6_SUBSHELL: return P6_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case P7_SUBSHELL: return P7_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case P8_SUBSHELL: return P8_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case P9_SUBSHELL: return P9_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case P10_SUBSHELL: return P10_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case P11_SUBSHELL: return P11_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case Q1_SUBSHELL: return Q1_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case Q2_SUBSHELL: return Q2_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  case Q3_SUBSHELL: return Q3_SUBSHELL_PHOTOELECTRIC_PHOTOATOMIC_REACTION;
  default:
    THROW_EXCEPTION( std::logic_error,
						  ...
						  const SubshellType subshell )
{
  switch( subshell )
  {
  case K_SUBSHELL: return K_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case L1_SUBSHELL: return L1_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case L2_SUBSHELL: return L2_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case L3_SUBSHELL: return L3_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case M1_SUBSHELL: return M1_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case M2_SUBSHELL: return M2_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case M3_SUBSHELL: return M3_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case M4_SUBSHELL: return M4_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case M5_SUBSHELL: return M5_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case N1_SUBSHELL: return N1_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case N2_SUBSHELL: return N2_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case N3_SUBSHELL: return N3_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case N4_SUBSHELL: return N4_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case N5_SUBSHELL: return N5_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case N6_SUBSHELL: return N6_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case N7_SUBSHELL: return N7_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case O1_SUBSHELL: return O1_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case O2_SUBSHELL: return O2_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case O3_SUBSHELL: return O3_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case O4_SUBSHELL: return O4_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case O5_SUBSHELL: return O5_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case O6_SUBSHELL: return O6_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case O7_SUBSHELL: return O7_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case O8_SUBSHELL: return O8_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case O9_SUBSHELL: return O9_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case P1_SUBSHELL: return P1_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case P2_SUBSHELL: return P2_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case P3_SUBSHELL: return P3_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case P4_SUBSHELL: return P4_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case P5_SUBSHELL: return P5_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case P6_SUBSHELL: return P6_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case P7_SUBSHELL: return P7_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case P8_SUBSHELL: return P8_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case P9_SUBSHELL: return P9_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case P10_SUBSHELL: return P10_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case P11_SUBSHELL: return P11_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case Q1_SUBSHELL: return Q1_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case Q2_SUBSHELL: return Q2_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  case Q3_SUBSHELL: return Q3_SUBSHELL_INCOHERENT_PHOTOATOMIC_REACTION;
  default:
    THROW_EXCEPTION( std::logic_error,
		     "Error: the invalid shell does not have a corresponding " 
		     "photoelectric photoatomic reaction!" );
