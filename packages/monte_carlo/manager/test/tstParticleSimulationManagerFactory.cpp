...
std::vector<std::shared_ptr<const MonteCarlo::PopulationControl>> population_controllers;
...
FRENSIE_UNIT_TEST( ParticleSimulationManagerFactory,
                   constructor_set_population_controllers )
{
  std::shared_ptr<MonteCarlo::SimulationProperties> properties(
                                        new MonteCarlo::SimulationProperties );
  properties->setParticleMode( MonteCarlo::NEUTRON_MODE );
  ...
  factory->setPopulationControllers( population_controllers );

  FRENSIE_CHECK_EQUAL( population_controllers[0].use_count(), 2 );
  ...
  FRENSIE_CHECK_EQUAL( manager->getSimulationArchiveType(), "xml" );
  FRENSIE_CHECK_EQUAL( Utility::OpenMPProperties::getRequestedNumberOfThreads(), 1 );
  FRENSIE_CHECK_EQUAL( population_controllers[0].use_count(), 3 );
}
...
FRENSIE_UNIT_TEST( ParticleSimulationManagerFactory,
                   constructor_set_population_controllers_collision_forcer )
{
  std::shared_ptr<MonteCarlo::SimulationProperties> properties(
                                        new MonteCarlo::SimulationProperties );
  properties->setParticleMode( MonteCarlo::NEUTRON_MODE );
...
FRENSIE_CUSTOM_UNIT_TEST_INIT()
{
  ...
  population_controllers[0] = MonteCarlo::WeightWindow::getDefault();
