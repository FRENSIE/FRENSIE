...
TEUCHOS_UNIT_TEST( AbsorptionAdjointElectroatomicReaction, getCrossSection )
{
  ...
  TEST_FLOATING_EQUALITY( cross_section, 4.33593594283757682e+01, 1e-12 );

  cross_section = absorption_reaction->getCrossSection( 6.96644693794250302e-04 );
  TEST_FLOATING_EQUALITY( cross_section, 2.24005846303539080e+01, 1e-12 );

  cross_section = absorption_reaction->getCrossSection( 20.0 );
  TEST_FLOATING_EQUALITY( cross_section, 8.36678200548424122e-01, 1e-12 );
}
