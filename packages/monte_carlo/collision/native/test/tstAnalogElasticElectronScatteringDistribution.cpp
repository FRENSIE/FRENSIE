...
public:
  ...
  using MonteCarlo::AnalogElasticElectronScatteringDistribution::sampleIndependent;
                   ...
                   evaluate )
{
  ...
  value =
    elastic_distribution->evaluate( energy,
                                    scattering_angle_cosine );
  // Test 1 energy 3
  TEST_FLOATING_EQUALITY( value, 4.84464407910787E-07, 1e-12 );
  ...
  value =
    elastic_distribution->evaluate( energy,
                                    scattering_angle_cosine );
  // Test 2 energy 3
  TEST_FLOATING_EQUALITY( value, 1.01168096559711E-05, 1e-12 );
  ...
  value =
    elastic_distribution->evaluate( energy,
                                    scattering_angle_cosine );
  // Test 3 energy 3
  TEST_FLOATING_EQUALITY( value, 9.85083571617589E+05, 1e-12 );
  ...
  value =
    elastic_distribution->evaluate( energy,
                                    scattering_angle_cosine );
  // Test 4 energy 3
  TEST_FLOATING_EQUALITY( value, 1.582771539320770E+13, 1e-12 );
  }
}
                   ...
                   evaluateScreenedRutherford )
{
  ...
  // Test energy 3
  TEST_FLOATING_EQUALITY( pdf_value, 1.582771539320770E+13, tol );
}
                   ...
                   evaluatePDF )
{
  ...
  value =
    elastic_distribution->evaluatePDF( energy,
                                       scattering_angle_cosine );
  // Test 1 energy 3
  TEST_FLOATING_EQUALITY( value, 4.84464208455224E-07, 1e-12 );
  ...
  value =
    elastic_distribution->evaluatePDF( energy,
                                       scattering_angle_cosine );
  // Test 2 energy 3
  TEST_FLOATING_EQUALITY( value, 1.01168054908479E-05, 1e-12 );
  ...
  value =
    elastic_distribution->evaluatePDF( energy,
                                       scattering_angle_cosine );
  // Test 3 energy 3
  TEST_FLOATING_EQUALITY( value, 9.85083166055497E+05, 1e-12 );
  ...
  value =
    elastic_distribution->evaluatePDF( energy,
                                       scattering_angle_cosine );
  // Test 4 energy 3
  TEST_FLOATING_EQUALITY( value, 1.582770887688610E+13, 1e-12 );
}
                   ...
                   evaluateScreenedRutherfordPDF )
{
  ...
  double pdf_value = 
    test_elastic_distribution->evaluateScreenedRutherfordPDF(
                        energy,
                        scattering_angle_cosine,
                        eta );
  ...
  // Test energy 3
  TEST_FLOATING_EQUALITY( pdf_value, 1.582770887688610E+13, tol );
}
                   ...
                   evaluateCDF )
{
  ...
  double value =
    elastic_distribution->evaluateCDF( energy,
                                       scattering_angle_cosine );
  // Test 1 energy 1
  ...
  value =
    elastic_distribution->evaluateCDF( energy,
                                       scattering_angle_cosine );
  // Test 3 energy 1
  TEST_FLOATING_EQUALITY( value, 1.0E+00, 1e-12 );
  ...
  value =
    elastic_distribution->evaluateCDF( energy,
                                       scattering_angle_cosine );
  // Test 1 energy 3
  TEST_FLOATING_EQUALITY( value, 1.50737238732271E-07, 1e-12 );
  ...
  value =
    elastic_distribution->evaluateCDF( energy,
                                       scattering_angle_cosine );
  // Test 2 energy 3
  TEST_FLOATING_EQUALITY( value, 2.00665195287969E-06, 1e-12 );
  ...
  value =
    elastic_distribution->evaluateCDF( energy,
                                       scattering_angle_cosine );
  // Test 4 energy 3
  TEST_FLOATING_EQUALITY( value, 3.94962122426858E+03, 1e-12 );
}
                   ...
                   evaluateScreenedRutherfordCDF )
{
  ...
  // Set energy in MeV
  double energy = 1.0e+5;
  double scattering_angle_cosine = 1.00;

  double eta =
    test_elastic_distribution->evaluateMoliereScreeningConstant( energy );

  // Calculate the pdf
  double pdf_value = test_elastic_distribution->evaluateScreenedRutherfordCDF(
                        energy,
                        scattering_angle_cosine,
                        eta );

  // Test energy 1
  TEST_FLOATING_EQUALITY( pdf_value, 9.83757207759616E+08, tol );
  ...
  pdf_value = test_elastic_distribution->evaluateScreenedRutherfordCDF(
                        energy,
                        scattering_angle_cosine,
                        eta );

  // Test energy 2
  TEST_FLOATING_EQUALITY( pdf_value, 4.39444544314946E+02, tol );
  ...
  // Test energy 3
  TEST_FLOATING_EQUALITY( pdf_value, 3.94962122426858E+03, tol );
}
