...
TEUCHOS_UNIT_TEST( ScreenedRutherfordElasticPositronatomicReaction, getReactionType )
{
...
TEUCHOS_UNIT_TEST( ScreenedRutherfordElasticPositronatomicReaction, getThresholdEnergy )
{
...
TEUCHOS_UNIT_TEST( ScreenedRutherfordElasticPositronatomicReaction, getNumberOfEmittedElectrons )
{
...
TEUCHOS_UNIT_TEST( ScreenedRutherfordElasticPositronatomicReaction, getNumberOfEmittedPhotons )
{
...
TEUCHOS_UNIT_TEST( ScreenedRutherfordElasticPositronatomicReaction,
                   getCrossSection )
{
...
TEUCHOS_UNIT_TEST( ScreenedRutherfordElasticPositronatomicReaction, react )
{
