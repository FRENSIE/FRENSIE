//---------------------------------------------------------------------------//
//!
//! \file   tstCollisionHandlerFactoryNeutronPhotonMode_Root.cpp
//! \author Eli Moll
...
TEUCHOS_UNIT_TEST( CollisionHandlerFactory, initializeHandlerUsingDagMC )
{
  ...
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellPhotonMaterial( 2 )->getId() == 1 );
  TEST_FLOATING_EQUALITY(
	   MonteCarlo::CollisionHandler::getCellPhotonMaterial( 2 )->getNumberDensity(),
	   1.0,
	   1e-12 );
...
//---------------------------------------------------------------------------//
// end tstCollisionHandlerFactoryNeutronPhotonMode_Root.cpp
//---------------------------------------------------------------------------//
