 ...
 * data can be created
 */
TEUCHOS_UNIT_TEST( PositronatomNativeFactory, createPositronatom_default )
{
...
TEUCHOS_UNIT_TEST( PositronatomNativeFactory, createPositronatom_coupled )
{
  MonteCarlo::SimulationProperties properties;
...
TEUCHOS_UNIT_TEST( PositronatomNativeFactory, createPositronatom_cutoff )
{
  MonteCarlo::SimulationProperties properties;
...
TEUCHOS_UNIT_TEST( PositronatomNativeFactory, createPositronatom_hybrid )
{
  ...
  MonteCarlo::ElasticElectronScatteringDistributionNativeFactory::createCutoffElasticDistribution<Utility::Correlated<Utility::LogLogCosLog<true> > >(
        cutoff_elastic_distribution,
        *data_container,
...
TEUCHOS_UNIT_TEST( PositronatomNativeFactory, createPositronatom_no_elastic )
{
  MonteCarlo::SimulationProperties properties;
  properties.setBremsstrahlungAngularDistributionFunction( MonteCarlo::DIPOLE_DISTRIBUTION );
...
TEUCHOS_UNIT_TEST( PositronatomNativeFactory, createPositronatom_no_positronionization )
{
  MonteCarlo::SimulationProperties properties;
  properties.setBremsstrahlungAngularDistributionFunction( MonteCarlo::DIPOLE_DISTRIBUTION );
  properties.setElasticCutoffAngleCosine( 1.0 );
...
TEUCHOS_UNIT_TEST( PositronatomNativeFactory, createPositronatom_no_bremsstrahlung )
{
  MonteCarlo::SimulationProperties properties;
  properties.setBremsstrahlungAngularDistributionFunction( MonteCarlo::DIPOLE_DISTRIBUTION );
  properties.setElasticCutoffAngleCosine( 1.0 );
...
TEUCHOS_UNIT_TEST( PositronatomNativeFactory, createPositronatom_no_atomic_excitation )
{
  MonteCarlo::SimulationProperties properties;
  properties.setBremsstrahlungAngularDistributionFunction( MonteCarlo::DIPOLE_DISTRIBUTION );
  properties.setElasticCutoffAngleCosine( 1.0 );
