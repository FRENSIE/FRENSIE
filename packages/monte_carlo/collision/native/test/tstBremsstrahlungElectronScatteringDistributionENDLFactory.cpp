//---------------------------------------------------------------------------//
//!
//! \file   tstBremsstrahlungElectronScatteringDistributionENDLFactory.cpp
//! \author Luke Kersting
//! \brief  bremsstrahlung scattering distribution ENDL factory unit tests
//!
//---------------------------------------------------------------------------//
...
TEUCHOS_UNIT_TEST( BremsstrahlungElectronScatteringDistributionENDLFactory,
                   sample_DipoleBremsstrahlung )
{
  MonteCarlo::BremsstrahlungElectronScatteringDistributionENDLFactory::createBremsstrahlungDistribution(
                                                 *data_container,
                                                 energy_grid,
                                                 dipole_distribution );
...
int main( int argc, char** argv )
{
  ...
  energy_grid = data_container->getBremsstrahlungPhotonEnergyGrid();
...
//---------------------------------------------------------------------------//
// end tstBremsstrahlungElectronScatteringDistributionENDLFactory.cpp
//---------------------------------------------------------------------------//
