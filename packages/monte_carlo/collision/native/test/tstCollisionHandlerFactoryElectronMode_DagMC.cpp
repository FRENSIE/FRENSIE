...
TEUCHOS_UNIT_TEST( CollisionHandlerFactory, initializeHandlerUsingDagMC )
{
  ...
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 26 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 27, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 27 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 28, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 28 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 29, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 29 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 30, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 30 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 31, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 31 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 32, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 32 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 33, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 33 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 34, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 34 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 35, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 35 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 36, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 36 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 37, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 37 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 48, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 48 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 49, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 49 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 50, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 50 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 51, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 51 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 52, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 52 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 53, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 53 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 54, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 54 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 55, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 55 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 56, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 56 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 57, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 57 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 58, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 58 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 59, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 59 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 70, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 70 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 71, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 71 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 72, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 72 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 73, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 73 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 74, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 74 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 75, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 75 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 76, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 76 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 77, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 77 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 78, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 78 )->getId() == 9 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 79, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 79 )->getId() == 9 );
  ...
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 41 )->getId() == 3 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 63, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 63 )->getId() == 3 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 82, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 82 )->getId() == 3 );
  TEST_ASSERT( !MonteCarlo::CollisionHandler::isCellVoid( 152, MonteCarlo::ELECTRON ) );
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 152 )->getId() == 3);
  ...
  TEST_ASSERT( MonteCarlo::CollisionHandler::getCellElectronMaterial( 83 )->getId() == 7 );
