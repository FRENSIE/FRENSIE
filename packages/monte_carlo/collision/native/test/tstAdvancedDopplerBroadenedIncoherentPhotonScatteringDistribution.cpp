//---------------------------------------------------------------------------//
//!
//! \file tstAdvancedDopplerBroadenedIncoherentPhotonScatteringDistribution.cpp
...
TEUCHOS_UNIT_TEST( AdvancedDopplerBroadenedIncoherentPhotonScatteringDistribution,
		   evaluate )
{
...
int main( int argc, char** argv )
{
  ...
  distribution.reset(
   new MonteCarlo::AdvancedDopplerBroadenedIncoherentPhotonScatteringDistribution( 
			  scattering_function,
...
//---------------------------------------------------------------------------//
// end tstAdvancedDopplerBroadenedIncoherentPhotonScatteringDistribution.cpp
//---------------------------------------------------------------------------//
