...
{
  // Get max energy
  double max_energy = endl_distribution->getMaxSecondaryEnergyAtIncomingEnergy( 8.829E-02 );

  // Test original electron
  TEST_EQUALITY_CONST( max_energy, 1e-7 );

  // Get max energy
  max_energy = endl_distribution->getMaxSecondaryEnergyAtIncomingEnergy( 1e5 );

  // Test original electron
  TEST_EQUALITY_CONST( max_energy, 5e4 );

  // Get max energy
  max_energy = endl_distribution->getMaxSecondaryEnergyAtIncomingEnergy( 2.0 );
