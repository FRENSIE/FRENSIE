//---------------------------------------------------------------------------//
//!
//! \file   MonteCarlo_ElectronScatteringAngularDistribution.cpp
//! \author Luke Kersting
//! \brief  The electron scattering angular distribution base class definition
//!
//---------------------------------------------------------------------------//
...
// FRENSIE Includes
#include "MonteCarlo_ElectronScatteringAngularDistribution.hpp"
...
// Constructor
ElectronScatteringAngularDistribution::ElectronScatteringAngularDistribution( 
	const ElectronScatteringAngularDistribution::AngularDistribution& dist )
...
double ElectronScatteringAngularDistribution::sampleAngleCosine( 
...
// Evaluate the PDF
double ElectronScatteringAngularDistribution::evaluatePDF( 
				const double energy,
...
//---------------------------------------------------------------------------//
// end MonteCarlo_ElectronScatteringAngularDistribution.cpp
//---------------------------------------------------------------------------//
