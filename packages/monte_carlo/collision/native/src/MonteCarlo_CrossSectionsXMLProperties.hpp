//---------------------------------------------------------------------------//
//!
//! \file   MonteCarlo_CrossSectionsXMLProperties.hpp
//! \author Alex Robinson
//! \brief  cross_sections.xml file properties and helper functions decls.
//!
//---------------------------------------------------------------------------//

#ifndef MONTE_CARLO_CROSS_SECTIONS_XML_PROPERTIES_HPP
#define MONTE_CARLO_CROSS_SECTIONS_XML_PROPERTIES_HPP
...
#endif // end MONTE_CARLO_CROSS_SECTIONS_XML_PROPERTIES_HPP

//---------------------------------------------------------------------------//
// end MonteCarlo_CrossSectionXMLProperties.hpp
//---------------------------------------------------------------------------//
