...
StandardComptonProfile<StoredMomentumUnit,StoredInverseMomentumUnit,SmartPointer>::StandardComptonProfile( const SmartPointer<Utility::UnitAwareTabularOneDDistribution<StoredMomentumUnit,StoredInverseMomentumUnit> >& raw_compton_profile )
