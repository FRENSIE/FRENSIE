//---------------------------------------------------------------------------//
//!
//! \file   MonteCarlo_CollisionHandlerFactory_Root_def.hpp
//! \author Alex Robinson, Eli Moll
//! \brief  Collision handler factory class template definitions
//!
//---------------------------------------------------------------------------//

#ifndef MONTE_CARLO_COLLISION_HANDLER_FACTORY_ROOT_DEF_HPP
#define MONTE_CARLO_COLLISION_HANDLER_FACTORY_ROOT_DEF_HPP
...
void CollisionHandlerFactory<Geometry::Root>::createMaterialNameDataMaps(
...
void CollisionHandlerFactory<Geometry::Root>::registerMaterials(
...
#endif // end MONTE_CARLO_COLLISION_HANDLER_FACTORY_DAGMC_DEF_HPP

//---------------------------------------------------------------------------//
// end MonteCarlo_CollisionHandlerFactory_Root_def.hpp
//---------------------------------------------------------------------------//
