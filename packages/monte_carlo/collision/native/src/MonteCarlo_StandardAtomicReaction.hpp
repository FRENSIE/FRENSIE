//---------------------------------------------------------------------------//
//!
//! \file   MonteCarlo_StandardAtomicReaction.hpp
//! \author Luke Kersting
//! \brief  The standard atomic reaction base class declaration
//!
//---------------------------------------------------------------------------//

#ifndef MONTE_CARLO_STANDARD_ATOMIC_REACTION_HPP
#define MONTE_CARLO_STANDARD_ATOMIC_REACTION_HPP
...
/*! The standard atomic reaction base class
...
class StandardAtomicReaction : public AtomicReaction
{
...
class StandardAtomicReaction<InterpPolicy,false> : public AtomicReaction
{
public:
...
#include "MonteCarlo_StandardAtomicReaction_def.hpp"

//---------------------------------------------------------------------------//

#endif // end MONTE_CARLO_STANDARD_ATOMIC_REACTION_HPP

//---------------------------------------------------------------------------//
// end MonteCarlo_StandardAtomicReaction.hpp
//---------------------------------------------------------------------------//
