...
void ElasticElectronScatteringDistributionNativeFactory<TwoDInterpPolicy>::createAnalogElasticDistribution(
    std::shared_ptr<const AnalogElasticElectronScatteringDistribution>&
        analog_elastic_distribution,
    const Data::ElectronPhotonRelaxationDataContainer& data_container,
    const double evaluation_tol )
{
  ElasticElectronScatteringDistributionNativeFactory<TwoDInterpPolicy>::createAnalogElasticDistribution(
    analog_elastic_distribution,
...
template<typename TwoDInterpPolicy>
void ElasticElectronScatteringDistributionNativeFactory<TwoDInterpPolicy>::createHybridElasticDistribution(
...
ElasticElectronScatteringDistributionNativeFactory<TwoDInterpPolicy>::createHybridElasticDistribution(
    hybrid_elastic_distribution,
    grid_searcher,
    energy_grid,
...
template<typename TwoDInterpPolicy>
void ElasticElectronScatteringDistributionNativeFactory<TwoDInterpPolicy>::createCutoffElasticDistribution(
    ...
    const double evaluation_tol )
{
  ElasticElectronScatteringDistributionNativeFactory<TwoDInterpPolicy>::createCutoffElasticDistribution(
    cutoff_elastic_distribution,
    data_container.getCutoffElasticAngles(),
    data_container.getCutoffElasticPDF(),
    data_container.getElasticAngularEnergyGrid(),
...
template<typename TwoDInterpPolicy>
void ElasticElectronScatteringDistributionNativeFactory<TwoDInterpPolicy>::createMomentPreservingElasticDistribution(
    ...
    const double evaluation_tol )
{
  ...
  ElasticElectronScatteringDistributionNativeFactory<TwoDInterpPolicy>::createMomentPreservingElasticDistribution(
    moment_preserving_elastic_distribution,
    data_container.getElasticAngularEnergyGrid(),
    data_container.getMomentPreservingElasticDiscreteAngles(),
    data_container.getMomentPreservingElasticWeights(),
    ...
    const double evaluation_tol )
{
  ...
  // Create the scattering function
  ElasticElectronScatteringDistributionNativeFactory<TwoDInterpPolicy>::createScatteringFunction(
    ...
    const double evaluation_tol )
{
  ...
  ElasticElectronScatteringDistributionNativeFactory<TwoDInterpPolicy>::createHybridScatteringFunction(
    grid_searcher,
    energy_grid,
    cutoff_cross_section,
    cutoff_elastic_angles,
...
template<typename TwoDInterpPolicy>
void ElasticElectronScatteringDistributionNativeFactory<TwoDInterpPolicy>::createScreenedRutherfordElasticDistribution(
...
template<typename TwoDInterpPolicy>
std::vector<double> ElasticElectronScatteringDistributionNativeFactory<TwoDInterpPolicy>::getAngularGrid(
    ...
    const double cutoff_angle_cosine )
{
  ...
  return ElasticElectronScatteringDistributionNativeFactory<TwoDInterpPolicy>::getAngularGrid(
            raw_grid,
            cutoff_angle_cosine );
}
...
template<typename TwoDInterpPolicy>
void ElasticElectronScatteringDistributionNativeFactory<TwoDInterpPolicy>::getAngularGridAndPDF(
...
template<typename TwoDInterpPolicy>
void ElasticElectronScatteringDistributionNativeFactory<TwoDInterpPolicy>::createHybridScatteringFunction(
    const Teuchos::RCP<Utility::HashBasedGridSearcher>& grid_searcher,
    const Teuchos::ArrayRCP<const double> energy_grid,
    const Teuchos::ArrayRCP<const double> cutoff_cross_section,
    const std::map<double,std::vector<double> >& cutoff_elastic_angles,
 ...
 */
template<typename TwoDInterpPolicy>
void ElasticElectronScatteringDistributionNativeFactory<TwoDInterpPolicy>::createScatteringFunction(
