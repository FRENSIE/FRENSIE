...
#ifndef MONTE_CARLO_ACE_LAW_3_NEUTRON_SCATTERING_ENERGY_DISTRIBUTION_HPP
#define MONTE_CARLO_ACE_LAW_3_NEUTRON_SCATTERING_ENERGY_DISTRIBUTION_HPP
...
#endif // end MONTE_CARLO_ACE_LAW_3_NEUTRON_SCATTERING_ENERGY_DISTRIBUTION_HPP
