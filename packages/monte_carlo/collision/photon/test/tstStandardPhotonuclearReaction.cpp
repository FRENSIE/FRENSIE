...
std::string h2_ace_file_name, c12_ace_file_name;
std::string h2_ace_table_name, c12_ace_table_name;
...
FRENSIE_CUSTOM_UNIT_TEST_COMMAND_LINE_OPTIONS()
{
  ...
  ADD_STANDARD_OPTION_AND_ASSIGN_VALUE( "c12_ace_table",
                                        c12_ace_table_name, "",
...
FRENSIE_CUSTOM_UNIT_TEST_INIT()
{
  ...
  ace_file_handler.reset( new Data::ACEFileHandler( c12_ace_file_name,
                                                    c12_ace_table_name,
                                                    1u ) );
