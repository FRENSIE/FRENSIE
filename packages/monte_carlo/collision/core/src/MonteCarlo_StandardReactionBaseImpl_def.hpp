                                               ...
                                               const size_t bin_index ) const
{
  ...
  testPrecondition( (Details::StandardReactionBaseImplInterpPolicyHelper<InterpPolicy,processed_cross_section>::returnEnergyOfInterest( (*d_incoming_energy_grid)[bin_index] ) <=
                     energy) );
  testPrecondition( (Details::StandardReactionBaseImplInterpPolicyHelper<InterpPolicy,processed_cross_section>::returnEnergyOfInterest( (*d_incoming_energy_grid)[bin_index+1] ) >=
                     energy) );
