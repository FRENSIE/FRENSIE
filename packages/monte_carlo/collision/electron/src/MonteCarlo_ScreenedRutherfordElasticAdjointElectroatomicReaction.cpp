...
EXPLICIT_TEMPLATE_CLASS_INST( ScreenedRutherfordElasticAdjointElectroatomicReaction<Utility::LinLog,false> );
EXPLICIT_TEMPLATE_CLASS_INST( ScreenedRutherfordElasticAdjointElectroatomicReaction<Utility::LinLog,true> );

EXPLICIT_TEMPLATE_CLASS_INST( ScreenedRutherfordElasticAdjointElectroatomicReaction<Utility::LogLin,false> );
EXPLICIT_TEMPLATE_CLASS_INST( ScreenedRutherfordElasticAdjointElectroatomicReaction<Utility::LogLin,true> );
