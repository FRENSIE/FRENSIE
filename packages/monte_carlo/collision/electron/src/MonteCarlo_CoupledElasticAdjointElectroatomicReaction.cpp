...
EXPLICIT_TEMPLATE_CLASS_INST( CoupledElasticAdjointElectroatomicReaction<Utility::LinLog,false> );
EXPLICIT_TEMPLATE_CLASS_INST( CoupledElasticAdjointElectroatomicReaction<Utility::LinLog,true> );

EXPLICIT_TEMPLATE_CLASS_INST( CoupledElasticAdjointElectroatomicReaction<Utility::LogLin,false> );
EXPLICIT_TEMPLATE_CLASS_INST( CoupledElasticAdjointElectroatomicReaction<Utility::LogLin,true> );
