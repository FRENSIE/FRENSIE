...
EXPLICIT_TEMPLATE_CLASS_INST( HybridElasticAdjointElectroatomicReaction<Utility::LinLog,false> );
EXPLICIT_TEMPLATE_CLASS_INST( HybridElasticAdjointElectroatomicReaction<Utility::LinLog,true> );

EXPLICIT_TEMPLATE_CLASS_INST( HybridElasticAdjointElectroatomicReaction<Utility::LogLin,false> );
EXPLICIT_TEMPLATE_CLASS_INST( HybridElasticAdjointElectroatomicReaction<Utility::LogLin,true> );
