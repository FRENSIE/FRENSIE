...
Positronatom::Positronatom(
   ...
   const Positronatom::ConstReactionMap& standard_scattering_reactions,
   const Positronatom::ConstReactionMap& standard_absorption_reactions,
  ...
  : BaseType( name, atomic_number, atomic_weight) 
{
  ...
  // Populate the core
  BaseType::setCore( PositronatomCore( energy_grid,
                                       grid_searcher,
