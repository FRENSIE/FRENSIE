 ...
 * data can be created
 */
FRENSIE_UNIT_TEST( ElectroatomNativeFactory, createElectroatom_default )
{
...
FRENSIE_UNIT_TEST( ElectroatomNativeFactory, createElectroatom_cutoff )
{
  MonteCarlo::SimulationProperties properties;
...
FRENSIE_UNIT_TEST( ElectroatomNativeFactory, createElectroatom_hybrid )
{
...
FRENSIE_UNIT_TEST( ElectroatomNativeFactory, createElectroatom_no_elastic )
{
  MonteCarlo::SimulationProperties properties;
  properties.setBremsstrahlungAngularDistributionFunction( MonteCarlo::DIPOLE_DISTRIBUTION );
...
FRENSIE_UNIT_TEST( ElectroatomNativeFactory, createElectroatom_no_electroionization )
{
  MonteCarlo::SimulationProperties properties;
  properties.setBremsstrahlungAngularDistributionFunction( MonteCarlo::DIPOLE_DISTRIBUTION );
  properties.setElasticCutoffAngleCosine( 1.0 );
...
FRENSIE_UNIT_TEST( ElectroatomNativeFactory, createElectroatom_no_bremsstrahlung )
{
  MonteCarlo::SimulationProperties properties;
  properties.setBremsstrahlungAngularDistributionFunction( MonteCarlo::DIPOLE_DISTRIBUTION );
  properties.setElasticCutoffAngleCosine( 1.0 );
...
FRENSIE_UNIT_TEST( ElectroatomNativeFactory, createElectroatom_no_atomic_excitation )
{
  MonteCarlo::SimulationProperties properties;
  properties.setBremsstrahlungAngularDistributionFunction( MonteCarlo::DIPOLE_DISTRIBUTION );
  properties.setElasticCutoffAngleCosine( 1.0 );
