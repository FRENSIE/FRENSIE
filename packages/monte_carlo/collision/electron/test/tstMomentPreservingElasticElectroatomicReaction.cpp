...
FRENSIE_UNIT_TEST( MomentPreservingElasticElectroatomicReaction, getReactionType )
{
...
FRENSIE_UNIT_TEST( MomentPreservingElasticElectroatomicReaction, getThresholdEnergy )
{
...
FRENSIE_UNIT_TEST( MomentPreservingElasticElectroatomicReaction, getNumberOfEmittedElectrons )
{
...
FRENSIE_UNIT_TEST( MomentPreservingElasticElectroatomicReaction, getNumberOfEmittedPhotons )
{
...
FRENSIE_UNIT_TEST( MomentPreservingElasticElectroatomicReaction, getNumberOfEmittedPositrons )
{
...
FRENSIE_UNIT_TEST( MomentPreservingElasticElectroatomicReaction,
                   getCrossSection )
{
...
FRENSIE_UNIT_TEST( MomentPreservingElasticElectroatomicReaction, react )
{
...
FRENSIE_CUSTOM_UNIT_TEST_INIT()
{
  // Create reaction
  {
    ...
    std::shared_ptr<BasicBivariateDist> scattering_function(
       new Utility::InterpolatedFullyTabularBasicBivariateDistribution<Utility::Correlated<Utility::LogLogCosLog<false> > >(
                                                        primary_grid,
                                                        secondary_dists ) );
