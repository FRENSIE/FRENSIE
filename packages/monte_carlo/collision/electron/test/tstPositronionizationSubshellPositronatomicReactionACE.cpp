//---------------------------------------------------------------------------//
//!
//! \file   tstPositronionizationSubshellPositronatomicReactionACE.cpp
...
FRENSIE_UNIT_TEST( PositronionizationSubshellPositronatomicReaction, getReactionType_ace )
{
...
FRENSIE_UNIT_TEST( PositronionizationSubshellPositronatomicReaction, getThresholdEnergy_ace )
{
...
FRENSIE_UNIT_TEST( PositronionizationSubshellPositronatomicReaction, getNumberOfEmittedElectrons_ace )
{
...
FRENSIE_UNIT_TEST( PositronionizationSubshellPositronatomicReaction, getNumberOfEmittedPhotons_ace )
{
...
FRENSIE_UNIT_TEST( PositronionizationSubshellPositronatomicReaction, getNumberOfEmittedPositrons_ace )
{
...
FRENSIE_UNIT_TEST( PositronionizationSubshellPositronatomicReaction, getCrossSection_ace )
{
  // First Subshell
...
FRENSIE_UNIT_TEST( PositronionizationSubshellPositronatomicReaction, react_ace )
{
  ...
  FRENSIE_CHECK( positron.getEnergy() < 20.0 );
...
//---------------------------------------------------------------------------//
  ...
  std::vector<double> first_table_length(
                              eion_block(
...
//---------------------------------------------------------------------------//
// end tstPositronionizationSubshellPositronatomicReactionACE.cpp
//---------------------------------------------------------------------------//
