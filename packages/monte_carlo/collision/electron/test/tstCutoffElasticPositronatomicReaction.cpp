//---------------------------------------------------------------------------//
//!
//! \file   tstCutoffElasticPositronatomicReaction.cpp
//! \author Luke Kersting
//! \brief  Cutoff elastic positron-atomic reaction unit tests
//!
//---------------------------------------------------------------------------//
...
FRENSIE_UNIT_TEST( CutoffElasticPositronatomicReaction, getReactionType_ace )
{
...
FRENSIE_UNIT_TEST( CutoffElasticPositronatomicReaction, getThresholdEnergy_ace )
{
...
FRENSIE_UNIT_TEST( CutoffElasticPositronatomicReaction, getNumberOfEmittedElectrons_ace )
{
...
FRENSIE_UNIT_TEST( CutoffElasticPositronatomicReaction, getNumberOfEmittedPhotons_ace )
{
...
//---------------------------------------------------------------------------//
// Check that the number of photons emitted from the rxn can be returned
FRENSIE_UNIT_TEST( CutoffElasticPositronatomicReaction, getNumberOfEmittedPositrons_ace )
{
...
FRENSIE_UNIT_TEST( CutoffElasticPositronatomicReaction, getCrossSection_ace )
{
...
FRENSIE_UNIT_TEST( CutoffElasticPositronatomicReaction,
                   getCrossSection_cutoff_ace )
{
  ...
  test_elastic_reaction.reset(
    new MonteCarlo::CutoffElasticPositronatomicReaction<Utility::LinLin>(
                energy_grid,
...
FRENSIE_UNIT_TEST( CutoffElasticPositronatomicReaction, react_ace )
{
  ...
  ace_elastic_reaction->react( positron, bank, shell_of_interaction );
...
//---------------------------------------------------------------------------//
// end tstCutoffElasticPositronatomicReaction.cpp
//---------------------------------------------------------------------------//
