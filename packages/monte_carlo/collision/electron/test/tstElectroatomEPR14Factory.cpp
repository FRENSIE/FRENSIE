...
FRENSIE_UNIT_TEST( ElectroatomACEFactory, createElectroatom_basic )
{
  ...
  cross_section = atom->getReactionCrossSection( 1.0e-5, reaction );
  FRENSIE_CHECK_EQUAL( cross_section, 1.310577e+08 );
...
FRENSIE_UNIT_TEST( ElectroatomACEFactory, createElectroatom_no_elastic )
{
  ...
  FRENSIE_CHECK_FLOATING_EQUALITY( cross_section, 4.8061937878513825e+08-2.100574153670e8, 1e-12 );

  energy = 4.0e-4;
  cross_section = atom->getTotalCrossSection( energy );
  FRENSIE_CHECK_FLOATING_EQUALITY( cross_section, 1.2781289478456964e+09-4.436635458458e8, 1e-12 );

  energy = 9.0e-5;
  cross_section = atom->getTotalCrossSection( energy );
  FRENSIE_CHECK_FLOATING_EQUALITY( cross_section, 2.4116031548838668e+09-8.887469904554e8, 1e-12 );
