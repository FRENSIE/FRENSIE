...
std::shared_ptr<MonteCarlo::CoupledElasticElectroatomicReaction<Utility::LinLin> > coupled_elastic_reaction;

//---------------------------------------------------------------------------//
// Tests
//---------------------------------------------------------------------------//
// Check that the reaction type can be returned
FRENSIE_UNIT_TEST( CoupledElasticElectroatomicReaction, getReactionType )
{
...
FRENSIE_UNIT_TEST( CoupledElasticElectroatomicReaction, getThresholdEnergy )
{
...
FRENSIE_UNIT_TEST( CoupledElasticElectroatomicReaction, getNumberOfEmittedElectrons )
{
...
FRENSIE_UNIT_TEST( CoupledElasticElectroatomicReaction, getNumberOfEmittedPhotons )
{
...
//---------------------------------------------------------------------------//
// Check that the number of photons emitted from the rxn can be returned
FRENSIE_UNIT_TEST( CoupledElasticElectroatomicReaction, getNumberOfEmittedPositrons )
{
...
FRENSIE_UNIT_TEST( CoupledElasticElectroatomicReaction,
                   getCrossSection )
{
...
FRENSIE_UNIT_TEST( CoupledElasticElectroatomicReaction, react )
{
