...
FRENSIE_UNIT_TEST( BremsstrahlungPositronatomicReaction, getReactionType_ace )
{
...
FRENSIE_UNIT_TEST( BremsstrahlungPositronatomicReaction, getThresholdEnergy_ace )
{
...
FRENSIE_UNIT_TEST( BremsstrahlungPositronatomicReaction, getNumberOfEmittedElectrons_ace )
{
...
FRENSIE_UNIT_TEST( BremsstrahlungPositronatomicReaction, getNumberOfEmittedPhotons_ace )
{
...
FRENSIE_UNIT_TEST( BremsstrahlungPositronatomicReaction, getNumberOfEmittedPositrons_ace )
{
...
FRENSIE_UNIT_TEST( BremsstrahlungPositronatomicReaction, getCrossSection_ace )
{
  // 2BS
...
FRENSIE_UNIT_TEST( BremsstrahlungPositronatomicReaction, getDifferentialCrossSection_ace )
{
  // 2BS
...
FRENSIE_UNIT_TEST( BremsstrahlungPositronatomicReaction, react_detailed_2BS_ace )
{
  ...
  FRENSIE_CHECK( bank.top().getZDirection() < 1.0 );
...
FRENSIE_UNIT_TEST( BremsstrahlungPositronatomicReaction, react_basic_ace )
{
  MonteCarlo::PositronState positron( 0 );
  positron.setEnergy( 20 );
  positron.setDirection( 0.0, 0.0, 1.0 );
