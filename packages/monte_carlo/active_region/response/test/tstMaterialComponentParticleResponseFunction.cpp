//---------------------------------------------------------------------------//
//!
//! \file   tstMaterialComponentParticleResponseFunction.cpp
//! \author Alex Robinson
//! \brief  Material component particle response function unit tests
//!
//---------------------------------------------------------------------------//
...
FRENSIE_UNIT_TEST( MaterialComponentParticleResponseFunction,
                   isSpatiallyUniform )
{
  std::shared_ptr<const MonteCarlo::ParticleResponseFunction>
    response_function(
             new MonteCarlo::NeutronMaterialComponentParticleResponseFunction(
  ...
  response_function.reset(
            new MonteCarlo::PhotonMaterialComponentParticleResponseFunction(
  ...
  response_function.reset(
            new MonteCarlo::ElectronMaterialComponentParticleResponseFunction(
  ...
  response_function.reset(
            new MonteCarlo::PositronMaterialComponentParticleResponseFunction(
  ...
  response_function.reset(
        new MonteCarlo::AdjointPhotonMaterialComponentParticleResponseFunction(
  ...
  response_function.reset(
      new MonteCarlo::AdjointElectronMaterialComponentParticleResponseFunction(
...
FRENSIE_UNIT_TEST( MaterialComponentParticleResponseFunction, description )
{
  std::shared_ptr<const MonteCarlo::ParticleResponseFunction>
    response_function(
              new MonteCarlo::NeutronMaterialComponentParticleResponseFunction(
  ...
  FRENSIE_CHECK_LESS( response_function->description().find( "cell_1_mat_component" ),
                      response_function->description().size() );
  FRENSIE_CHECK_LESS( response_function->description().find( "\"H1 @ 293.6K\"" ),
                      response_function->description().size() );
...
FRENSIE_UNIT_TEST( MaterialComponentParticleResponseFunction, evaluate )
{
  std::shared_ptr<const MonteCarlo::ParticleResponseFunction>
    response_function(
              new MonteCarlo::NeutronMaterialComponentParticleResponseFunction(
...
FRENSIE_UNIT_TEST_TEMPLATE_EXPAND( MaterialComponentParticleResponseFunction,
                                   archive_forward,
                                   TestArchives )
{
  ...
  std::string archive_base_name( "test_forward_material_component_particle_response_function" );
...

  {
    ...
    std::shared_ptr<const MonteCarlo::ParticleResponseFunction>
      neutron_response_function( new MonteCarlo::NeutronMaterialComponentParticleResponseFunction(
                                             neutron_material_filled_model,
                                             1,
                                             "H1 @ 293.6K",
                                             MonteCarlo::N__GAMMA_REACTION ) );
                                   ...
                                   TestArchives )
{
  ...
  std::string archive_base_name( "test_adjoint_photon_material_component_particle_response_function" );
  std::ostringstream archive_ostream;
                                   ...
                                   TestArchives )
{
  ...
  std::string archive_base_name( "test_adjoint_electron_material_component_particle_response_function" );
  std::ostringstream archive_ostream;
...
//---------------------------------------------------------------------------//
// end tstMaterialComponentParticleResponseFunction.cpp
//---------------------------------------------------------------------------//
