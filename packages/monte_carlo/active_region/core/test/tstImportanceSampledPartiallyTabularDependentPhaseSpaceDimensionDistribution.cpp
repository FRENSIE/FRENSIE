//---------------------------------------------------------------------------//
//!
//! \file   tstImportanceSampledPartiallyTabularDependentPhaseSpaceDimensionDistribution.cpp
//! \author Alex Robinson
//! \brief  Importance sampled partially-tabular dependent phase space
//!         dimension distribution unit tests
//!
//---------------------------------------------------------------------------//
...
// FRENSIE Includes
#include "MonteCarlo_ImportanceSampledPartiallyTabularDependentPhaseSpaceDimensionDistribution.hpp"
...
std::shared_ptr<const Utility::PartiallyTabularTwoDDistribution>
                     ...
                     Dimension )
{
  std::unique_ptr<const MonteCarlo::PhaseSpaceDimensionDistribution>
    dimension_distribution( new MonteCarlo::ImportanceSampledPartiallyTabularDependentPhaseSpaceDimensionDistribution<ParentDimension,Dimension>(
                                               raw_distribution,
                                               raw_importance_distribution ) );
...
{
  std::unique_ptr<const MonteCarlo::PhaseSpaceDimensionDistribution>
    dimension_distribution( new MonteCarlo::ImportanceSampledPartiallyTabularDependentPhaseSpaceDimensionDistribution<ParentDimension,Dimension>( raw_distribution, raw_importance_distribution ) );
...
//---------------------------------------------------------------------------//
// end tstImportanceSampledPartiallyTabularDependentPhaseSpaceDimensionDistribution.cpp
//---------------------------------------------------------------------------//
