...
template<typename ContributionMultiplierPolicy>
void TetMeshTrackLengthFluxEstimator<ContributionMultiplierPolicy>::setParticleTypes( const std::vector<ParticleType>& particle_types )
{
						       ...
						       std::ostream& os ) const
{
  ...
  std::vector<unsigned long long> num_zero_tets(
                                  this->getNumberOfResponseFunctions(), 0ull );
  std::vector<unsigned long long> num_tets_lte_1pc_re(
                                  this->getNumberOfResponseFunctions(), 0ull );
  std::vector<unsigned long long> num_tets_lte_5pc_re(
                                  this->getNumberOfResponseFunctions(), 0ull );
  std::vector<unsigned long long> num_tets_lte_10pc_re(
                                  this->getNumberOfResponseFunctions(), 0ull );
