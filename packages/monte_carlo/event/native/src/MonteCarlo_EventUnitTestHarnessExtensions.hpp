//---------------------------------------------------------------------------//
//!
//! \file   MonteCarlo_EventUnitTestHarnessExtensions.hpp
//! \author Alex Robinson
//! \brief  Extensions to the Teuchos_UnitTestHarness
//!
//---------------------------------------------------------------------------//

#ifndef MONTE_CARLO_EVENT_UNIT_TEST_HARNESS_EXTENSIONS_HPP
#define MONTE_CARLO_EVENT_UNIT_TEST_HARNESS_EXTENSIONS_HPP

// FRENSIE Includes
#include "Utility_UnitTestHarnessExtensions.hpp"

/*! \brief A macro for the Teuchos Unit Test Harness for creating a
 * templated unit test on a MonteCarlo::PhaseSpaceDimension enum.
...
#endif // end MONTE_CARLO_EVENT_UNIT_TEST_HARNESS_EXTENSIONS_HPP

//---------------------------------------------------------------------------//
// end MonteCarlo_EventUnitTestHarnessExtensions.hpp
//---------------------------------------------------------------------------//
