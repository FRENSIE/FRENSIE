//---------------------------------------------------------------------------//
//!
//! \file   tstObserverEnergyDimensionDiscretization.cpp
//! \author Alex Robinson
//! \brief  Observer energy dimension discretization unit tests
//!
//---------------------------------------------------------------------------//
...
FRENSIE_UNIT_TEST( ObserverEnergyDimensionDiscretization, getDimension )
{
...
FRENSIE_UNIT_TEST( ObserverEnergyDimensionDiscretization,
                   getDimensionName )
{
...
{
  MonteCarlo::ObserverEnergyDimensionDiscretization::BinIndexArray
    bin_indices;
...
{
  MonteCarlo::ObserverEnergyDimensionDiscretization::BinIndexWeightPairArray
...
FRENSIE_UNIT_TEST( ObserverEnergyDimensionDiscretization, print )
{
  std::ostringstream oss;
...
FRENSIE_UNIT_TEST_TEMPLATE_EXPAND( ObserverEnergyDimensionDiscretization,
                                   archive,
                                   TestArchives )
{
  ...
  std::string archive_base_name( "test_observer_energy_dimension_discretization" );
...
{
  MonteCarlo::ObserverEnergyDimensionDiscretization::InputDataType discretization( 4 );
  ...
  dimension_discretization.reset( new MonteCarlo::ObserverEnergyDimensionDiscretization( discretization ) );
  ...
  dimension_discretization_with_line_bins.reset( new MonteCarlo::ObserverEnergyDimensionDiscretization( discretization ) );
}
