//---------------------------------------------------------------------------//
//!
//! \file   tstObserverSourceTimeDimensionDiscretization.cpp
...
FRENSIE_UNIT_TEST( ObserverSourceTimeDimensionDiscretization, getDimension )
{
...
FRENSIE_UNIT_TEST( ObserverSourceTimeDimensionDiscretization,
                   getDimensionName )
{
...
{
  MonteCarlo::ObserverSourceTimeDimensionDiscretization::BinIndexArray
    bin_indices;
...
{
  MonteCarlo::ObserverSourceTimeDimensionDiscretization::BinIndexWeightPairArray
                   ...
                   printBoundariesOfBin )
{
  ...
  FRENSIE_CHECK( oss.str().find( "Source Time Bin:" ) < oss.str().size() );
...
FRENSIE_UNIT_TEST( ObserverSourceTimeDimensionDiscretization, print )
{
  std::ostringstream oss;
...
FRENSIE_UNIT_TEST_TEMPLATE_EXPAND( ObserverSourceTimeDimensionDiscretization,
                                   archive,
                                   TestArchives )
{
  ...
  std::string archive_base_name( "test_observer_source_time_dimension_discretization" );
...
{
  MonteCarlo::ObserverSourceTimeDimensionDiscretization::InputDataType discretization( 4 );
  ...
  dimension_discretization.reset( new MonteCarlo::ObserverSourceTimeDimensionDiscretization( discretization ) );
  ...
  dimension_discretization_with_line_bins.reset( new MonteCarlo::ObserverSourceTimeDimensionDiscretization( discretization ) );
}
