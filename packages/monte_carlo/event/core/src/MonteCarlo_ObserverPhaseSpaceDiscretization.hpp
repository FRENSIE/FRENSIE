...
BOOST_SERIALIZATION_CLASS_VERSION( ObserverPhaseSpaceDiscretization , MonteCarlo, 0 );
BOOST_SERIALIZATION_ASSUME_ABSTRACT_CLASS( ObserverPhaseSpaceDiscretization, MonteCarlo );
