...
std::shared_ptr<MonteCarlo::WeightEnergyAndChargeMultipliedCellCollisionFluxEstimator>
estimator_4;
...
std::shared_ptr<MonteCarlo::WeightEnergyAndChargeMultipliedCellTrackLengthFluxEstimator>
estimator_8;
...
std::shared_ptr<MonteCarlo::WeightEnergyAndChargeMultipliedCellPulseHeightEstimator>
estimator_12;
...
std::shared_ptr<MonteCarlo::WeightEnergyAndChargeMultipliedSurfaceFluxEstimator>
estimator_16;
...
std::shared_ptr<MonteCarlo::WeightEnergyAndChargeMultipliedSurfaceCurrentEstimator>
estimator_20;
...
std::shared_ptr<MonteCarlo::WeightEnergyAndChargeMultipliedMeshTrackLengthFluxEstimator>
mesh_estimator_4;
...
FRENSIE_UNIT_TEST( EventHandler, addEstimator )
{
  ...
  FRENSIE_REQUIRE_NO_THROW( event_handler.addEstimator( estimator_16 ) );
  FRENSIE_CHECK( event_handler.doesEstimatorExist( estimator_16->getId() ) );
  FRENSIE_CHECK_EQUAL( event_handler.getNumberOfEstimators(), 16 );

  FRENSIE_REQUIRE_NO_THROW( event_handler.addEstimator( estimator_17 ) );
  FRENSIE_CHECK( event_handler.doesEstimatorExist( estimator_17->getId() ) );
  FRENSIE_CHECK_EQUAL( event_handler.getNumberOfEstimators(), 17 );

  FRENSIE_REQUIRE_NO_THROW( event_handler.addEstimator( estimator_18 ) );
  FRENSIE_CHECK( event_handler.doesEstimatorExist( estimator_18->getId() ) );
  FRENSIE_CHECK_EQUAL( event_handler.getNumberOfEstimators(), 18 );

  FRENSIE_REQUIRE_NO_THROW( event_handler.addEstimator( estimator_19 ) );
  FRENSIE_CHECK( event_handler.doesEstimatorExist( estimator_19->getId() ) );
  FRENSIE_CHECK_EQUAL( event_handler.getNumberOfEstimators(), 19 );

  FRENSIE_REQUIRE_NO_THROW( event_handler.addEstimator( estimator_20 ) );
  FRENSIE_CHECK( event_handler.doesEstimatorExist( estimator_20->getId() ) );
  FRENSIE_CHECK_EQUAL( event_handler.getNumberOfEstimators(), 20 );
  ...
  FRENSIE_CHECK_EQUAL( event_handler.getNumberOfEstimators(), 21 );
  ...
  FRENSIE_CHECK_EQUAL( event_handler.getNumberOfEstimators(), 22 );
  ...
  FRENSIE_CHECK_EQUAL( event_handler.getNumberOfEstimators(), 23 );

  FRENSIE_REQUIRE_NO_THROW( event_handler.addEstimator( mesh_estimator_4 ) );
  FRENSIE_CHECK( event_handler.doesEstimatorExist( mesh_estimator_4->getId() ) );
  FRENSIE_CHECK_EQUAL( event_handler.getNumberOfEstimators(), 24 );
...
FRENSIE_UNIT_TEST( EventHandler, getEstimator )
{
  ...
  event_handler.addEstimator( estimator_16 );

  {
    const MonteCarlo::Estimator& estimator =
      event_handler.getEstimator( estimator_16->getId() );

    FRENSIE_CHECK( &estimator == estimator_16.get() );
  }

  event_handler.addEstimator( estimator_17 );

  {
    const MonteCarlo::Estimator& estimator =
      event_handler.getEstimator( estimator_17->getId() );

    FRENSIE_CHECK( &estimator == estimator_17.get() );
  }

  event_handler.addEstimator( estimator_18 );

  {
    const MonteCarlo::Estimator& estimator =
      event_handler.getEstimator( estimator_18->getId() );

    FRENSIE_CHECK( &estimator == estimator_18.get() );
  }

  event_handler.addEstimator( estimator_19 );

  {
    const MonteCarlo::Estimator& estimator =
      event_handler.getEstimator( estimator_19->getId() );

    FRENSIE_CHECK( &estimator == estimator_19.get() );
  }
  ...
  {
    const MonteCarlo::Estimator& estimator =
      event_handler.getEstimator( estimator_20->getId() );

    FRENSIE_CHECK( &estimator == estimator_20.get() );
  }
  ...
  event_handler.addEstimator( mesh_estimator_4 );

  {
    const MonteCarlo::Estimator& estimator =
      event_handler.getEstimator( mesh_estimator_4->getId() );

    FRENSIE_CHECK( &estimator == mesh_estimator_4.get() );
  }
...
FRENSIE_UNIT_TEST( EventHandler, get_dispatcher )
{
  ...
  event_handler.addEstimator( estimator_18 );
  event_handler.addEstimator( estimator_19 );
  event_handler.addEstimator( estimator_20 );
  event_handler.addEstimator( mesh_estimator_1 );
  event_handler.addEstimator( mesh_estimator_2 );
  event_handler.addEstimator( mesh_estimator_3 );
  event_handler.addEstimator( mesh_estimator_4 );
                   ...
                   updateObserversFromParticleCollidingInCellEvent )
{
...

  {
    ...
    FRENSIE_CHECK( !estimator_16->hasUncommittedHistoryContribution() );
    FRENSIE_CHECK( !estimator_17->hasUncommittedHistoryContribution() );
    FRENSIE_CHECK( !estimator_18->hasUncommittedHistoryContribution() );
    FRENSIE_CHECK( !estimator_19->hasUncommittedHistoryContribution() );
    FRENSIE_CHECK( !estimator_20->hasUncommittedHistoryContribution() );
    ...
    FRENSIE_CHECK( !mesh_estimator_4->hasUncommittedHistoryContribution() );
                   ...
                   updateObserversFromParticleCrossingSurfaceEvent )
{
...

  {
    ...
    first_moments = estimator_17->getEntityBinDataFirstMoments( 1 );
    second_moments = estimator_17->getEntityBinDataSecondMoments( 1 );

    FRENSIE_CHECK_EQUAL( first_moments, std::vector<double>( {1.0} ) );
    FRENSIE_CHECK_EQUAL( second_moments, std::vector<double>( {1.0} ) );

    first_moments = estimator_17->getEntityBinDataFirstMoments( 2 );
    second_moments = estimator_17->getEntityBinDataSecondMoments( 2 );

    FRENSIE_CHECK_EQUAL( first_moments, std::vector<double>( {0.0} ) );
    FRENSIE_CHECK_EQUAL( second_moments, std::vector<double>( {0.0} ) );

    first_moments = estimator_18->getEntityBinDataFirstMoments( 1 );
    second_moments = estimator_18->getEntityBinDataSecondMoments( 1 );

    FRENSIE_CHECK_EQUAL( first_moments, std::vector<double>( {1.0} ) );
    FRENSIE_CHECK_EQUAL( second_moments, std::vector<double>( {1.0} ) );

    first_moments = estimator_18->getEntityBinDataFirstMoments( 2 );
    second_moments = estimator_18->getEntityBinDataSecondMoments( 2 );
...
FRENSIE_UNIT_TEST( EventHandler, update_parallel )
{
  ...
  #pragma omp parallel num_threads( threads )
  {
    ...
    MonteCarlo::PhotonState photon( (comm->size()+comm->rank())*threads + Utility::OpenMPProperties::getThreadId() );
    photon.setWeight( 1.0 );
    photon.setEnergy( 2.0 );
    photon.setDirection( 1.0, 0.0, 0.0 );
    photon.embedInModel( local_model );

    MonteCarlo::ElectronState electron( (comm->size()+comm->rank())*threads + Utility::OpenMPProperties::getThreadId() );
    electron.setWeight( 1.0 );
    electron.setEnergy( 2.0 );
    electron.setDirection( -1.0, 0.0, 0.0 );
    electron.embedInModel( local_model );
  ...
  if( comm->rank() == 0 )
  {
    FRENSIE_CHECK_EQUAL( event_handler.getNumberOfCommittedHistories(), 2*comm->size()*threads );
    ...
    FRENSIE_CHECK_EQUAL( first_moments, std::vector<double>( {2.0*comm->size()*threads} ) );
    FRENSIE_CHECK_EQUAL( second_moments, std::vector<double>( {2.0*comm->size()*threads} ) );
    ...
    for( size_t i = comm->size()*threads; i < 2*comm->size()*threads; ++i )
    {
      FRENSIE_REQUIRE( history_map.find( i ) != history_map.end() );
      FRENSIE_REQUIRE( history_map[i].find( MonteCarlo::PHOTON ) !=
                       history_map[i].end() );
...
FRENSIE_UNIT_TEST_TEMPLATE_EXPAND( EventHandler, archive, TestArchives )
{
  ...
  if( comm->rank() == 0 )
  {
    ...
    std::shared_ptr<MonteCarlo::WeightMultipliedCellTrackLengthFluxEstimator>
      local_estimator_6( new MonteCarlo::WeightMultipliedCellTrackLengthFluxEstimator(
                                              103, 1.0, {1, 2}, {1.0, 1.0} ) );

    local_estimator_6->setParticleTypes( std::set<MonteCarlo::ParticleType>( {MonteCarlo::ELECTRON} ) );

    std::shared_ptr<MonteCarlo::WeightMultipliedCellPulseHeightEstimator>
      local_estimator_9( new MonteCarlo::WeightMultipliedCellPulseHeightEstimator(
                                                          104, 1.0, {1, 2} ) );

    local_estimator_9->setParticleTypes( std::set<MonteCarlo::ParticleType>( {MonteCarlo::PHOTON, MonteCarlo::ELECTRON} ) );

    std::shared_ptr<MonteCarlo::WeightAndEnergyMultipliedCellPulseHeightEstimator>
      local_estimator_10( new MonteCarlo::WeightAndEnergyMultipliedCellPulseHeightEstimator(
                                                          105, 1.0, {1, 2} ) );

    local_estimator_10->setParticleTypes( std::set<MonteCarlo::ParticleType>( {MonteCarlo::PHOTON, MonteCarlo::ELECTRON} ) );

    std::shared_ptr<MonteCarlo::WeightMultipliedSurfaceFluxEstimator>
      local_estimator_13( new MonteCarlo::WeightMultipliedSurfaceFluxEstimator(
                                              106, 1.0, {1, 2}, {1.0, 1.0} ) );

    local_estimator_13->setParticleTypes( std::set<MonteCarlo::ParticleType>( {MonteCarlo::PHOTON} ) );

    std::shared_ptr<MonteCarlo::WeightAndEnergyMultipliedSurfaceFluxEstimator>
      local_estimator_14( new MonteCarlo::WeightAndEnergyMultipliedSurfaceFluxEstimator(
                                              107, 1.0, {1, 2}, {1.0, 1.0} ) );

    local_estimator_14->setParticleTypes( std::set<MonteCarlo::ParticleType>( {MonteCarlo::ELECTRON} ) );

    std::shared_ptr<MonteCarlo::WeightMultipliedSurfaceCurrentEstimator>
      local_estimator_17( new MonteCarlo::WeightMultipliedSurfaceCurrentEstimator(
                                                          108, 1.0, {1, 2} ) );

    local_estimator_17->setParticleTypes( std::set<MonteCarlo::ParticleType>( {MonteCarlo::PHOTON} ) );

    std::shared_ptr<MonteCarlo::WeightAndEnergyMultipliedSurfaceCurrentEstimator>
      local_estimator_18( new MonteCarlo::WeightAndEnergyMultipliedSurfaceCurrentEstimator(
                                                          109, 1.0, {1, 2} ) );

    local_estimator_18->setParticleTypes( std::set<MonteCarlo::ParticleType>( {MonteCarlo::ELECTRON} ) );
    ...
    event_handler.addEstimator( local_estimator_17 );
    event_handler.addEstimator( local_estimator_18 );
...
FRENSIE_CUSTOM_UNIT_TEST_INIT()
{
  ...
  estimator_5.reset( new MonteCarlo::WeightMultipliedCellTrackLengthFluxEstimator(
                                                              2,
                                                              1.0,
                                                              cell_ids,
                                                              cell_volumes ) );
  estimator_5->setParticleTypes( std::set<MonteCarlo::ParticleType>( {MonteCarlo::PHOTON} ) );

  estimator_6.reset( new MonteCarlo::WeightAndEnergyMultipliedCellTrackLengthFluxEstimator(
                                                              3,
                                                              10.0,
                                                              cell_ids,
                                                              cell_volumes ) );
  ...
  estimator_9.reset( new MonteCarlo::WeightMultipliedCellPulseHeightEstimator(
                                                              4,
                                                              1.0,
                                                              cell_ids ) );
  estimator_9->setParticleTypes( std::set<MonteCarlo::ParticleType>( {MonteCarlo::PHOTON, MonteCarlo::ELECTRON} ) );

  estimator_10.reset( new MonteCarlo::WeightAndEnergyMultipliedCellPulseHeightEstimator(
                                                              5,
                                                              10.0,
                                                              cell_ids ) );
  estimator_10->setParticleTypes( std::set<MonteCarlo::ParticleType>( {MonteCarlo::PHOTON, MonteCarlo::ELECTRON} ) );

  estimator_13.reset( new MonteCarlo::WeightMultipliedSurfaceFluxEstimator(
                                                             6,
                                                             1.0,
                                                             surface_ids,
                                                             surface_areas ) );
  ...
  estimator_14.reset( new MonteCarlo::WeightAndEnergyMultipliedSurfaceFluxEstimator(
                                                             7,
                                                             10.0,
                                                             surface_ids,
                                                             surface_areas ) );
  ...
  estimator_17.reset( new MonteCarlo::WeightMultipliedSurfaceCurrentEstimator(
                                                               8,
                                                               1.0,
                                                               surface_ids ) );
  estimator_17->setParticleTypes( std::set<MonteCarlo::ParticleType>( {MonteCarlo::PHOTON} ) );

  estimator_18.reset( new MonteCarlo::WeightAndEnergyMultipliedSurfaceCurrentEstimator(
                                                               9,
                                                               10.0,
                                                               surface_ids ) );
  estimator_18->setParticleTypes( std::set<MonteCarlo::ParticleType>( {MonteCarlo::ELECTRON} ) );
