...
FRENSIE_UNIT_TEST( ParticleEnteringCellEventDispatcher, getLocalDispatcher )
{
                   ...
                   dispatchParticleEnteringCellEvent )
{
...

  {
    ...
    dispatcher->dispatchParticleEnteringCellEvent( photon, 0 );
    ...
    dispatcher->dispatchParticleEnteringCellEvent( electron, 0 );
...

  {
    ...
    dispatcher->dispatchParticleEnteringCellEvent( photon, 1 );
    ...
    dispatcher->dispatchParticleEnteringCellEvent( electron, 1 );
                                   ...
                                   TestArchives )
{
  ...
  std::string archive_base_name( "test_particle_entering_cell_event_dispatcher" );
