...
FRENSIE_UNIT_TEST( ParticleCollidingInCellEventDispatcher, getEntityId )
{
  std::shared_ptr<MonteCarlo::ParticleCollidingInCellEventLocalDispatcher>
    dispatcher_0( new MonteCarlo::ParticleCollidingInCellEventLocalDispatcher( 0 ) );

  std::shared_ptr<MonteCarlo::ParticleCollidingInCellEventLocalDispatcher>
    dispatcher_1( new MonteCarlo::ParticleCollidingInCellEventLocalDispatcher( 1 ) );
...
FRENSIE_UNIT_TEST( ParticleCollidingInCellEventDispatcher,
		   manage_observers )
{
  std::shared_ptr<MonteCarlo::ParticleCollidingInCellEventLocalDispatcher>
    dispatcher_0( new MonteCarlo::ParticleCollidingInCellEventLocalDispatcher( 0 ) );
		   ...
		   dispatchParticleCollidingInCellEvent )
{
...

  {
    ...
    dispatcher_0->dispatchParticleCollidingInCellEvent( photon, 0, 1.0 );
    ...
    dispatcher_0->dispatchParticleCollidingInCellEvent( electron, 0, 1.0 );
...

  {
    ...
    dispatcher_1->dispatchParticleCollidingInCellEvent( photon, 1, 1.0 );
    ...
    dispatcher_1->dispatchParticleCollidingInCellEvent( electron, 1, 1.0 );
...
FRENSIE_UNIT_TEST_TEMPLATE_EXPAND( ParticleCollidingInCellEventLocalDispatcher,
                                   archive,
                                   TestArchives )
{
  ...
  std::string archive_base_name( "test_particle_colliding_in_cell_event_local_dispatcher" );
...

  {
...

    {
      ...
      local_estimator_1.reset( new MonteCarlo::WeightMultipliedCellCollisionFluxEstimator(
                                                              10,
                                                              1.0,
                                                              cell_ids,
                                                              cell_volumes ) );
      ...
      local_estimator_2.reset( new MonteCarlo::WeightAndEnergyMultipliedCellCollisionFluxEstimator(
                                                              11,
                                                              10.0,
                                                              cell_ids,
                                                              cell_volumes ) );
      ...
      local_estimator_3.reset( new MonteCarlo::WeightAndChargeMultipliedCellCollisionFluxEstimator(
                                                              12,
                                                              1.0,
                                                              cell_ids,
                                                              cell_volumes ) );
