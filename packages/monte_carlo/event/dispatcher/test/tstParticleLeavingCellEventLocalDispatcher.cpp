//---------------------------------------------------------------------------//
//!
//! \file   tstParticleLeavingCellEventLocalDispatcher.cpp
//! \author Alex Robinson
//! \brief  Particle leaving cell event local dispatcher unit tests
//!
//---------------------------------------------------------------------------//
...
FRENSIE_UNIT_TEST( ParticleLeavingCellEventDispatcher, getEntityId )
{
  std::shared_ptr<MonteCarlo::ParticleLeavingCellEventLocalDispatcher>
    dispatcher_0( new MonteCarlo::ParticleLeavingCellEventLocalDispatcher( 0 ) );

  std::shared_ptr<MonteCarlo::ParticleLeavingCellEventLocalDispatcher>
    dispatcher_1( new MonteCarlo::ParticleLeavingCellEventLocalDispatcher( 1 ) );
                   ...
                   dispatchParticleLeavingCellEvent )
{
...

  {
    ...
    dispatcher_0->dispatchParticleLeavingCellEvent( photon, 0 );
    ...
    dispatcher_0->dispatchParticleLeavingCellEvent( electron, 0 );
...

  {
    ...
    dispatcher_1->dispatchParticleLeavingCellEvent( photon, 1 );
    ...
    dispatcher_1->dispatchParticleLeavingCellEvent( electron, 1 );
                                   ...
                                   TestArchives )
{
  ...
  std::string archive_base_name( "test_particle_leaving_cell_event_local_dispatcher" );
  ...
  {
    FRENSIE_CHECK_EQUAL( dispatcher_0->getEntityId(), 0 );
    FRENSIE_CHECK_EQUAL( dispatcher_0->getNumberOfObservers( MonteCarlo::PHOTON ), 3 );
    FRENSIE_CHECK_EQUAL( dispatcher_0->getNumberOfObservers( MonteCarlo::ELECTRON ), 3 );
    FRENSIE_CHECK_EQUAL( dispatcher_0->getNumberOfObservers( MonteCarlo::POSITRON ), 3 );
...
//---------------------------------------------------------------------------//
// end tstParticleLeavingCellEventLocalDispatcher.cpp
//---------------------------------------------------------------------------//
