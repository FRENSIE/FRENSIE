...
TEUCHOS_UNIT_TEST( StandardDagMCCellHandler, constructor )
{
  TEST_NOTHROW( cell_handler.reset( new Geometry::StandardDagMCCellHandler( 
                                                 moab::DagMC::instance() ) ) );
}

//---------------------------------------------------------------------------//
// Check that the number of cells can be returned
TEUCHOS_UNIT_TEST( StandardDagMCCellHandler, getNumberOfCells )
{
...
TEUCHOS_UNIT_TEST( StandardDagMCCellHandler, doesCellExist )
{
...
TEUCHOS_UNIT_TEST( StandardDagMCCellHandler, doesCellHandleExist )
{
...
TEUCHOS_UNIT_TEST( StandardDagMCCellHandler, getCellId )
{
...
TEUCHOS_UNIT_TEST( StandardDagMCCellHandler, getCellHandle )
{
