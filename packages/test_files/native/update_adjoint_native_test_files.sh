...
aepr_generator --forward_file=test_epr_1_native.xml --min_photon_energy=1e-3 --max_photon_energy=20.0 --min_electron_energy=1e-5 --max_electron_energy=20 --adjoint_pp_edist_eval_tol=1e-3 --adjoint_pp_edist_nudge_val=1e-6 --adjoint_tp_edist_eval_tol=1e-3 --adjoint_tp_edist_nudge_val=1e-6 --adjoint_incoherent_max_e_nudge_val=0.2 --adjoint_incoherent_e_to_max_e_nudge_val=1e-5 --adjoint_incoherent_eval_tol=1e-2 --adjoint_incoherent_grid_convergence_tol=0.5 --adjoint_incoherent_grid_absolute_diff_tol=1e-42 --adjoint_incoherent_grid_dist_tol=1e-16 --cutoff_angle_cosine=0.9 --number_of_moment_preserving_angles=2 --electron_tabular_evaluation_tol=1e-5 --electron_interp_policy="Log-Log-Log" --electron_sampling_policy="Unit-base Correlated" --adjoint_electron_grid_convergence_tol=1e-2 --adjoint_electron_grid_absolute_diff_tol=1e-16 --adjoint_electron_dist_tol=1e-9 --adjoint_bremsstrahlung_max_e_nudge_val=0.2 --adjoint_bremsstrahlung_e_to_outgoing_e_nudge_val=2e-7 --adjoint_bremsstrahlung_eval_tol=1e-3 --adjoint_bremsstrahlung_grid_convergence_tol=0.5 --adjoint_bremsstrahlung_grid_absolute_diff_tol=1e-16 --adjoint_bremsstrahlung_dist_tol=1e-9 --adjoint_electroionization_eval_tol=1e-3 --adjoint_electroionization_grid_convergence_tol=0.5 --adjoint_electroionization_grid_absolute_diff_tol=1e-16 --adjoint_electroionization_dist_tol=1e-9 --grid_convergence_tol=1e-3 --grid_absolute_diff_tol=1e-42 --grid_absolute_dist_tol=1e-16 --notes="$notes"
if [ $? -eq 0 ]
then
