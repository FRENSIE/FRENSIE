...
// interface
//---------------------------------------------------------------------------//
%define %model_interface_setup_helper( GENERATOR )
...
//---------------------------------------------------------------------------//
%model_interface_setup_helper( ElectronPhotonRelaxationDataGenerator )

%include "DataGen_ElectronPhotonRelaxationDataGenerator.hpp"

//---------------------------------------------------------------------------//
// Add support for the ENDLElectronPhotonRelaxationDataGenerator base class
//---------------------------------------------------------------------------//
%model_interface_setup_helper( ENDLElectronPhotonRelaxationDataGenerator )

%include "DataGen_ENDLElectronPhotonRelaxationDataGenerator.hpp"

//---------------------------------------------------------------------------//
// Add support for the ACEAndENDLElectronPhotonRelaxationDataGenerator base
// class
//---------------------------------------------------------------------------//
%model_interface_setup_helper( ACEAndENDLElectronPhotonRelaxationDataGenerator )
