...
%template(createCoupledElasticReaction_LogLogCorrelated) createCoupledElasticReaction<Utility::LogLogCosLog<true>, Utility::Correlated>;
...
%template(createCoupledElasticReaction_LogLogDirect) createCoupledElasticReaction<Utility::LogLogCosLog<true>, Utility::Direct>;
...
%template(createDecoupledElasticReaction_LogLogCorrelated) createDecoupledElasticReaction<Utility::LogLogCosLog<false>, Utility::Correlated>;
...
%template(createDecoupledElasticReaction_LogLogDirect) createDecoupledElasticReaction<Utility::LogLogCosLog<false>, Utility::Direct>;
