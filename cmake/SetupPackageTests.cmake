...
MACRO(FRENSIE_ADD_TEST_EXECUTABLE TEST_NAME_ROOT)
  ...
  SET(oneValueArgs)
  SET(multiValueArgs DEPENDS LIB_DEPENDS)
...
MACRO(FRENSIE_ADD_TEST TEST_NAME_ROOT)
  SET(options VERBOSE_TEST_OUTPUT)
  SET(oneValueArgs TEST_EXEC_NAME_ROOT MPI_PROCS)
  SET(multiValueArgs EXTRA_ARGS EXTRA_LABELS)
  ...
  ELSE()
    ...
    SET(TEST_PREAMBLE ${MPIEXEC} -n ${FRENSIE_ADD_TEST_MPI_PROCS})
