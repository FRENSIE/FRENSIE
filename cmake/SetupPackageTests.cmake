...
MACRO(FRENSIE_ADD_TEST TEST_NAME_ROOT)
  ...
  IF(NUM_UNAVAILABLE_ACE_LIB_DEPENDS EQUAL "0")
    ...
    IF(NOT "${FRENSIE_ADD_TEST_ACE_LIB_DEPENDS}" STREQUAL "")
      FOREACH(ACE_LIB_DEPEND ${FRENSIE_ADD_TEST_ACE_LIB_DEPENDS})
        GET_ACE_LIBRARY_FILE_PATH(${ACE_LIB_DEPEND} ACE_LIB_FILE_PATH)
        GET_ACE_LIBRARY_FILE_START_LINE(${ACE_LIB_DEPEND} ACE_LIB_FILE_START_LINE)
        STRING(REPLACE "${ACE_LIB_DEPEND}:filepath" "${ACE_LIB_FILE_PATH}" FRENSIE_ADD_TEST_EXTRA_ARGS "${FRENSIE_ADD_TEST_EXTRA_ARGS}")
        STRING(REPLACE "${ACE_LIB_DEPEND}:filestartline" "${ACE_LIB_FILE_START_LINE}" FRENSIE_ADD_TEST_EXTRA_ARGS "${FRENSIE_ADD_TEST_EXTRA_ARGS}")
      ENDFOREACH()
    ENDIF()
