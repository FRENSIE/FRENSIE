MACRO(FRENSIE_PROCESS_ROOT_GEOM FILE_NAME_BASE)
  ...
  # Get the index of this file name
  IF(NOT DEFINED FRENSIE_PROCESS_ROOT_GEOM_${FILE_NAME_BASE}_INDEX)
    SET(FRENSIE_PROCESS_ROOT_GEOM_${FILE_NAME_BASE}_INDEX 0)
  ELSE()
    MATH(EXPR FRENSIE_PROCESS_ROOT_GEOM_${FILE_NAME_BASE}_INDEX "${FRENSIE_PROCESS_ROOT_GEOM_${FILE_NAME_BASE}_INDEX}+1")
  ENDIF()

  SET(LOCAL_INDEX ${FRENSIE_PROCESS_ROOT_GEOM_${FILE_NAME_BASE}_INDEX})

  # This file needs to be processed
  IF((NOT DEFINED FRENSIE_PROCESS_ROOT_GEOM_${FILE_NAME_BASE}_${LOCAL_INDEX}_PROCESSED) OR (NOT ${FRENSIE_PROCESS_ROOT_GEOM_${FILE_NAME_BASE}_${LOCAL_INDEX}_PROCESSED}))
    ...
    SET(FRENSIE_PROCESS_ROOT_GEOM_${FILE_NAME_BASE}_${LOCAL_INDEX}_PROCESSED "ON"
