...
#ifndef CROSS_SECTION_BASED_PHOTON_PRODUCTION_REACTION
#define CROSS_SECTION_BASED_PHOTON_PRODUCTION_REACTION
...
#endif // end CROSS_SECTION_BASED_PHOTON_PRODUCTION_REACTION

//---------------------------------------------------------------------------//
// end CrossSectionBasedPhotonProductionReaction.hpp
//---------------------------------------------------------------------------//
