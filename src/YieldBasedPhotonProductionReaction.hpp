//---------------------------------------------------------------------------//
//!
//! \file   YieldBasePhotonProductionReaction.hpp
//! \author Alex Robinson
//! \brief  The photon production reaction with yield data declaration
//!
//---------------------------------------------------------------------------//

#ifndef YIELD_BASED_PHOTON_PRODUCTION_REACTION_HPP
#define YIELD_BASED_PHOTON_PRODUCTION_REACTION_HPP

// Trilinos Includes
#include <Teuchos_Array.hpp>

// FACEMC Includes
#include "PhotonProductionReaction.hpp"
...
#endif // end YIELD_BASED_PHOTON_PRODUCTION_REACTION_HPP

//---------------------------------------------------------------------------//
// end YieldBasedPhotonProductionReaction.hpp
//---------------------------------------------------------------------------//
