...
#ifndef SERIAL_DENSE_MATRIX_EXTENSION_DEF_HPP
#define SERIAL_DENSE_MATRIX_EXTENSION_DEF_HPP
...
#endif // end SERIAL_DENSE_MATRIX_EXTENSION_DEF_HPP

//---------------------------------------------------------------------------//
// end SerialDenseMatrixExtension_def.hpp
//---------------------------------------------------------------------------//
