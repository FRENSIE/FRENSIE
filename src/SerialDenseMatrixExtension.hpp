//---------------------------------------------------------------------------//
//!
//! \file   SerialDenseMatrixExtension.hpp
//! \author Alex Robinson
//! \brief  Matrix base class decl that extends the Teuchos serial dense matrix
//!
//---------------------------------------------------------------------------//

#ifndef SERIAL_DENSE_MATRIX_EXTENSION_HPP
#define SERIAL_DENSE_MATRIX_EXTENSION_HPP
...
#include "SerialDenseMatrixExtension_def.hpp"

//---------------------------------------------------------------------------//

#endif // end SERIAL_DENSE_MATRIX_EXTENSION_HPP

//---------------------------------------------------------------------------//
// end SerialDenseMatrixExtension.hpp
//---------------------------------------------------------------------------//
