//---------------------------------------------------------------------------//
//!
//! \file   CellBoundingBox_def.hpp
//! \author Alex Robinson
//! \brief  Cell bounding box class definition
//!
//---------------------------------------------------------------------------//

#ifndef CELL_BOUNDING_BOX_DEF_HPP
#define CELL_BOUNDING_BOX_DEF_HPP
...
#endif // end CELL_BOUNDING_BOX_DEF_HPP

//---------------------------------------------------------------------------//
// end CellBoundingBox_def.hpp
//---------------------------------------------------------------------------//
