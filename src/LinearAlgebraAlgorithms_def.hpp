//---------------------------------------------------------------------------//
//!
//! \file   LinearAlgebraAlgorithms_def.hpp
//! \author Alex Robinson
//! \brief  A collection of linear algebra algorithm definitions.
//!
//---------------------------------------------------------------------------//

#ifndef LINEAR_ALGEBRA_ALGORITHMS_DEF_HPP
#define LINEAR_ALGEBRA_ALGORITHMS_DEF_HPP
...
#endif // end LINEAR_ALGEBRA_ALGORITHMS_DEF_HPP

//---------------------------------------------------------------------------//
// end LinearAlgebraAlgorithms_def.hpp
//---------------------------------------------------------------------------//
