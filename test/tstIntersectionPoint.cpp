...
TEUCHOS_UNIT_TEST_TEMPLATE_2_DECL( IntersectionPoint,
				   ...
				   ScalarType )
{
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_a( 0.0, 0.0, 0.0,
							     0, 1, 2 );
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_a_copy( point_a );
				   ...
				   ScalarType )
{
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_a( 0.0, 0.0, 0.0,
							     0, 1, 2 );
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_b( 0.0, 0.0, 0.0,
							     3, 4, 5 );
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_c( 1.0, 1.0, 1.0,
							     4, 5, 6 );
...
TEUCHOS_UNIT_TEST_TEMPLATE_2_DECL( IntersectionPoint,
				   ...
				   ScalarType )
{
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_a( 0.0, 1.0, 2.0,
							     0, 1, 2 );
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_b( 3.0, 4.0, 5.0,
							     3, 4, 5 );
				   ...
				   ScalarType )
{
  ...
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> test_point( 0.0, 1.0, 0.0,
								1, 2, 3 );
...
TEUCHOS_UNIT_TEST_TEMPLATE_2_DECL( IntersectionPoint,
				   ...
				   ScalarType )
{
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> test_point( 0.0, 1.0, 2.0,
								1, 2, 3 );

  FACEMC::Vector<ScalarType> test_point_coords( test_point.getRawPoint() );

  FACEMC::Vector<ScalarType> ref_coords( 0.0, 1.0, 2.0 );
...
TEUCHOS_UNIT_TEST_TEMPLATE_2_DECL( IntersectionPoint,
				   ...
				   ScalarType )
{
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> 
    normal_point( 0.0, 1.0, 2.0,
		  1, 2, 3 );

  FACEMC::IntersectionPoint<OrdinalType,ScalarType> star_point( 0.0, 1.0, 2.0,
								1, 2, 3,
								true );

  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point( 0.0, 1.0, 2.0,
							   1, 2, 3 );
				   ...
				   ScalarType )
{
  ...
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_b( 1.0, 0.0, 0.0,
							     1, 4, 5 );

  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_c( 0.0, 1.0, 0.0,
							     6, 2, 3 );
				   ...
				   ScalarType )
{
  ...
  Teuchos::RCP<FACEMC::Cell<unsigned,OrdinalType,ScalarType> > cell_ptr;
  createConcavePolyhedronOnOrigin( cell_ptr );

  // Create all corners of the cell
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_1( 2.0, 4.0, 2.0,
							     1, 3, 5 );
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_2( 2.0, 0.0, 0.0,
							     1, 5, 6 );
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_3( 2.0, -4.0, 2.0,
							     1, 4, 6 );
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_4( 2.0, -4.0, -1.0,
							     1, 4, 7 );
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_5( 2.0, 4.0, -1.0,
							     1, 3, 7 );
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_6( -2.0, 4.0, 2.0,
							     2, 3, 5 );
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_7( -2.0, 0.0, 0.0,
							     2, 5, 6 );
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_8( -2.0, -4.0, 2.0,
							     2, 4, 6 );
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_9( -2.0, -4.0, -1.0,
							     2, 4, 7 );
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_10( -2.0, 4.0, -1.0,
							      2, 3, 5 );

  // Create all of the fictitious corners not on the cell
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_11( 2.0, 4.0, -2.0,
							      1, 3, 6 );
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_12( -2.0, 4.0, -2.0,
							      2, 3, 6 );
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_13( 2.0, -4.0, -2.0,
							      1, 4, 5 );
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_14( -2.0, -4.0, -2.0,
							      2, 4, 5 );
  
  // Create all of the fictitious corners on the cell
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_15( 2.0, 2.0, -1.0,
							      1, 6, 7 );
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_16( -2.0, 2.0, -1.0,
							      2, 6, 7 );
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_17( 2.0, -2.0, -1.0,
							      1, 5, 7 );
  FACEMC::IntersectionPoint<OrdinalType,ScalarType> point_18( -2.0, -2.0, -1.0,
							      2, 5, 7 );
