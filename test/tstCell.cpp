				   ...
				   SurfaceMap )
{
  ...
  FACEMC::Vector<ScalarType> point_2( 10.0, 10.0, 10.0 );
  // Points on cell
  FACEMC::Vector<ScalarType> point_3( 1.0, 0.0, 0.0 );
  FACEMC::Vector<ScalarType> point_4( -1.0, 0.0, 0.0 );
  FACEMC::Vector<ScalarType> point_5( 0.0, 1.0, 0.0 );
  FACEMC::Vector<ScalarType> point_6( 0.0, -1.0, 0.0 );
  FACEMC::Vector<ScalarType> point_7( 0.0, 0.0, 1.0 );
  FACEMC::Vector<ScalarType> point_8( 0.0, 0.0, -1.0 );
