 ...
 * objects commonly used by FACEMC to be tested more easily. 
 */
 ...
 * 
 * This macro allows tuples (FACEMC::Pair, FACEMC::Trip and FACEMC::Quad),
 ...
 *
 * This macro allows arrays of tuples (FACEMC::Pair, FACEMC::Trip and
 * FACEMC::Quad), which are not supported by the standard Teuchos Unit Test
