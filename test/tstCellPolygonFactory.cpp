...
class TestCellPolygonFactory : public FACEMC::CellPolygonFactory<Cell>
{
public:
  TestCellPolygonFactory( const Teuchos::RCP<Cell> &cell_ptr )
    : FACEMC::CellPolygonFactory<Cell>( cell_ptr )
  { /* ... */ }

  virtual ~TestCellPolygonFactory()
  { /* ... */ }

  using FACEMC::CellPolygonFactory<Cell>::initializePolygonCorners;
  using FACEMC::CellPolygonFactory<Cell>::cornerTripletNeedsReversing;
  using FACEMC::CellPolygonFactory<Cell>::allPointsOnSamePlane;
  using FACEMC::CellPolygonFactory<Cell>::getPlaneOfPolygonId;
  using FACEMC::CellPolygonFactory<Cell>::getLexicographicallyLargestPoint;
  using FACEMC::CellPolygonFactory<Cell>::getNextPolygonCorner;
};
...
TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL( CellPolygonFactory,
				   ...
				   ScalarType )
{
  typedef FACEMC::Cell<CellOrdinalType,OrdinalType,ScalarType> Cell;
  typedef TestCellPolygonFactory<Cell> CellPolygonFactory;
  typedef FACEMC::IntersectionPoint<OrdinalType,ScalarType> IntersectionPoint;
				   ...
				   ScalarType )
{
  ...
  FACEMC::Vector<ScalarType> polygon_1_largest_corner = 
    largest_corner->getRawPoint();

  largest_corner = 
    CellPolygonFactory::getLexicographicallyLargestPoint( polygon_2_corners );
  FACEMC::Vector<ScalarType> polygon_2_largest_corner = 
    largest_corner->getRawPoint();

  largest_corner = 
    CellPolygonFactory::getLexicographicallyLargestPoint( polygon_3_corners );
  FACEMC::Vector<ScalarType> polygon_3_largest_corner = 
    largest_corner->getRawPoint();

  largest_corner = 
    CellPolygonFactory::getLexicographicallyLargestPoint( polygon_4_corners );
  FACEMC::Vector<ScalarType> polygon_4_largest_corner = 
    largest_corner->getRawPoint();

  largest_corner = 
    CellPolygonFactory::getLexicographicallyLargestPoint( polygon_5_corners );
  FACEMC::Vector<ScalarType> polygon_5_largest_corner = 
    largest_corner->getRawPoint();

  largest_corner = 
    CellPolygonFactory::getLexicographicallyLargestPoint( polygon_6_corners );
  FACEMC::Vector<ScalarType> polygon_6_largest_corner = 
    largest_corner->getRawPoint();

  largest_corner = 
    CellPolygonFactory::getLexicographicallyLargestPoint( polygon_7_corners );
  FACEMC::Vector<ScalarType> polygon_7_largest_corner = 
    largest_corner->getRawPoint();

  largest_corner = 
    CellPolygonFactory::getLexicographicallyLargestPoint( polygon_8_corners );
  FACEMC::Vector<ScalarType> polygon_8_largest_corner = 
    largest_corner->getRawPoint();

  largest_corner = 
    CellPolygonFactory::getLexicographicallyLargestPoint( polygon_9_corners );
  FACEMC::Vector<ScalarType> polygon_9_largest_corner = 
    largest_corner->getRawPoint();

  largest_corner = 
    CellPolygonFactory::getLexicographicallyLargestPoint( polygon_10_corners );
  FACEMC::Vector<ScalarType> polygon_10_largest_corner = 
    largest_corner->getRawPoint();

  largest_corner = 
    CellPolygonFactory::getLexicographicallyLargestPoint( polygon_11_corners );
  FACEMC::Vector<ScalarType> polygon_11_largest_corner = 
    largest_corner->getRawPoint();

  largest_corner = 
    CellPolygonFactory::getLexicographicallyLargestPoint( polygon_12_corners );
  FACEMC::Vector<ScalarType> polygon_12_largest_corner = 
    largest_corner->getRawPoint();

  largest_corner = 
    CellPolygonFactory::getLexicographicallyLargestPoint( polygon_13_corners );
  FACEMC::Vector<ScalarType> polygon_13_largest_corner = 
    largest_corner->getRawPoint();

  // Set the reference corners
  FACEMC::Vector<ScalarType> ref_polygon_1_largest_corner( 2.0, 7.0, 0.0 );
  FACEMC::Vector<ScalarType> ref_polygon_2_largest_corner( 1.0, 1.0, 2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_3_largest_corner( -1.0, 1.0, 2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_4_largest_corner( -2.0, 7.0, 0.0 );
  FACEMC::Vector<ScalarType> ref_polygon_5_largest_corner( 2.0, 7.0, 0.0 );
  FACEMC::Vector<ScalarType> ref_polygon_6_largest_corner( 2.0, 3.0, 0.0 );
  FACEMC::Vector<ScalarType> ref_polygon_7_largest_corner( 2.0, 2.0, 2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_8_largest_corner( 1.0, 1.0, 2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_9_largest_corner( 1.0, -1.0, 2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_10_largest_corner( 2.0, -2.0, 2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_11_largest_corner( 2.0, 2.0, 2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_12_largest_corner( 2.0, 7.0, 0.0 );
  FACEMC::Vector<ScalarType> ref_polygon_13_largest_corner( 2.0, 7.0, -2.0 );
				   ...
				   ScalarType )
{
  ...
  FACEMC::Vector<ScalarType> ref_polygon_1_first_point( 2.0, 3.0, 0.0 );
  FACEMC::Vector<ScalarType> ref_polygon_1_second_point( 2.0, 7.0, 0.0 );
  FACEMC::Vector<ScalarType> ref_polygon_1_third_point( 2.0, 7.0, -2.0 );
  ...
  FACEMC::Vector<ScalarType> ref_polygon_2_first_point( 1.0, 1.0, -2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_2_second_point( 1.0, 1.0, 2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_2_third_point( 1.0, -1.0, 2.0 );
  ...
  FACEMC::Vector<ScalarType> ref_polygon_3_first_point( -1.0, -1.0, 2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_3_second_point( -1.0, 1.0, 2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_3_third_point( -1.0, 1.0, -2.0 );
  ...
  FACEMC::Vector<ScalarType> ref_polygon_4_first_point( -2.0, 7.0, -2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_4_second_point( -2.0, 7.0, 0.0 );
  FACEMC::Vector<ScalarType> ref_polygon_4_third_point( -2.0, 3.0, 0.0 );
  ...
  FACEMC::Vector<ScalarType> ref_polygon_5_first_point( 2.0, 7.0, -2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_5_second_point( 2.0, 7.0, 0.0 );
  FACEMC::Vector<ScalarType> ref_polygon_5_third_point( -2.0, 7.0, 0.0 );
  ...
  FACEMC::Vector<ScalarType> ref_polygon_6_first_point( -2.0, 3.0, 0.0 );
  FACEMC::Vector<ScalarType> ref_polygon_6_second_point( 2.0, 3.0, 0.0 );
  FACEMC::Vector<ScalarType> ref_polygon_6_third_point( 2.0, 3.0, -2.0 );
  ...
  FACEMC::Vector<ScalarType> ref_polygon_7_first_point( 2.0, 2.0, -2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_7_second_point( 2.0, 2.0, 2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_7_third_point( -2.0, 2.0, 2.0 );
  ...
  FACEMC::Vector<ScalarType> ref_polygon_8_first_point( -1.0, 1.0, 2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_8_second_point( 1.0, 1.0, 2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_8_third_point( 1.0, 1.0, -2.0 );
  ...
  FACEMC::Vector<ScalarType> ref_polygon_9_first_point( 1.0, -1.0, -2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_9_second_point( 1.0, -1.0, 2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_9_third_point( -1.0, -1.0, 2.0 );
  ...
  FACEMC::Vector<ScalarType> ref_polygon_10_first_point( -2.0, -2.0, 2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_10_second_point( 2.0, -2.0, 2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_10_third_point( 2.0, -2.0, -2.0 );
  ...
  FACEMC::Vector<ScalarType> ref_polygon_11_first_point( -2.0, 2.0, 2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_11_second_point( 2.0, 2.0, 2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_11_third_point( 2.0, -2.0, 2.0 );
  ...
  FACEMC::Vector<ScalarType> ref_polygon_12_first_point( -2.0, 7.0, 0.0 );
  FACEMC::Vector<ScalarType> ref_polygon_12_second_point( 2.0, 7.0, 0.0 );
  FACEMC::Vector<ScalarType> ref_polygon_12_third_point( 2.0, 3.0, 0.0 );
  ...
  FACEMC::Vector<ScalarType> ref_polygon_13_first_point( 2.0, 3.0, -2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_13_second_point( 2.0, 7.0, -2.0 );
  FACEMC::Vector<ScalarType> ref_polygon_13_third_point( -2.0, 7.0, -2.0 );
				   ...
				   ScalarType )
{
  typedef FACEMC::Cell<CellOrdinalType,OrdinalType,ScalarType> Cell;
  typedef FACEMC::IntersectionPoint<OrdinalType,ScalarType> IntersectionPoint;
  typedef typename FACEMC::CellPolygonFactory<Cell>::PolygonPtr PolygonPtr;
  ...
  // Create the cell polygon factory
  FACEMC::CellPolygonFactory<Cell> factory( cell );
