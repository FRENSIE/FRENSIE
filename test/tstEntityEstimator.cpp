...
class TestEntityEstimator : public FACEMC::EntityEstimator<EntityId>
{  
public:
  TestEntityEstimator( const unsigned long long id,
    ...
    : FACEMC::EntityEstimator<EntityId>( id, 
					 multiplier, 
					 entity_ids, 
  ...
  TestEntityEstimator( const unsigned long long id,
		       const double multiplier,
		       const Teuchos::Array<EntityId>& entity_ids )
    : FACEMC::EntityEstimator<EntityId>( id, multiplier, entity_ids )
  { /* ... */ }
  ...
  using FACEMC::EntityEstimator<EntityId>::getEntityNormConstant;
  using FACEMC::EntityEstimator<EntityId>::getTotalNormConstant;
  using FACEMC::EntityEstimator<EntityId>::commitHistoryContributionToBinOfEntity;
};
