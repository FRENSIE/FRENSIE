...
TEUCHOS_UNIT_TEST( SurfaceInputValidator, validateSurface )
{
  ...
  TEST_NOTHROW( FACEMC::SurfaceInputValidator::validateSurface( 
						      valid_surface,
						      valid_surface.name() ) );
  
  Teuchos::ParameterList invalid_surface_1( "test_surface" );

  TEST_THROW( FACEMC::SurfaceInputValidator::validateSurface( 
						    invalid_surface_1,
  ...
  FACEMC::SurfaceInputValidator::clearSurfaceNames();
}
...
TEUCHOS_UNIT_TEST( SurfaceInputValidator, validateAllSurfaces )
{
  ...
  TEST_NOTHROW( FACEMC::SurfaceInputValidator::validateAllSurfaces(surfaces) );
